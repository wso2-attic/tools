...
/**
 * This is the item provider adapter for a {@link org.wso2.carbonstudio.eclipse.esb.mediator.XSLTMediator} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class XSLTMediatorItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MediatorPackage.Literals.XSLT_MEDIATOR__XSLT_KEY,
				 true,
				 false,
				 false,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MediatorPackage.Literals.XSLT_MEDIATOR__SOURCE_XPATH,
				 true,
				 false,
				 false,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MediatorPackage.Literals.XSLT_MEDIATOR__PROPERTIES);
			childrenFeatures.add(MediatorPackage.Literals.XSLT_MEDIATOR__FEATURES);
			childrenFeatures.add(MediatorPackage.Literals.XSLT_MEDIATOR__RESOURCES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MediatorPackage.Literals.XSLT_MEDIATOR__PROPERTIES,
				 MediatorFactory.eINSTANCE.createXSLTProperty()));

		newChildDescriptors.add
			(createChildParameter
				(MediatorPackage.Literals.XSLT_MEDIATOR__FEATURES,
				 MediatorFactory.eINSTANCE.createXSLTFeature()));

		newChildDescriptors.add
			(createChildParameter
				(MediatorPackage.Literals.XSLT_MEDIATOR__RESOURCES,
				 MediatorFactory.eINSTANCE.createXSLTResource()));
	}
