...
/**
 * This is the item provider adapter for a {@link org.wso2.carbonstudio.eclipse.esb.mediator.ValidateMediator} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ValidateMediatorItemProvider extends MediatorItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MediatorPackage.Literals.VALIDATE_MEDIATOR__SOURCE_XPATH,
				 true,
				 false,
				 false,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MediatorPackage.Literals.VALIDATE_MEDIATOR__ON_FAIL_BRANCH);
			childrenFeatures.add(MediatorPackage.Literals.VALIDATE_MEDIATOR__FEATURES);
			childrenFeatures.add(MediatorPackage.Literals.VALIDATE_MEDIATOR__SCHEMAS);
		}
	...
	public String getText(Object object) {
		return getString("_UI_ValidateMediator_type");
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MediatorPackage.Literals.VALIDATE_MEDIATOR__ON_FAIL_BRANCH,
				 MediatorFactory.eINSTANCE.createValidateOnFailBranch()));

		newChildDescriptors.add
			(createChildParameter
				(MediatorPackage.Literals.VALIDATE_MEDIATOR__FEATURES,
				 MediatorFactory.eINSTANCE.createValidateFeature()));

		newChildDescriptors.add
			(createChildParameter
				(MediatorPackage.Literals.VALIDATE_MEDIATOR__SCHEMAS,
				 MediatorFactory.eINSTANCE.createValidateSchema()));
	}
