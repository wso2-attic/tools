...
/**
 * This is the item provider adapter for a {@link org.wso2.carbonstudio.eclipse.esb.mediator.SendMediator} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SendMediatorItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		...
		if (null != sendMediator.getEndPointReference()) {		
			childrenFeatures.add(MediatorPackage.Literals.SEND_MEDIATOR__END_POINT_REFERENCE);
		} else {
			childrenFeatures.add(MediatorPackage.Literals.SEND_MEDIATOR__ANONYMOUS_END_POINT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(MediatorPackage.Literals.SEND_MEDIATOR__ANONYMOUS_END_POINT,
				endpoint));
		...
		newChildDescriptors.add(createChildParameter(MediatorPackage.Literals.SEND_MEDIATOR__END_POINT_REFERENCE,
	...
	protected Command createCreateChildCommand(EditingDomain domain, EObject owner, EStructuralFeature feature,
		...
		boolean unexecutable = (value instanceof EndPoint && (null != sendMediator.getEndPointReference()))
				|| (value instanceof EndPointReference && (null != sendMediator.getAnonymousEndPoint()));
		if (unexecutable) {
