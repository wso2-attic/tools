...
/**
 * This is the item provider adapter for a {@link org.wso2.carbonstudio.eclipse.esb.mediator.SmooksMediator} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SmooksMediatorItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MediatorPackage.Literals.SMOOKS_MEDIATOR__CONFIGURATION_KEY,
				 true,
				 false,
				 false,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MediatorPackage.Literals.SMOOKS_MEDIATOR__INPUT);
			childrenFeatures.add(MediatorPackage.Literals.SMOOKS_MEDIATOR__OUTPUT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MediatorPackage.Literals.SMOOKS_MEDIATOR__INPUT,
				 MediatorFactory.eINSTANCE.createSmooksInConfiguration()));

		newChildDescriptors.add
			(createChildParameter
				(MediatorPackage.Literals.SMOOKS_MEDIATOR__OUTPUT,
				 MediatorFactory.eINSTANCE.createSmooksOutConfiguration()));
	}
