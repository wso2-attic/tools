...
/**
 * This is the item provider adapter for a {@link org.wso2.carbonstudio.eclipse.esb.mediator.SwitchMediator} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SwitchMediatorItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MediatorPackage.Literals.SWITCH_MEDIATOR__SOURCE_XPATH,
				 true,
				 false,
				 false,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MediatorPackage.Literals.SWITCH_MEDIATOR__CASE_BRANCHES);
			childrenFeatures.add(MediatorPackage.Literals.SWITCH_MEDIATOR__DEFAULT_BRANCH);
		}
	...
	public String getText(Object object) {
		return getString("_UI_SwitchMediator_type");
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MediatorPackage.Literals.SWITCH_MEDIATOR__CASE_BRANCHES,
				 MediatorFactory.eINSTANCE.createSwitchCaseBranch()));

		newChildDescriptors.add
			(createChildParameter
				(MediatorPackage.Literals.SWITCH_MEDIATOR__DEFAULT_BRANCH,
				 MediatorFactory.eINSTANCE.createSwitchDefaultBranch()));
	}
