...
import org.wso2.carbonstudio.eclipse.esb.provider.MediatorBranchItemProvider;

/**
 * This is the item provider adapter for a {@link org.wso2.carbonstudio.eclipse.esb.mediator.ThrottleOnRejectBranch} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ThrottleOnRejectBranchItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		ThrottleOnRejectBranch onRejectBranch = (ThrottleOnRejectBranch) object;
		...
		if (onRejectBranch.getSequenceType().equals(ThrottleSequenceType.REGISTRY_REFERENCE)) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MediatorPackage.Literals.THROTTLE_ON_REJECT_BRANCH__SEQUENCE_TYPE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MediatorPackage.Literals.THROTTLE_ON_REJECT_BRANCH__SEQUENCE_KEY,
				 true,
				 false,
				 false,
				 null,
	...
	public String getText(Object object) {
		return getString("_UI_ThrottleOnRejectBranch_type");
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		...
		if (onRejectBranch.getSequenceType().equals(ThrottleSequenceType.ANONYMOUS)) {
	...
	protected Command createCreateChildCommand(EditingDomain domain, EObject owner, EStructuralFeature feature,
		...
		ThrottleOnRejectBranch onRejectBranch = (ThrottleOnRejectBranch) owner;
