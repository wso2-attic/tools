...
/**
 * This is the item provider adapter for a {@link org.wso2.carbonstudio.eclipse.esb.mediator.SqlStatement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SqlStatementItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MediatorPackage.Literals.SQL_STATEMENT__QUERY_STRING,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		...
		childrenFeatures.add(MediatorPackage.Literals.SQL_STATEMENT__PARAMETERS);
		if (statement.isResultsEnabled()) {
			childrenFeatures.add(MediatorPackage.Literals.SQL_STATEMENT__RESULTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(MediatorPackage.Literals.SQL_STATEMENT__PARAMETERS,
				MediatorFactory.eINSTANCE.createSqlParameterDefinition()));

		if (statement.isResultsEnabled()) {
			newChildDescriptors.add(createChildParameter(MediatorPackage.Literals.SQL_STATEMENT__RESULTS,
					MediatorFactory.eINSTANCE.createSqlResultMapping()));
		}
	}
