 ...
 * <ul>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.IterateTargetImpl#getSoapAction <em>Soap Action</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.IterateTargetImpl#getToAddress <em>To Address</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IterateTargetImpl extends AbstractCommonTargetImpl implements IterateTarget {
	...
	protected EClass eStaticClass() {
		return MediatorPackage.Literals.ITERATE_TARGET;
	}
	...
	public void setSoapAction(String newSoapAction) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.ITERATE_TARGET__SOAP_ACTION, oldSoapAction, soapAction));
	}
	...
	public void setToAddress(String newToAddress) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.ITERATE_TARGET__TO_ADDRESS, oldToAddress, toAddress));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MediatorPackage.ITERATE_TARGET__SOAP_ACTION:
				return getSoapAction();
			case MediatorPackage.ITERATE_TARGET__TO_ADDRESS:
				return getToAddress();
		}
