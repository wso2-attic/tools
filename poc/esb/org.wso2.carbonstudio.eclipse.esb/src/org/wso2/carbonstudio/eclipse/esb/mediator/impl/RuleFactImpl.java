 ...
 * <ul>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.RuleFactImpl#getFactType <em>Fact Type</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.RuleFactImpl#getFactCustomType <em>Fact Custom Type</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.RuleFactImpl#getFactName <em>Fact Name</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.RuleFactImpl#getValueType <em>Value Type</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.RuleFactImpl#getValueLiteral <em>Value Literal</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.RuleFactImpl#getValueExpression <em>Value Expression</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.RuleFactImpl#getValueKey <em>Value Key</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RuleFactImpl extends ModelObjectImpl implements RuleFact {
	...
	protected EClass eStaticClass() {
		return MediatorPackage.Literals.RULE_FACT;
	}
	...
	public void setFactType(RuleFactType newFactType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.RULE_FACT__FACT_TYPE, oldFactType, factType));
	}
	...
	public void setFactCustomType(String newFactCustomType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.RULE_FACT__FACT_CUSTOM_TYPE, oldFactCustomType, factCustomType));
	}
	...
	public void setFactName(String newFactName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.RULE_FACT__FACT_NAME, oldFactName, factName));
	}
	...
	public void setValueType(RuleFactValueType newValueType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.RULE_FACT__VALUE_TYPE, oldValueType, valueType));
	}
	...
	public void setValueLiteral(String newValueLiteral) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.RULE_FACT__VALUE_LITERAL, oldValueLiteral, valueLiteral));
	}
	...
	public NotificationChain basicSetValueExpression(NamespacedProperty newValueExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MediatorPackage.RULE_FACT__VALUE_EXPRESSION, oldValueExpression, newValueExpression);
	...
	public void setValueExpression(NamespacedProperty newValueExpression) {
		if (newValueExpression != valueExpression) {
			...
			if (valueExpression != null)
				msgs = ((InternalEObject)valueExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MediatorPackage.RULE_FACT__VALUE_EXPRESSION, null, msgs);
			if (newValueExpression != null)
				msgs = ((InternalEObject)newValueExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MediatorPackage.RULE_FACT__VALUE_EXPRESSION, null, msgs);
			msgs = basicSetValueExpression(newValueExpression, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.RULE_FACT__VALUE_EXPRESSION, newValueExpression, newValueExpression));
	}
	...
	public NotificationChain basicSetValueKey(RegistryKeyProperty newValueKey, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MediatorPackage.RULE_FACT__VALUE_KEY, oldValueKey, newValueKey);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setValueKey(RegistryKeyProperty newValueKey) {
		if (newValueKey != valueKey) {
			NotificationChain msgs = null;
			if (valueKey != null)
				msgs = ((InternalEObject)valueKey).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MediatorPackage.RULE_FACT__VALUE_KEY, null, msgs);
			if (newValueKey != null)
				msgs = ((InternalEObject)newValueKey).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MediatorPackage.RULE_FACT__VALUE_KEY, null, msgs);
			msgs = basicSetValueKey(newValueKey, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.RULE_FACT__VALUE_KEY, newValueKey, newValueKey));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MediatorPackage.RULE_FACT__VALUE_EXPRESSION:
				return basicSetValueExpression(null, msgs);
			case MediatorPackage.RULE_FACT__VALUE_KEY:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MediatorPackage.RULE_FACT__FACT_TYPE:
				return getFactType();
			case MediatorPackage.RULE_FACT__FACT_CUSTOM_TYPE:
				return getFactCustomType();
			case MediatorPackage.RULE_FACT__FACT_NAME:
				return getFactName();
			case MediatorPackage.RULE_FACT__VALUE_TYPE:
				return getValueType();
			case MediatorPackage.RULE_FACT__VALUE_LITERAL:
