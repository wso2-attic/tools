 ...
 * <ul>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.RuleResultImpl#getResultType <em>Result Type</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.RuleResultImpl#getResultCustomType <em>Result Custom Type</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.RuleResultImpl#getResultName <em>Result Name</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.RuleResultImpl#getValueType <em>Value Type</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.RuleResultImpl#getValueLiteral <em>Value Literal</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.RuleResultImpl#getValueExpression <em>Value Expression</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.RuleResultImpl#getValueKey <em>Value Key</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RuleResultImpl extends ModelObjectImpl implements RuleResult {
	...
	protected EClass eStaticClass() {
		return MediatorPackage.Literals.RULE_RESULT;
	}
	...
	public void setResultType(RuleResultType newResultType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.RULE_RESULT__RESULT_TYPE, oldResultType, resultType));
	}
	...
	public void setResultCustomType(String newResultCustomType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.RULE_RESULT__RESULT_CUSTOM_TYPE, oldResultCustomType, resultCustomType));
	}
	...
	public void setResultName(String newResultName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.RULE_RESULT__RESULT_NAME, oldResultName, resultName));
	}
	...
	public void setValueType(RuleResultValueType newValueType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.RULE_RESULT__VALUE_TYPE, oldValueType, valueType));
	}
	...
	public void setValueLiteral(String newValueLiteral) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.RULE_RESULT__VALUE_LITERAL, oldValueLiteral, valueLiteral));
	}
	...
	public NotificationChain basicSetValueExpression(NamespacedProperty newValueExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MediatorPackage.RULE_RESULT__VALUE_EXPRESSION, oldValueExpression, newValueExpression);
	...
	public void setValueExpression(NamespacedProperty newValueExpression) {
		if (newValueExpression != valueExpression) {
			...
			if (valueExpression != null)
				msgs = ((InternalEObject)valueExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MediatorPackage.RULE_RESULT__VALUE_EXPRESSION, null, msgs);
			if (newValueExpression != null)
				msgs = ((InternalEObject)newValueExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MediatorPackage.RULE_RESULT__VALUE_EXPRESSION, null, msgs);
			msgs = basicSetValueExpression(newValueExpression, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.RULE_RESULT__VALUE_EXPRESSION, newValueExpression, newValueExpression));
	}
	...
	public NotificationChain basicSetValueKey(RegistryKeyProperty newValueKey, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MediatorPackage.RULE_RESULT__VALUE_KEY, oldValueKey, newValueKey);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setValueKey(RegistryKeyProperty newValueKey) {
		if (newValueKey != valueKey) {
			NotificationChain msgs = null;
			if (valueKey != null)
				msgs = ((InternalEObject)valueKey).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MediatorPackage.RULE_RESULT__VALUE_KEY, null, msgs);
			if (newValueKey != null)
				msgs = ((InternalEObject)newValueKey).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MediatorPackage.RULE_RESULT__VALUE_KEY, null, msgs);
			msgs = basicSetValueKey(newValueKey, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.RULE_RESULT__VALUE_KEY, newValueKey, newValueKey));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MediatorPackage.RULE_RESULT__VALUE_EXPRESSION:
				return basicSetValueExpression(null, msgs);
			case MediatorPackage.RULE_RESULT__VALUE_KEY:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MediatorPackage.RULE_RESULT__RESULT_TYPE:
				return getResultType();
			case MediatorPackage.RULE_RESULT__RESULT_CUSTOM_TYPE:
				return getResultCustomType();
			case MediatorPackage.RULE_RESULT__RESULT_NAME:
				return getResultName();
			case MediatorPackage.RULE_RESULT__VALUE_TYPE:
				return getValueType();
			case MediatorPackage.RULE_RESULT__VALUE_LITERAL:
