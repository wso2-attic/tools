...
public class ModelObjectResolverFactoryImpl implements ModelObjectResolverFactory {
	...
	/**
	 * Utility method for obtaining a reference to global {@link EsbFactory} instance.
	 * 
	...
	/**
	 * Utility method for obtaining a reference to global {@link MediatorFactory} instance.
	 * 
	 * @return global {@link MediatorFactory} instance.
	 */
	private MediatorFactory getMediatorFactory() {
		return MediatorFactory.eINSTANCE;
	}
	...
	private void initResolvers() {
		...
		localNameToResolverMap.put("endpoint", new ModelObjectResolver() {
			public ModelObject resolve(Element elem, ModelObject parent) {
				...
				} else if (EsbUtils.elementContainsChild(elem, "dynamicLoadBalance")) {
		 ...
		 */
		localNameToResolverMap.put("entitlementService", new ModelObjectResolver() {
			public ModelObject resolve(Element elem, ModelObject parent) {
		...
		localNameToResolverMap.put("policy", new ModelObjectResolver() {
			public ModelObject resolve(Element elem, ModelObject parent) {
				...
				if (parent instanceof ProxyService) {
					...
					obj = getMediatorFactory().createThrottlePolicyConfiguration();
		...
		localNameToResolverMap.put("childMediators", new ModelObjectResolver() {
			public ModelObject resolve(Element elem, ModelObject parent) {
				return getMediatorFactory().createRuleChildMediatorsConfiguration();
			}
		});
