 ...
 * <ul>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.HeaderMediatorImpl#getHeaderName <em>Header Name</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.HeaderMediatorImpl#getHeaderAction <em>Header Action</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.HeaderMediatorImpl#getValueType <em>Value Type</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.HeaderMediatorImpl#getValueLiteral <em>Value Literal</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.HeaderMediatorImpl#getValueExpression <em>Value Expression</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class HeaderMediatorImpl extends MediatorImpl implements HeaderMediator {
	...
	protected EClass eStaticClass() {
		return MediatorPackage.Literals.HEADER_MEDIATOR;
	}
	...
	public NotificationChain basicSetHeaderName(NamespacedProperty newHeaderName, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MediatorPackage.HEADER_MEDIATOR__HEADER_NAME, oldHeaderName, newHeaderName);
	...
	public void setHeaderName(NamespacedProperty newHeaderName) {
		if (newHeaderName != headerName) {
			...
			if (headerName != null)
				msgs = ((InternalEObject)headerName).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MediatorPackage.HEADER_MEDIATOR__HEADER_NAME, null, msgs);
			if (newHeaderName != null)
				msgs = ((InternalEObject)newHeaderName).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MediatorPackage.HEADER_MEDIATOR__HEADER_NAME, null, msgs);
			msgs = basicSetHeaderName(newHeaderName, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.HEADER_MEDIATOR__HEADER_NAME, newHeaderName, newHeaderName));
	}
	...
	public void setHeaderAction(HeaderAction newHeaderAction) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.HEADER_MEDIATOR__HEADER_ACTION, oldHeaderAction, headerAction));
	}
	...
	public void setValueType(HeaderValueType newValueType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.HEADER_MEDIATOR__VALUE_TYPE, oldValueType, valueType));
	}
	...
	public void setValueLiteral(String newValueLiteral) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.HEADER_MEDIATOR__VALUE_LITERAL, oldValueLiteral, valueLiteral));
	}
	...
	public NotificationChain basicSetValueExpression(NamespacedProperty newValueExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MediatorPackage.HEADER_MEDIATOR__VALUE_EXPRESSION, oldValueExpression, newValueExpression);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setValueExpression(NamespacedProperty newValueExpression) {
		if (newValueExpression != valueExpression) {
			...
			if (valueExpression != null)
				msgs = ((InternalEObject)valueExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MediatorPackage.HEADER_MEDIATOR__VALUE_EXPRESSION, null, msgs);
			if (newValueExpression != null)
				msgs = ((InternalEObject)newValueExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MediatorPackage.HEADER_MEDIATOR__VALUE_EXPRESSION, null, msgs);
			msgs = basicSetValueExpression(newValueExpression, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.HEADER_MEDIATOR__VALUE_EXPRESSION, newValueExpression, newValueExpression));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MediatorPackage.HEADER_MEDIATOR__HEADER_NAME:
				return basicSetHeaderName(null, msgs);
			case MediatorPackage.HEADER_MEDIATOR__VALUE_EXPRESSION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case MediatorPackage.HEADER_MEDIATOR__HEADER_ACTION:
				return getHeaderAction();
			case MediatorPackage.HEADER_MEDIATOR__VALUE_TYPE:
				return getValueType();
			case MediatorPackage.HEADER_MEDIATOR__VALUE_LITERAL:
