 ...
 * <ul>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.RuleSessionConfigurationImpl#isStatefulSession <em>Stateful Session</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.RuleSessionConfigurationImpl#getProperties <em>Properties</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RuleSessionConfigurationImpl extends ModelObjectImpl implements RuleSessionConfiguration {
	...
	public void setStatefulSession(boolean newStatefulSession) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.RULE_SESSION_CONFIGURATION__STATEFUL_SESSION, oldStatefulSession, statefulSession));
	}
	...
	public EList<RuleSessionProperty> getProperties() {
		if (properties == null) {
			properties = new EObjectContainmentEList<RuleSessionProperty>(RuleSessionProperty.class, this, MediatorPackage.RULE_SESSION_CONFIGURATION__PROPERTIES);
		}
		return properties;
	}
