 ...
 * <ul>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.OAuthMediatorImpl#getRemoteServiceUrl <em>Remote Service Url</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OAuthMediatorImpl extends MediatorImpl implements OAuthMediator {
	...
	protected EClass eStaticClass() {
		return MediatorPackage.Literals.OAUTH_MEDIATOR;
	}
	...
	public void setRemoteServiceUrl(String newRemoteServiceUrl) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.OAUTH_MEDIATOR__REMOTE_SERVICE_URL, oldRemoteServiceUrl, remoteServiceUrl));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MediatorPackage.OAUTH_MEDIATOR__REMOTE_SERVICE_URL:
