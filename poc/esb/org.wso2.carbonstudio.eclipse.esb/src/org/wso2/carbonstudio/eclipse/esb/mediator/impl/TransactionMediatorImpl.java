 ...
 * <ul>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.TransactionMediatorImpl#getAction <em>Action</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TransactionMediatorImpl extends MediatorImpl implements TransactionMediator {
	...
	protected void doLoad(Element self) throws Exception {
		TransactionAction action = TransactionAction.get(self.getAttribute("action"));
		if (null != action) {
			setAction(action);
		} else {
	...
	protected EClass eStaticClass() {
		return MediatorPackage.Literals.TRANSACTION_MEDIATOR;
	}
	...
	public void setAction(TransactionAction newAction) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.TRANSACTION_MEDIATOR__ACTION, oldAction, action));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MediatorPackage.TRANSACTION_MEDIATOR__ACTION:
				return getAction();
		}
