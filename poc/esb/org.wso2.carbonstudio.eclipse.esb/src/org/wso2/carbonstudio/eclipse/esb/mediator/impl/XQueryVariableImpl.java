 ...
 * <ul>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.XQueryVariableImpl#getVariableName <em>Variable Name</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.XQueryVariableImpl#getVariableType <em>Variable Type</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.XQueryVariableImpl#getValueType <em>Value Type</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.XQueryVariableImpl#getValueLiteral <em>Value Literal</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.XQueryVariableImpl#getValueExpression <em>Value Expression</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.XQueryVariableImpl#getValueKey <em>Value Key</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class XQueryVariableImpl extends ModelObjectImpl implements XQueryVariable {
	...
	public void setVariableName(String newVariableName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.XQUERY_VARIABLE__VARIABLE_NAME, oldVariableName, variableName));
	}
	...
	public void setVariableType(XQueryVariableType newVariableType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.XQUERY_VARIABLE__VARIABLE_TYPE, oldVariableType, variableType));
	}
	...
	public void setValueType(XQueryVariableValueType newValueType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.XQUERY_VARIABLE__VALUE_TYPE, oldValueType, valueType));
	}
	...
	public void setValueLiteral(String newValueLiteral) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.XQUERY_VARIABLE__VALUE_LITERAL, oldValueLiteral, valueLiteral));
	}
	...
	public NotificationChain basicSetValueExpression(NamespacedProperty newValueExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MediatorPackage.XQUERY_VARIABLE__VALUE_EXPRESSION, oldValueExpression, newValueExpression);
	...
	public void setValueExpression(NamespacedProperty newValueExpression) {
		if (newValueExpression != valueExpression) {
			...
			if (valueExpression != null)
				msgs = ((InternalEObject)valueExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MediatorPackage.XQUERY_VARIABLE__VALUE_EXPRESSION, null, msgs);
			if (newValueExpression != null)
				msgs = ((InternalEObject)newValueExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MediatorPackage.XQUERY_VARIABLE__VALUE_EXPRESSION, null, msgs);
			msgs = basicSetValueExpression(newValueExpression, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.XQUERY_VARIABLE__VALUE_EXPRESSION, newValueExpression, newValueExpression));
	}
	...
	public NotificationChain basicSetValueKey(RegistryKeyProperty newValueKey, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MediatorPackage.XQUERY_VARIABLE__VALUE_KEY, oldValueKey, newValueKey);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setValueKey(RegistryKeyProperty newValueKey) {
		if (newValueKey != valueKey) {
			NotificationChain msgs = null;
			if (valueKey != null)
				msgs = ((InternalEObject)valueKey).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MediatorPackage.XQUERY_VARIABLE__VALUE_KEY, null, msgs);
			if (newValueKey != null)
				msgs = ((InternalEObject)newValueKey).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MediatorPackage.XQUERY_VARIABLE__VALUE_KEY, null, msgs);
			msgs = basicSetValueKey(newValueKey, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.XQUERY_VARIABLE__VALUE_KEY, newValueKey, newValueKey));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MediatorPackage.XQUERY_VARIABLE__VALUE_EXPRESSION:
				return basicSetValueExpression(null, msgs);
			case MediatorPackage.XQUERY_VARIABLE__VALUE_KEY:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MediatorPackage.XQUERY_VARIABLE__VARIABLE_NAME:
				return getVariableName();
			case MediatorPackage.XQUERY_VARIABLE__VARIABLE_TYPE:
				return getVariableType();
			case MediatorPackage.XQUERY_VARIABLE__VALUE_TYPE:
				return getValueType();
			case MediatorPackage.XQUERY_VARIABLE__VALUE_LITERAL:
