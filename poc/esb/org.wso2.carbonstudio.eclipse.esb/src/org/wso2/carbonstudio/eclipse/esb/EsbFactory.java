...
public interface EsbFactory extends EFactory {
	 ...
	 * @generated
	 */
	EsbFactory eINSTANCE = org.wso2.carbonstudio.eclipse.esb.impl.EsbFactoryImpl.init();
	...
	/**
	 * Utility method for creating a copy of the given {@link NamespacedProperty}.
	 * 
	 * @param namespacedProperty original {@link NamespacedProperty} instance.
    ...
    /**
     * Utility method for creating a copy of the given {@link RegistryKeyProperty}.
     * 
     * @param registryKeyProperty original {@link RegistryKeyProperty} instance.
	 ...
	 *         encountered.
	 */
	<T extends ModelObject> T loadModelObject(Element element, Class<T> clazz, ModelObject parent);
	
	/**
	 * Utility method for serializing any {@link ModelObject} into an
	 * {@link Element}.
	 * 
	 * @param modelObj {@link ModelObject} to be serialized.
	...
	/**
	 * Utility method for creating an {@link UnknownObject} wrapping a given {@link Element}.
	 * 
	 * @param elem {@link Element} to be wrapped with this {@link UnknownObject}.
