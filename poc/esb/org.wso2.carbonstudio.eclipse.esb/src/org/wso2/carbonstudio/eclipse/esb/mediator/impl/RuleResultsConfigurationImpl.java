...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Rule Results Configuration</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.RuleResultsConfigurationImpl#getResults <em>Results</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RuleResultsConfigurationImpl extends ModelObjectImpl implements RuleResultsConfiguration {
	...
	protected void doLoad(Element self) throws Exception {
		loadObjects(self, "result", RuleResult.class, new ObjectHandler<RuleResult>() {
	...
	protected Element doSave(Element parent) throws Exception {
		Element self = createChildElement(parent, "results");
	...
	protected EClass eStaticClass() {
		return MediatorPackage.Literals.RULE_RESULTS_CONFIGURATION;
	}
	...
	public EList<RuleResult> getResults() {
		if (results == null) {
			results = new EObjectContainmentEList<RuleResult>(RuleResult.class, this, MediatorPackage.RULE_RESULTS_CONFIGURATION__RESULTS);
		}
		return results;
	}
