 ...
 * <ul>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.DBReportMediatorImpl#isConnectionUseTransaction <em>Connection Use Transaction</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DBReportMediatorImpl extends AbstractSqlExecutorMediatorImpl implements DBReportMediator {
	...
	public void setConnectionUseTransaction(boolean newConnectionUseTransaction) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.DB_REPORT_MEDIATOR__CONNECTION_USE_TRANSACTION, oldConnectionUseTransaction, connectionUseTransaction));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MediatorPackage.DB_REPORT_MEDIATOR__CONNECTION_USE_TRANSACTION:
