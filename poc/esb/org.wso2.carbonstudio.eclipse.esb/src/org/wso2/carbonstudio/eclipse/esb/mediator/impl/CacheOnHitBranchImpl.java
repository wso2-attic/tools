 ...
 * <ul>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.CacheOnHitBranchImpl#getSequenceType <em>Sequence Type</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.CacheOnHitBranchImpl#getSequenceKey <em>Sequence Key</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CacheOnHitBranchImpl extends MediatorBranchImpl implements CacheOnHitBranch {
	...
	protected EClass eStaticClass() {
		return MediatorPackage.Literals.CACHE_ON_HIT_BRANCH;
	}
	...
	public void setSequenceType(CacheSequenceType newSequenceType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.CACHE_ON_HIT_BRANCH__SEQUENCE_TYPE, oldSequenceType, sequenceType));
	}
	...
	public RegistryKeyProperty getSequenceKey() {
		if (sequenceKey != null && sequenceKey.eIsProxy()) {
			...
			if (sequenceKey != oldSequenceKey) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MediatorPackage.CACHE_ON_HIT_BRANCH__SEQUENCE_KEY, oldSequenceKey, sequenceKey));
			}
		}
		return sequenceKey;
	}
	...
	public void setSequenceKey(RegistryKeyProperty newSequenceKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.CACHE_ON_HIT_BRANCH__SEQUENCE_KEY, oldSequenceKey, sequenceKey));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MediatorPackage.CACHE_ON_HIT_BRANCH__SEQUENCE_TYPE:
				return getSequenceType();
			case MediatorPackage.CACHE_ON_HIT_BRANCH__SEQUENCE_KEY:
