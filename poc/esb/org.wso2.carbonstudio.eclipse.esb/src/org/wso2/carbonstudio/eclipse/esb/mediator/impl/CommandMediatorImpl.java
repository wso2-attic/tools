 ...
 * <ul>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.CommandMediatorImpl#getClassName <em>Class Name</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.CommandMediatorImpl#getProperties <em>Properties</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CommandMediatorImpl extends MediatorImpl implements CommandMediator {
	...
	protected EClass eStaticClass() {
		return MediatorPackage.Literals.COMMAND_MEDIATOR;
	}
	...
	public void setClassName(String newClassName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.COMMAND_MEDIATOR__CLASS_NAME, oldClassName, className));
	}
	...
	public EList<CommandProperty> getProperties() {
		if (properties == null) {
			properties = new EObjectContainmentEList<CommandProperty>(CommandProperty.class, this, MediatorPackage.COMMAND_MEDIATOR__PROPERTIES);
		}
		return properties;
	}
