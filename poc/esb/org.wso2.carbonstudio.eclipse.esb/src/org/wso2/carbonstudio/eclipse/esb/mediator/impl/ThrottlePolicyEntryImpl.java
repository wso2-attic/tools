 ...
 * <ul>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.ThrottlePolicyEntryImpl#getThrottleType <em>Throttle Type</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.ThrottlePolicyEntryImpl#getThrottleRange <em>Throttle Range</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.ThrottlePolicyEntryImpl#getAccessType <em>Access Type</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.ThrottlePolicyEntryImpl#getMaxRequestCount <em>Max Request Count</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.ThrottlePolicyEntryImpl#getUnitTime <em>Unit Time</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.ThrottlePolicyEntryImpl#getProhibitPeriod <em>Prohibit Period</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ThrottlePolicyEntryImpl extends ModelObjectImpl implements ThrottlePolicyEntry {
		...
		switch (getAccessType()) {
			...
			case CONTROL : {
				...
				Element controlPolicyElem = 
					createChildElement(controlElem, throttleNsURI, throttleNsPrefix, "Policy");
	...
	protected EClass eStaticClass() {
		return MediatorPackage.Literals.THROTTLE_POLICY_ENTRY;
	}
	...
	public void setThrottleType(ThrottleConditionType newThrottleType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.THROTTLE_POLICY_ENTRY__THROTTLE_TYPE, oldThrottleType, throttleType));
	}
	...
	public void setThrottleRange(String newThrottleRange) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.THROTTLE_POLICY_ENTRY__THROTTLE_RANGE, oldThrottleRange, throttleRange));
	}
	...
	public void setAccessType(ThrottleAccessType newAccessType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.THROTTLE_POLICY_ENTRY__ACCESS_TYPE, oldAccessType, accessType));
	}
	...
	public void setMaxRequestCount(int newMaxRequestCount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.THROTTLE_POLICY_ENTRY__MAX_REQUEST_COUNT, oldMaxRequestCount, maxRequestCount));
	}
	...
	public void setUnitTime(int newUnitTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.THROTTLE_POLICY_ENTRY__UNIT_TIME, oldUnitTime, unitTime));
	}
	...
	public void setProhibitPeriod(int newProhibitPeriod) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.THROTTLE_POLICY_ENTRY__PROHIBIT_PERIOD, oldProhibitPeriod, prohibitPeriod));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MediatorPackage.THROTTLE_POLICY_ENTRY__THROTTLE_TYPE:
				return getThrottleType();
			case MediatorPackage.THROTTLE_POLICY_ENTRY__THROTTLE_RANGE:
				return getThrottleRange();
			case MediatorPackage.THROTTLE_POLICY_ENTRY__ACCESS_TYPE:
				return getAccessType();
			case MediatorPackage.THROTTLE_POLICY_ENTRY__MAX_REQUEST_COUNT:
				return getMaxRequestCount();
			case MediatorPackage.THROTTLE_POLICY_ENTRY__UNIT_TIME:
				return getUnitTime();
			case MediatorPackage.THROTTLE_POLICY_ENTRY__PROHIBIT_PERIOD:
