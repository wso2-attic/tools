 ...
 * <ul>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.ScriptMediatorImpl#getScriptType <em>Script Type</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.ScriptMediatorImpl#getScriptLanguage <em>Script Language</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.ScriptMediatorImpl#getMediateFunction <em>Mediate Function</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.ScriptMediatorImpl#getScriptKey <em>Script Key</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.ScriptMediatorImpl#getScriptBody <em>Script Body</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ScriptMediatorImpl extends MediatorImpl implements ScriptMediator {
	...
	protected EClass eStaticClass() {
		return MediatorPackage.Literals.SCRIPT_MEDIATOR;
	}
	...
	public void setScriptType(ScriptType newScriptType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.SCRIPT_MEDIATOR__SCRIPT_TYPE, oldScriptType, scriptType));
	}
	...
	public void setScriptLanguage(ScriptLanguage newScriptLanguage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.SCRIPT_MEDIATOR__SCRIPT_LANGUAGE, oldScriptLanguage, scriptLanguage));
	}
	...
	public void setMediateFunction(String newMediateFunction) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.SCRIPT_MEDIATOR__MEDIATE_FUNCTION, oldMediateFunction, mediateFunction));
	}
	...
	public NotificationChain basicSetScriptKey(RegistryKeyProperty newScriptKey, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MediatorPackage.SCRIPT_MEDIATOR__SCRIPT_KEY, oldScriptKey, newScriptKey);
	...
	public void setScriptKey(RegistryKeyProperty newScriptKey) {
		if (newScriptKey != scriptKey) {
			...
			if (scriptKey != null)
				msgs = ((InternalEObject)scriptKey).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MediatorPackage.SCRIPT_MEDIATOR__SCRIPT_KEY, null, msgs);
			if (newScriptKey != null)
				msgs = ((InternalEObject)newScriptKey).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MediatorPackage.SCRIPT_MEDIATOR__SCRIPT_KEY, null, msgs);
			msgs = basicSetScriptKey(newScriptKey, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.SCRIPT_MEDIATOR__SCRIPT_KEY, newScriptKey, newScriptKey));
	}
	...
	public void setScriptBody(String newScriptBody) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.SCRIPT_MEDIATOR__SCRIPT_BODY, oldScriptBody, scriptBody));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MediatorPackage.SCRIPT_MEDIATOR__SCRIPT_KEY:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MediatorPackage.SCRIPT_MEDIATOR__SCRIPT_TYPE:
				return getScriptType();
			case MediatorPackage.SCRIPT_MEDIATOR__SCRIPT_LANGUAGE:
				return getScriptLanguage();
			case MediatorPackage.SCRIPT_MEDIATOR__MEDIATE_FUNCTION:
				return getMediateFunction();
			case MediatorPackage.SCRIPT_MEDIATOR__SCRIPT_KEY:
				return getScriptKey();
			case MediatorPackage.SCRIPT_MEDIATOR__SCRIPT_BODY:
