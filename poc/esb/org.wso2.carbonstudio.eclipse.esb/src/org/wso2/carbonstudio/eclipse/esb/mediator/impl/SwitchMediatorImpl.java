 ...
 * <ul>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.SwitchMediatorImpl#getSourceXpath <em>Source Xpath</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.SwitchMediatorImpl#getCaseBranches <em>Case Branches</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.SwitchMediatorImpl#getDefaultBranch <em>Default Branch</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SwitchMediatorImpl extends MediatorImpl implements SwitchMediator {
	...
	public NotificationChain basicSetSourceXpath(NamespacedProperty newSourceXpath, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MediatorPackage.SWITCH_MEDIATOR__SOURCE_XPATH, oldSourceXpath, newSourceXpath);
	...
	public void setSourceXpath(NamespacedProperty newSourceXpath) {
		if (newSourceXpath != sourceXpath) {
			...
			if (sourceXpath != null)
				msgs = ((InternalEObject)sourceXpath).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MediatorPackage.SWITCH_MEDIATOR__SOURCE_XPATH, null, msgs);
			if (newSourceXpath != null)
				msgs = ((InternalEObject)newSourceXpath).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MediatorPackage.SWITCH_MEDIATOR__SOURCE_XPATH, null, msgs);
			msgs = basicSetSourceXpath(newSourceXpath, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.SWITCH_MEDIATOR__SOURCE_XPATH, newSourceXpath, newSourceXpath));
	}
	...
	public EList<SwitchCaseBranch> getCaseBranches() {
		if (caseBranches == null) {
			caseBranches = new EObjectContainmentEList<SwitchCaseBranch>(SwitchCaseBranch.class, this, MediatorPackage.SWITCH_MEDIATOR__CASE_BRANCHES);
		}
		return caseBranches;
	}
	...
	public NotificationChain basicSetDefaultBranch(SwitchDefaultBranch newDefaultBranch, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MediatorPackage.SWITCH_MEDIATOR__DEFAULT_BRANCH, oldDefaultBranch, newDefaultBranch);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setDefaultBranch(SwitchDefaultBranch newDefaultBranch) {
		if (newDefaultBranch != defaultBranch) {
			...
			if (defaultBranch != null)
				msgs = ((InternalEObject)defaultBranch).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MediatorPackage.SWITCH_MEDIATOR__DEFAULT_BRANCH, null, msgs);
			if (newDefaultBranch != null)
				msgs = ((InternalEObject)newDefaultBranch).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MediatorPackage.SWITCH_MEDIATOR__DEFAULT_BRANCH, null, msgs);
			msgs = basicSetDefaultBranch(newDefaultBranch, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.SWITCH_MEDIATOR__DEFAULT_BRANCH, newDefaultBranch, newDefaultBranch));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MediatorPackage.SWITCH_MEDIATOR__SOURCE_XPATH:
				return basicSetSourceXpath(null, msgs);
			case MediatorPackage.SWITCH_MEDIATOR__CASE_BRANCHES:
				return ((InternalEList<?>)getCaseBranches()).basicRemove(otherEnd, msgs);
			case MediatorPackage.SWITCH_MEDIATOR__DEFAULT_BRANCH:
