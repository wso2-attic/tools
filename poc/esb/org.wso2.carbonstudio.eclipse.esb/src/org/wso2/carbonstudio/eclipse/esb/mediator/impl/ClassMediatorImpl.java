 ...
 * <ul>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.ClassMediatorImpl#getClassName <em>Class Name</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.ClassMediatorImpl#getProperties <em>Properties</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ClassMediatorImpl extends MediatorImpl implements ClassMediator {
    ...
    protected EClass eStaticClass() {
		return MediatorPackage.Literals.CLASS_MEDIATOR;
	}
	...
	public void setClassName(String newClassName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.CLASS_MEDIATOR__CLASS_NAME, oldClassName, className));
	}
	...
	public EList<ClassProperty> getProperties() {
		if (properties == null) {
			properties = new EObjectContainmentEList<ClassProperty>(ClassProperty.class, this, MediatorPackage.CLASS_MEDIATOR__PROPERTIES);
		}
		return properties;
	}
