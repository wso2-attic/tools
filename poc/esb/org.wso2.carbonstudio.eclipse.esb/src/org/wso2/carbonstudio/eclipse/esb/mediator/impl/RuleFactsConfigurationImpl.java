 ...
 * <ul>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.RuleFactsConfigurationImpl#getFacts <em>Facts</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RuleFactsConfigurationImpl extends ModelObjectImpl implements RuleFactsConfiguration {
	...
	protected EClass eStaticClass() {
		return MediatorPackage.Literals.RULE_FACTS_CONFIGURATION;
	}
	...
	public EList<RuleFact> getFacts() {
		if (facts == null) {
			facts = new EObjectContainmentEList<RuleFact>(RuleFact.class, this, MediatorPackage.RULE_FACTS_CONFIGURATION__FACTS);
		}
		return facts;
	}
