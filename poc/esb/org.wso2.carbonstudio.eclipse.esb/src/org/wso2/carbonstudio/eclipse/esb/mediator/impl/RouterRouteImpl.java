 ...
 * <ul>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.RouterRouteImpl#isBreakAfterRoute <em>Break After Route</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.RouterRouteImpl#getRouteExpression <em>Route Expression</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.RouterRouteImpl#getRoutePattern <em>Route Pattern</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.RouterRouteImpl#getTarget <em>Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RouterRouteImpl extends ModelObjectImpl implements RouterRoute {
	...
	protected EClass eStaticClass() {
		return MediatorPackage.Literals.ROUTER_ROUTE;
	}
	...
	public void setBreakAfterRoute(boolean newBreakAfterRoute) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.ROUTER_ROUTE__BREAK_AFTER_ROUTE, oldBreakAfterRoute, breakAfterRoute));
	}
	...
	public NamespacedProperty getRouteExpression() {
		if (routeExpression != null && routeExpression.eIsProxy()) {
			...
			if (routeExpression != oldRouteExpression) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MediatorPackage.ROUTER_ROUTE__ROUTE_EXPRESSION, oldRouteExpression, routeExpression));
			}
		}
	...
	public void setRouteExpression(NamespacedProperty newRouteExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.ROUTER_ROUTE__ROUTE_EXPRESSION, oldRouteExpression, routeExpression));
	}
	...
	public void setRoutePattern(String newRoutePattern) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.ROUTER_ROUTE__ROUTE_PATTERN, oldRoutePattern, routePattern));
	}
	...
	public NotificationChain basicSetTarget(RouteTarget newTarget, NotificationChain msgs) {
		...
		target = newTarget;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MediatorPackage.ROUTER_ROUTE__TARGET, oldTarget, newTarget);
	...
	public void setTarget(RouteTarget newTarget) {
		if (newTarget != target) {
			...
			if (target != null)
				msgs = ((InternalEObject)target).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MediatorPackage.ROUTER_ROUTE__TARGET, null, msgs);
			if (newTarget != null)
				msgs = ((InternalEObject)newTarget).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MediatorPackage.ROUTER_ROUTE__TARGET, null, msgs);
			msgs = basicSetTarget(newTarget, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.ROUTER_ROUTE__TARGET, newTarget, newTarget));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MediatorPackage.ROUTER_ROUTE__TARGET:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MediatorPackage.ROUTER_ROUTE__BREAK_AFTER_ROUTE:
				return isBreakAfterRoute();
			case MediatorPackage.ROUTER_ROUTE__ROUTE_EXPRESSION:
				if (resolve) return getRouteExpression();
				return basicGetRouteExpression();
			case MediatorPackage.ROUTER_ROUTE__ROUTE_PATTERN:
