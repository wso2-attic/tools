 ...
 * <ul>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.AggregateOnCompleteBranchImpl#getAggregationExpression <em>Aggregation Expression</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.AggregateOnCompleteBranchImpl#getSequenceType <em>Sequence Type</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.AggregateOnCompleteBranchImpl#getSequenceKey <em>Sequence Key</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AggregateOnCompleteBranchImpl extends MediatorBranchImpl implements AggregateOnCompleteBranch {
	...
	protected EClass eStaticClass() {
		return MediatorPackage.Literals.AGGREGATE_ON_COMPLETE_BRANCH;
	}
	...
	public NotificationChain basicSetAggregationExpression(NamespacedProperty newAggregationExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MediatorPackage.AGGREGATE_ON_COMPLETE_BRANCH__AGGREGATION_EXPRESSION, oldAggregationExpression, newAggregationExpression);
	...
	public void setAggregationExpression(NamespacedProperty newAggregationExpression) {
		if (newAggregationExpression != aggregationExpression) {
			...
			if (aggregationExpression != null)
				msgs = ((InternalEObject)aggregationExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MediatorPackage.AGGREGATE_ON_COMPLETE_BRANCH__AGGREGATION_EXPRESSION, null, msgs);
			if (newAggregationExpression != null)
				msgs = ((InternalEObject)newAggregationExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MediatorPackage.AGGREGATE_ON_COMPLETE_BRANCH__AGGREGATION_EXPRESSION, null, msgs);
			msgs = basicSetAggregationExpression(newAggregationExpression, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.AGGREGATE_ON_COMPLETE_BRANCH__AGGREGATION_EXPRESSION, newAggregationExpression, newAggregationExpression));
	}
	...
	public void setSequenceType(AggregateSequenceType newSequenceType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.AGGREGATE_ON_COMPLETE_BRANCH__SEQUENCE_TYPE, oldSequenceType, sequenceType));
	}
	...
	public NotificationChain basicSetSequenceKey(RegistryKeyProperty newSequenceKey, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MediatorPackage.AGGREGATE_ON_COMPLETE_BRANCH__SEQUENCE_KEY, oldSequenceKey, newSequenceKey);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSequenceKey(RegistryKeyProperty newSequenceKey) {
		if (newSequenceKey != sequenceKey) {
			NotificationChain msgs = null;
			if (sequenceKey != null)
				msgs = ((InternalEObject)sequenceKey).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MediatorPackage.AGGREGATE_ON_COMPLETE_BRANCH__SEQUENCE_KEY, null, msgs);
			if (newSequenceKey != null)
				msgs = ((InternalEObject)newSequenceKey).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MediatorPackage.AGGREGATE_ON_COMPLETE_BRANCH__SEQUENCE_KEY, null, msgs);
			msgs = basicSetSequenceKey(newSequenceKey, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.AGGREGATE_ON_COMPLETE_BRANCH__SEQUENCE_KEY, newSequenceKey, newSequenceKey));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MediatorPackage.AGGREGATE_ON_COMPLETE_BRANCH__AGGREGATION_EXPRESSION:
				return basicSetAggregationExpression(null, msgs);
			case MediatorPackage.AGGREGATE_ON_COMPLETE_BRANCH__SEQUENCE_KEY:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case MediatorPackage.AGGREGATE_ON_COMPLETE_BRANCH__SEQUENCE_TYPE:
