 ...
 * <ul>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.RuleMediatorImpl#getRuleSetConfiguration <em>Rule Set Configuration</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.RuleMediatorImpl#getRuleSessionConfiguration <em>Rule Session Configuration</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.RuleMediatorImpl#getFactsConfiguration <em>Facts Configuration</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.RuleMediatorImpl#getResultsConfiguration <em>Results Configuration</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.RuleMediatorImpl#getChildMediatorsConfiguration <em>Child Mediators Configuration</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RuleMediatorImpl extends MediatorImpl implements RuleMediator {
	...
	protected EClass eStaticClass() {
		return MediatorPackage.Literals.RULE_MEDIATOR;
	}
	...
	public NotificationChain basicSetRuleSetConfiguration(RuleSetConfiguration newRuleSetConfiguration, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MediatorPackage.RULE_MEDIATOR__RULE_SET_CONFIGURATION, oldRuleSetConfiguration, newRuleSetConfiguration);
	...
	public void setRuleSetConfiguration(RuleSetConfiguration newRuleSetConfiguration) {
		if (newRuleSetConfiguration != ruleSetConfiguration) {
			...
			if (ruleSetConfiguration != null)
				msgs = ((InternalEObject)ruleSetConfiguration).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MediatorPackage.RULE_MEDIATOR__RULE_SET_CONFIGURATION, null, msgs);
			if (newRuleSetConfiguration != null)
				msgs = ((InternalEObject)newRuleSetConfiguration).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MediatorPackage.RULE_MEDIATOR__RULE_SET_CONFIGURATION, null, msgs);
			msgs = basicSetRuleSetConfiguration(newRuleSetConfiguration, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.RULE_MEDIATOR__RULE_SET_CONFIGURATION, newRuleSetConfiguration, newRuleSetConfiguration));
	}
	...
	public NotificationChain basicSetRuleSessionConfiguration(RuleSessionConfiguration newRuleSessionConfiguration, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MediatorPackage.RULE_MEDIATOR__RULE_SESSION_CONFIGURATION, oldRuleSessionConfiguration, newRuleSessionConfiguration);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setRuleSessionConfiguration(RuleSessionConfiguration newRuleSessionConfiguration) {
		if (newRuleSessionConfiguration != ruleSessionConfiguration) {
			...
			if (ruleSessionConfiguration != null)
				msgs = ((InternalEObject)ruleSessionConfiguration).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MediatorPackage.RULE_MEDIATOR__RULE_SESSION_CONFIGURATION, null, msgs);
			if (newRuleSessionConfiguration != null)
				msgs = ((InternalEObject)newRuleSessionConfiguration).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MediatorPackage.RULE_MEDIATOR__RULE_SESSION_CONFIGURATION, null, msgs);
			msgs = basicSetRuleSessionConfiguration(newRuleSessionConfiguration, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.RULE_MEDIATOR__RULE_SESSION_CONFIGURATION, newRuleSessionConfiguration, newRuleSessionConfiguration));
	}
	...
	public NotificationChain basicSetFactsConfiguration(RuleFactsConfiguration newFactsConfiguration, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MediatorPackage.RULE_MEDIATOR__FACTS_CONFIGURATION, oldFactsConfiguration, newFactsConfiguration);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setFactsConfiguration(RuleFactsConfiguration newFactsConfiguration) {
		if (newFactsConfiguration != factsConfiguration) {
			...
			if (factsConfiguration != null)
				msgs = ((InternalEObject)factsConfiguration).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MediatorPackage.RULE_MEDIATOR__FACTS_CONFIGURATION, null, msgs);
			if (newFactsConfiguration != null)
				msgs = ((InternalEObject)newFactsConfiguration).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MediatorPackage.RULE_MEDIATOR__FACTS_CONFIGURATION, null, msgs);
			msgs = basicSetFactsConfiguration(newFactsConfiguration, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.RULE_MEDIATOR__FACTS_CONFIGURATION, newFactsConfiguration, newFactsConfiguration));
	}
	...
	public NotificationChain basicSetResultsConfiguration(RuleResultsConfiguration newResultsConfiguration, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MediatorPackage.RULE_MEDIATOR__RESULTS_CONFIGURATION, oldResultsConfiguration, newResultsConfiguration);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setResultsConfiguration(RuleResultsConfiguration newResultsConfiguration) {
		if (newResultsConfiguration != resultsConfiguration) {
			...
			if (resultsConfiguration != null)
				msgs = ((InternalEObject)resultsConfiguration).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MediatorPackage.RULE_MEDIATOR__RESULTS_CONFIGURATION, null, msgs);
			if (newResultsConfiguration != null)
				msgs = ((InternalEObject)newResultsConfiguration).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MediatorPackage.RULE_MEDIATOR__RESULTS_CONFIGURATION, null, msgs);
			msgs = basicSetResultsConfiguration(newResultsConfiguration, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.RULE_MEDIATOR__RESULTS_CONFIGURATION, newResultsConfiguration, newResultsConfiguration));
	}
	...
	public NotificationChain basicSetChildMediatorsConfiguration(RuleChildMediatorsConfiguration newChildMediatorsConfiguration, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MediatorPackage.RULE_MEDIATOR__CHILD_MEDIATORS_CONFIGURATION, oldChildMediatorsConfiguration, newChildMediatorsConfiguration);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setChildMediatorsConfiguration(RuleChildMediatorsConfiguration newChildMediatorsConfiguration) {
		if (newChildMediatorsConfiguration != childMediatorsConfiguration) {
			...
			if (childMediatorsConfiguration != null)
				msgs = ((InternalEObject)childMediatorsConfiguration).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MediatorPackage.RULE_MEDIATOR__CHILD_MEDIATORS_CONFIGURATION, null, msgs);
			if (newChildMediatorsConfiguration != null)
				msgs = ((InternalEObject)newChildMediatorsConfiguration).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MediatorPackage.RULE_MEDIATOR__CHILD_MEDIATORS_CONFIGURATION, null, msgs);
			msgs = basicSetChildMediatorsConfiguration(newChildMediatorsConfiguration, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.RULE_MEDIATOR__CHILD_MEDIATORS_CONFIGURATION, newChildMediatorsConfiguration, newChildMediatorsConfiguration));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MediatorPackage.RULE_MEDIATOR__RULE_SET_CONFIGURATION:
				return basicSetRuleSetConfiguration(null, msgs);
			case MediatorPackage.RULE_MEDIATOR__RULE_SESSION_CONFIGURATION:
				return basicSetRuleSessionConfiguration(null, msgs);
			case MediatorPackage.RULE_MEDIATOR__FACTS_CONFIGURATION:
				return basicSetFactsConfiguration(null, msgs);
			case MediatorPackage.RULE_MEDIATOR__RESULTS_CONFIGURATION:
				return basicSetResultsConfiguration(null, msgs);
			case MediatorPackage.RULE_MEDIATOR__CHILD_MEDIATORS_CONFIGURATION:
