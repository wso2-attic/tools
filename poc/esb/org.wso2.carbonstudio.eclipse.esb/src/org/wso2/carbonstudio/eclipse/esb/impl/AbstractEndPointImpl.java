 ...
 * <ul>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.impl.AbstractEndPointImpl#isReliableMessagingEnabled <em>Reliable Messaging Enabled</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.impl.AbstractEndPointImpl#isSecurityEnabled <em>Security Enabled</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.impl.AbstractEndPointImpl#isAddressingEnabled <em>Addressing Enabled</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.impl.AbstractEndPointImpl#getAddressingVersion <em>Addressing Version</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.impl.AbstractEndPointImpl#isAddressingSeparateListener <em>Addressing Separate Listener</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.impl.AbstractEndPointImpl#getTimeOutDuration <em>Time Out Duration</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.impl.AbstractEndPointImpl#getTimeOutAction <em>Time Out Action</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.impl.AbstractEndPointImpl#getRetryErrorCodes <em>Retry Error Codes</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.impl.AbstractEndPointImpl#getRetryCount <em>Retry Count</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.impl.AbstractEndPointImpl#getRetryDelay <em>Retry Delay</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.impl.AbstractEndPointImpl#getSuspendErrorCodes <em>Suspend Error Codes</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.impl.AbstractEndPointImpl#getSuspendInitialDuration <em>Suspend Initial Duration</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.impl.AbstractEndPointImpl#getSuspendMaximumDuration <em>Suspend Maximum Duration</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.impl.AbstractEndPointImpl#getSuspendProgressionFactor <em>Suspend Progression Factor</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.impl.AbstractEndPointImpl#getReliableMessagingPolicy <em>Reliable Messaging Policy</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.impl.AbstractEndPointImpl#getSecurityPolicy <em>Security Policy</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
