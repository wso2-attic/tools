 ...
 * <ul>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.SqlStatementImpl#getQueryString <em>Query String</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.SqlStatementImpl#getParameters <em>Parameters</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.SqlStatementImpl#isResultsEnabled <em>Results Enabled</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.SqlStatementImpl#getResults <em>Results</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SqlStatementImpl extends ModelObjectImpl implements SqlStatement {
	...
	protected EClass eStaticClass() {
		return MediatorPackage.Literals.SQL_STATEMENT;
	}
	...
	public void setQueryString(String newQueryString) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.SQL_STATEMENT__QUERY_STRING, oldQueryString, queryString));
	}
	...
	public EList<SqlParameterDefinition> getParameters() {
		if (parameters == null) {
			parameters = new EObjectContainmentEList<SqlParameterDefinition>(SqlParameterDefinition.class, this, MediatorPackage.SQL_STATEMENT__PARAMETERS);
		}
		return parameters;
	}
	...
	public void setResultsEnabled(boolean newResultsEnabled) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.SQL_STATEMENT__RESULTS_ENABLED, oldResultsEnabled, resultsEnabled));
	}
	...
	public EList<SqlResultMapping> getResults() {
		if (results == null) {
			results = new EObjectContainmentEList<SqlResultMapping>(SqlResultMapping.class, this, MediatorPackage.SQL_STATEMENT__RESULTS);
		}
		return results;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MediatorPackage.SQL_STATEMENT__PARAMETERS:
				return ((InternalEList<?>)getParameters()).basicRemove(otherEnd, msgs);
			case MediatorPackage.SQL_STATEMENT__RESULTS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MediatorPackage.SQL_STATEMENT__QUERY_STRING:
				return getQueryString();
			case MediatorPackage.SQL_STATEMENT__PARAMETERS:
				return getParameters();
			case MediatorPackage.SQL_STATEMENT__RESULTS_ENABLED:
