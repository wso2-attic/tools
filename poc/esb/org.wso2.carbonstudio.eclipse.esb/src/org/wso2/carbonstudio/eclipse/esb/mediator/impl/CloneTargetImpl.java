...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Clone Target</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.CloneTargetImpl#getSoapAction <em>Soap Action</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.CloneTargetImpl#getToAddress <em>To Address</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CloneTargetImpl extends AbstractCommonTargetImpl implements CloneTarget {
	...
	protected EClass eStaticClass() {
		return MediatorPackage.Literals.CLONE_TARGET;
	}
	...
	public void setSoapAction(String newSoapAction) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.CLONE_TARGET__SOAP_ACTION, oldSoapAction, soapAction));
	}
	...
	public void setToAddress(String newToAddress) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.CLONE_TARGET__TO_ADDRESS, oldToAddress, toAddress));
	}
