 ...
 * <ul>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.ThrottlePolicyConfigurationImpl#getPolicyType <em>Policy Type</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.ThrottlePolicyConfigurationImpl#getPolicyKey <em>Policy Key</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.ThrottlePolicyConfigurationImpl#getMaxConcurrentAccessCount <em>Max Concurrent Access Count</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.ThrottlePolicyConfigurationImpl#getPolicyEntries <em>Policy Entries</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ThrottlePolicyConfigurationImpl extends ModelObjectImpl implements ThrottlePolicyConfiguration {
	...
	protected EClass eStaticClass() {
		return MediatorPackage.Literals.THROTTLE_POLICY_CONFIGURATION;
	}
	...
	public void setPolicyType(ThrottlePolicyType newPolicyType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.THROTTLE_POLICY_CONFIGURATION__POLICY_TYPE, oldPolicyType, policyType));
	}
	...
	public NotificationChain basicSetPolicyKey(RegistryKeyProperty newPolicyKey, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MediatorPackage.THROTTLE_POLICY_CONFIGURATION__POLICY_KEY, oldPolicyKey, newPolicyKey);
	...
	public void setPolicyKey(RegistryKeyProperty newPolicyKey) {
		if (newPolicyKey != policyKey) {
			...
			if (policyKey != null)
				msgs = ((InternalEObject)policyKey).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MediatorPackage.THROTTLE_POLICY_CONFIGURATION__POLICY_KEY, null, msgs);
			if (newPolicyKey != null)
				msgs = ((InternalEObject)newPolicyKey).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MediatorPackage.THROTTLE_POLICY_CONFIGURATION__POLICY_KEY, null, msgs);
			msgs = basicSetPolicyKey(newPolicyKey, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.THROTTLE_POLICY_CONFIGURATION__POLICY_KEY, newPolicyKey, newPolicyKey));
	}
	...
	public void setMaxConcurrentAccessCount(int newMaxConcurrentAccessCount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.THROTTLE_POLICY_CONFIGURATION__MAX_CONCURRENT_ACCESS_COUNT, oldMaxConcurrentAccessCount, maxConcurrentAccessCount));
	}
	...
	public EList<ThrottlePolicyEntry> getPolicyEntries() {
		if (policyEntries == null) {
			policyEntries = new EObjectContainmentEList<ThrottlePolicyEntry>(ThrottlePolicyEntry.class, this, MediatorPackage.THROTTLE_POLICY_CONFIGURATION__POLICY_ENTRIES);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MediatorPackage.THROTTLE_POLICY_CONFIGURATION__POLICY_KEY:
				return basicSetPolicyKey(null, msgs);
			case MediatorPackage.THROTTLE_POLICY_CONFIGURATION__POLICY_ENTRIES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MediatorPackage.THROTTLE_POLICY_CONFIGURATION__POLICY_TYPE:
				return getPolicyType();
			case MediatorPackage.THROTTLE_POLICY_CONFIGURATION__POLICY_KEY:
				return getPolicyKey();
			case MediatorPackage.THROTTLE_POLICY_CONFIGURATION__MAX_CONCURRENT_ACCESS_COUNT:
