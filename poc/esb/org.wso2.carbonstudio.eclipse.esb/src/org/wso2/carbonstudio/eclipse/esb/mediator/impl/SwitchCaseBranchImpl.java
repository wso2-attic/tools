 ...
 * <ul>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.SwitchCaseBranchImpl#getCaseRegex <em>Case Regex</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SwitchCaseBranchImpl extends MediatorBranchImpl implements SwitchCaseBranch {
	...
	protected EClass eStaticClass() {
		return MediatorPackage.Literals.SWITCH_CASE_BRANCH;
	}
	...
	public void setCaseRegex(String newCaseRegex) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.SWITCH_CASE_BRANCH__CASE_REGEX, oldCaseRegex, caseRegex));
	}
