 ...
 * <ul>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.SqlParameterDefinitionImpl#getDataType <em>Data Type</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.SqlParameterDefinitionImpl#getValueType <em>Value Type</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.SqlParameterDefinitionImpl#getValueLiteral <em>Value Literal</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.SqlParameterDefinitionImpl#getValueExpression <em>Value Expression</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SqlParameterDefinitionImpl extends ModelObjectImpl implements SqlParameterDefinition {
	...
	protected EClass eStaticClass() {
		return MediatorPackage.Literals.SQL_PARAMETER_DEFINITION;
	}
	...
	public void setDataType(SqlParameterDataType newDataType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.SQL_PARAMETER_DEFINITION__DATA_TYPE, oldDataType, dataType));
	}
	...
	public void setValueType(SqlParameterValueType newValueType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.SQL_PARAMETER_DEFINITION__VALUE_TYPE, oldValueType, valueType));
	}
	...
	public void setValueLiteral(String newValueLiteral) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.SQL_PARAMETER_DEFINITION__VALUE_LITERAL, oldValueLiteral, valueLiteral));
	}
	...
	public NotificationChain basicSetValueExpression(NamespacedProperty newValueExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MediatorPackage.SQL_PARAMETER_DEFINITION__VALUE_EXPRESSION, oldValueExpression, newValueExpression);
	...
	public void setValueExpression(NamespacedProperty newValueExpression) {
		if (newValueExpression != valueExpression) {
			...
			if (valueExpression != null)
				msgs = ((InternalEObject)valueExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MediatorPackage.SQL_PARAMETER_DEFINITION__VALUE_EXPRESSION, null, msgs);
			if (newValueExpression != null)
				msgs = ((InternalEObject)newValueExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MediatorPackage.SQL_PARAMETER_DEFINITION__VALUE_EXPRESSION, null, msgs);
			msgs = basicSetValueExpression(newValueExpression, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.SQL_PARAMETER_DEFINITION__VALUE_EXPRESSION, newValueExpression, newValueExpression));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MediatorPackage.SQL_PARAMETER_DEFINITION__VALUE_EXPRESSION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MediatorPackage.SQL_PARAMETER_DEFINITION__DATA_TYPE:
				return getDataType();
			case MediatorPackage.SQL_PARAMETER_DEFINITION__VALUE_TYPE:
				return getValueType();
			case MediatorPackage.SQL_PARAMETER_DEFINITION__VALUE_LITERAL:
