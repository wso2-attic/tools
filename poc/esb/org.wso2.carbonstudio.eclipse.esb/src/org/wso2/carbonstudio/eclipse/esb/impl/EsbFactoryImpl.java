...
public class EsbFactoryImpl extends EFactoryImpl implements EsbFactory {
	...
	public static EsbFactory init() {
		try {
			EsbFactory theEsbFactory = (EsbFactory)EPackage.Registry.INSTANCE.getEFactory("http:///org/wso2/carbonstudio/eclipse/esb"); 
	...
	public <T extends ModelObject> T loadModelObject(Element element, Class<T> clazz, ModelObject parent) {
		T result = null;
		ModelObjectResolver resolver = resolverFactory.getResolver(element.getLocalName());		
		if (null != resolver) {
	...
	/**
	 * Utility method used for recursively extracting load errors of a {@link ModelObject} and its children.
	 * 
	 * @param modelObj {@link ModelObject} to be analyzed.
	 * @param statusList list of {@link IStatus} objects collected so far.
	 */
	private void extractLoadErrors(ModelObject modelObj, List<IStatus> statusList) {
		for (Throwable throwable : modelObj.getLoadErrors()) {
			statusList.add(new Status(IStatus.WARNING, "org.wso2.carbonstudio.eclipse.esb", String.format(
					"Error while loading model object: [%s]", modelObj.getClass().getCanonicalName()), throwable));
		}
	 ...
	 * @generated
	 */
	public EndPointAddressingVersion createEndPointAddressingVersionFromString(EDataType eDataType,
	                                                                           String initialValue) {
	 ...
	 * @generated
	 */
	public EndPointTimeOutAction createEndPointTimeOutActionFromString(EDataType eDataType,
	                                                                   String initialValue) {
	 ...
	 * @generated
	 */
	public EndPointMessageFormat createEndPointMessageFormatFromString(EDataType eDataType,
	                                                                   String initialValue) {
	 ...
	 * @generated
	 */
	public String convertEndPointAttachmentOptimizationToString(EDataType eDataType,
	 ...
	 * @generated
	 */
	public EndPointWsdlType createEndPointWsdlTypeFromString(EDataType eDataType,
	                                                         String initialValue) {
	 ...
	 * @generated
	 */
	public String convertEndPointWsdlTypeToString(EDataType eDataType, Object instanceValue) {
		return instanceValue == null ? null : instanceValue.toString();
	}
	 ...
	 * @generated
	 */
	public LoadBalanceAlgorithm createLoadBalanceAlgorithmFromString(EDataType eDataType,
	                                                                 String initialValue) {
	 ...
	 * @generated
	 */
	public LoadBalanceSessionType createLoadBalanceSessionTypeFromString(EDataType eDataType,
	                                                                     String initialValue) {
	 ...
	 * @generated
	 */
    public ModelObjectState createModelObjectStateFromString(EDataType eDataType, String initialValue) {
	 ...
	 * @generated
	 */
    public String convertModelObjectStateToString(EDataType eDataType, Object instanceValue) {
		return instanceValue == null ? null : instanceValue.toString();
	}
	 ...
	 * @generated
	 */
	public ProxySequenceType createProxySequenceTypeFromString(EDataType eDataType, String initialValue) {
	 ...
	 * @generated
	 */
	public String convertProxySequenceTypeToString(EDataType eDataType, Object instanceValue) {
		return instanceValue == null ? null : instanceValue.toString();
	}
	 ...
	 * @generated
	 */
	public ProxyEndpointType createProxyEndpointTypeFromString(EDataType eDataType, String initialValue) {
	 ...
	 * @generated
	 */
	public String convertProxyEndpointTypeToString(EDataType eDataType, Object instanceValue) {
		return instanceValue == null ? null : instanceValue.toString();
	}
