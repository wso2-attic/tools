 ...
 * <ul>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.ThrottleMediatorImpl#getGroupId <em>Group Id</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.ThrottleMediatorImpl#getPolicyConfiguration <em>Policy Configuration</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.ThrottleMediatorImpl#getOnAcceptBranch <em>On Accept Branch</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.ThrottleMediatorImpl#getOnRejectBranch <em>On Reject Branch</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ThrottleMediatorImpl extends MediatorImpl implements ThrottleMediator {
	...
	public NotificationChain basicSetOnAcceptBranch(ThrottleOnAcceptBranch newOnAcceptBranch, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MediatorPackage.THROTTLE_MEDIATOR__ON_ACCEPT_BRANCH, oldOnAcceptBranch, newOnAcceptBranch);
	...
	public void setOnAcceptBranch(ThrottleOnAcceptBranch newOnAcceptBranch) {
		if (newOnAcceptBranch != onAcceptBranch) {
			...
			if (onAcceptBranch != null)
				msgs = ((InternalEObject)onAcceptBranch).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MediatorPackage.THROTTLE_MEDIATOR__ON_ACCEPT_BRANCH, null, msgs);
			if (newOnAcceptBranch != null)
				msgs = ((InternalEObject)newOnAcceptBranch).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MediatorPackage.THROTTLE_MEDIATOR__ON_ACCEPT_BRANCH, null, msgs);
			msgs = basicSetOnAcceptBranch(newOnAcceptBranch, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.THROTTLE_MEDIATOR__ON_ACCEPT_BRANCH, newOnAcceptBranch, newOnAcceptBranch));
	}
	...
	public NotificationChain basicSetOnRejectBranch(ThrottleOnRejectBranch newOnRejectBranch, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MediatorPackage.THROTTLE_MEDIATOR__ON_REJECT_BRANCH, oldOnRejectBranch, newOnRejectBranch);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setOnRejectBranch(ThrottleOnRejectBranch newOnRejectBranch) {
		if (newOnRejectBranch != onRejectBranch) {
			...
			if (onRejectBranch != null)
				msgs = ((InternalEObject)onRejectBranch).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MediatorPackage.THROTTLE_MEDIATOR__ON_REJECT_BRANCH, null, msgs);
			if (newOnRejectBranch != null)
				msgs = ((InternalEObject)newOnRejectBranch).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MediatorPackage.THROTTLE_MEDIATOR__ON_REJECT_BRANCH, null, msgs);
			msgs = basicSetOnRejectBranch(newOnRejectBranch, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.THROTTLE_MEDIATOR__ON_REJECT_BRANCH, newOnRejectBranch, newOnRejectBranch));
	}
	...
	public void setGroupId(String newGroupId) {
		...
		groupId = newGroupId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.THROTTLE_MEDIATOR__GROUP_ID, oldGroupId, groupId));
	}
	...
	public NotificationChain basicSetPolicyConfiguration(ThrottlePolicyConfiguration newPolicyConfiguration, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MediatorPackage.THROTTLE_MEDIATOR__POLICY_CONFIGURATION, oldPolicyConfiguration, newPolicyConfiguration);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPolicyConfiguration(ThrottlePolicyConfiguration newPolicyConfiguration) {
		if (newPolicyConfiguration != policyConfiguration) {
			...
			if (policyConfiguration != null)
				msgs = ((InternalEObject)policyConfiguration).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MediatorPackage.THROTTLE_MEDIATOR__POLICY_CONFIGURATION, null, msgs);
			if (newPolicyConfiguration != null)
				msgs = ((InternalEObject)newPolicyConfiguration).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MediatorPackage.THROTTLE_MEDIATOR__POLICY_CONFIGURATION, null, msgs);
			msgs = basicSetPolicyConfiguration(newPolicyConfiguration, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.THROTTLE_MEDIATOR__POLICY_CONFIGURATION, newPolicyConfiguration, newPolicyConfiguration));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MediatorPackage.THROTTLE_MEDIATOR__POLICY_CONFIGURATION:
				return basicSetPolicyConfiguration(null, msgs);
			case MediatorPackage.THROTTLE_MEDIATOR__ON_ACCEPT_BRANCH:
				return basicSetOnAcceptBranch(null, msgs);
			case MediatorPackage.THROTTLE_MEDIATOR__ON_REJECT_BRANCH:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MediatorPackage.THROTTLE_MEDIATOR__GROUP_ID:
				return getGroupId();
			case MediatorPackage.THROTTLE_MEDIATOR__POLICY_CONFIGURATION:
