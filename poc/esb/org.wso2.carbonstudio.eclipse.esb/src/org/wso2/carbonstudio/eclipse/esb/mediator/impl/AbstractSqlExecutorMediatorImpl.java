 ...
 * <ul>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.AbstractSqlExecutorMediatorImpl#getConnectionType <em>Connection Type</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.AbstractSqlExecutorMediatorImpl#getConnectionDsType <em>Connection Ds Type</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.AbstractSqlExecutorMediatorImpl#getConnectionDbDriver <em>Connection Db Driver</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.AbstractSqlExecutorMediatorImpl#getConnectionDsInitialContext <em>Connection Ds Initial Context</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.AbstractSqlExecutorMediatorImpl#getConnectionDsName <em>Connection Ds Name</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.AbstractSqlExecutorMediatorImpl#getConnectionURL <em>Connection URL</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.AbstractSqlExecutorMediatorImpl#getConnectionUsername <em>Connection Username</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.AbstractSqlExecutorMediatorImpl#getConnectionPassword <em>Connection Password</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.AbstractSqlExecutorMediatorImpl#getPropertyAutocommit <em>Property Autocommit</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.AbstractSqlExecutorMediatorImpl#getPropertyIsolation <em>Property Isolation</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.AbstractSqlExecutorMediatorImpl#getPropertyMaxactive <em>Property Maxactive</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.AbstractSqlExecutorMediatorImpl#getPropertyMaxidle <em>Property Maxidle</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.AbstractSqlExecutorMediatorImpl#getPropertyMaxopenstatements <em>Property Maxopenstatements</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.AbstractSqlExecutorMediatorImpl#getPropertyMaxwait <em>Property Maxwait</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.AbstractSqlExecutorMediatorImpl#getPropertyMinidle <em>Property Minidle</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.AbstractSqlExecutorMediatorImpl#getPropertyPoolstatements <em>Property Poolstatements</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.AbstractSqlExecutorMediatorImpl#getPropertyTestonborrow <em>Property Testonborrow</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.AbstractSqlExecutorMediatorImpl#getPropertyTestwhileidle <em>Property Testwhileidle</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.AbstractSqlExecutorMediatorImpl#getPropertyValidationquery <em>Property Validationquery</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.AbstractSqlExecutorMediatorImpl#getPropertyInitialsize <em>Property Initialsize</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.AbstractSqlExecutorMediatorImpl#getSqlStatements <em>Sql Statements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class AbstractSqlExecutorMediatorImpl extends MediatorImpl implements AbstractSqlExecutorMediator {
	...
	public void setConnectionType(SqlExecutorConnectionType newConnectionType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.ABSTRACT_SQL_EXECUTOR_MEDIATOR__CONNECTION_TYPE, oldConnectionType, connectionType));
	}
	...
	public void setConnectionDsType(SqlExecutorDatasourceType newConnectionDsType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.ABSTRACT_SQL_EXECUTOR_MEDIATOR__CONNECTION_DS_TYPE, oldConnectionDsType, connectionDsType));
	}
	...
	public void setConnectionDbDriver(String newConnectionDbDriver) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.ABSTRACT_SQL_EXECUTOR_MEDIATOR__CONNECTION_DB_DRIVER, oldConnectionDbDriver, connectionDbDriver));
	}
	...
	public void setConnectionDsInitialContext(String newConnectionDsInitialContext) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.ABSTRACT_SQL_EXECUTOR_MEDIATOR__CONNECTION_DS_INITIAL_CONTEXT, oldConnectionDsInitialContext, connectionDsInitialContext));
	}
	...
	public void setConnectionDsName(String newConnectionDsName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.ABSTRACT_SQL_EXECUTOR_MEDIATOR__CONNECTION_DS_NAME, oldConnectionDsName, connectionDsName));
	}
	...
	public void setConnectionURL(String newConnectionURL) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.ABSTRACT_SQL_EXECUTOR_MEDIATOR__CONNECTION_URL, oldConnectionURL, connectionURL));
	}
	...
	public void setConnectionUsername(String newConnectionUsername) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.ABSTRACT_SQL_EXECUTOR_MEDIATOR__CONNECTION_USERNAME, oldConnectionUsername, connectionUsername));
	}
	...
	public void setConnectionPassword(String newConnectionPassword) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.ABSTRACT_SQL_EXECUTOR_MEDIATOR__CONNECTION_PASSWORD, oldConnectionPassword, connectionPassword));
	}
	...
	public void setPropertyAutocommit(SqlExecutorBooleanValue newPropertyAutocommit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.ABSTRACT_SQL_EXECUTOR_MEDIATOR__PROPERTY_AUTOCOMMIT, oldPropertyAutocommit, propertyAutocommit));
	}
	...
	public void setPropertyIsolation(SqlExecutorIsolationLevel newPropertyIsolation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.ABSTRACT_SQL_EXECUTOR_MEDIATOR__PROPERTY_ISOLATION, oldPropertyIsolation, propertyIsolation));
	}
	...
	public void setPropertyMaxactive(int newPropertyMaxactive) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.ABSTRACT_SQL_EXECUTOR_MEDIATOR__PROPERTY_MAXACTIVE, oldPropertyMaxactive, propertyMaxactive));
	}
	...
	public void setPropertyMaxidle(int newPropertyMaxidle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.ABSTRACT_SQL_EXECUTOR_MEDIATOR__PROPERTY_MAXIDLE, oldPropertyMaxidle, propertyMaxidle));
	}
	...
	public void setPropertyMaxopenstatements(int newPropertyMaxopenstatements) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.ABSTRACT_SQL_EXECUTOR_MEDIATOR__PROPERTY_MAXOPENSTATEMENTS, oldPropertyMaxopenstatements, propertyMaxopenstatements));
	}
	...
	public void setPropertyMaxwait(int newPropertyMaxwait) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.ABSTRACT_SQL_EXECUTOR_MEDIATOR__PROPERTY_MAXWAIT, oldPropertyMaxwait, propertyMaxwait));
	}
	...
	public void setPropertyMinidle(int newPropertyMinidle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.ABSTRACT_SQL_EXECUTOR_MEDIATOR__PROPERTY_MINIDLE, oldPropertyMinidle, propertyMinidle));
	}
	...
	public void setPropertyPoolstatements(SqlExecutorBooleanValue newPropertyPoolstatements) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.ABSTRACT_SQL_EXECUTOR_MEDIATOR__PROPERTY_POOLSTATEMENTS, oldPropertyPoolstatements, propertyPoolstatements));
	}
	...
	public void setPropertyTestonborrow(SqlExecutorBooleanValue newPropertyTestonborrow) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.ABSTRACT_SQL_EXECUTOR_MEDIATOR__PROPERTY_TESTONBORROW, oldPropertyTestonborrow, propertyTestonborrow));
	}
	...
	public void setPropertyTestwhileidle(SqlExecutorBooleanValue newPropertyTestwhileidle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.ABSTRACT_SQL_EXECUTOR_MEDIATOR__PROPERTY_TESTWHILEIDLE, oldPropertyTestwhileidle, propertyTestwhileidle));
	}
	...
	public void setPropertyValidationquery(String newPropertyValidationquery) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.ABSTRACT_SQL_EXECUTOR_MEDIATOR__PROPERTY_VALIDATIONQUERY, oldPropertyValidationquery, propertyValidationquery));
	}
	...
	public void setPropertyInitialsize(int newPropertyInitialsize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.ABSTRACT_SQL_EXECUTOR_MEDIATOR__PROPERTY_INITIALSIZE, oldPropertyInitialsize, propertyInitialsize));
	}
	...
	public EList<SqlStatement> getSqlStatements() {
		if (sqlStatements == null) {
			sqlStatements = new EObjectContainmentEList<SqlStatement>(SqlStatement.class, this, MediatorPackage.ABSTRACT_SQL_EXECUTOR_MEDIATOR__SQL_STATEMENTS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MediatorPackage.ABSTRACT_SQL_EXECUTOR_MEDIATOR__SQL_STATEMENTS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MediatorPackage.ABSTRACT_SQL_EXECUTOR_MEDIATOR__CONNECTION_TYPE:
				return getConnectionType();
			case MediatorPackage.ABSTRACT_SQL_EXECUTOR_MEDIATOR__CONNECTION_DS_TYPE:
				return getConnectionDsType();
			case MediatorPackage.ABSTRACT_SQL_EXECUTOR_MEDIATOR__CONNECTION_DB_DRIVER:
				return getConnectionDbDriver();
			case MediatorPackage.ABSTRACT_SQL_EXECUTOR_MEDIATOR__CONNECTION_DS_INITIAL_CONTEXT:
				return getConnectionDsInitialContext();
			case MediatorPackage.ABSTRACT_SQL_EXECUTOR_MEDIATOR__CONNECTION_DS_NAME:
				return getConnectionDsName();
			case MediatorPackage.ABSTRACT_SQL_EXECUTOR_MEDIATOR__CONNECTION_URL:
				return getConnectionURL();
			case MediatorPackage.ABSTRACT_SQL_EXECUTOR_MEDIATOR__CONNECTION_USERNAME:
				return getConnectionUsername();
			case MediatorPackage.ABSTRACT_SQL_EXECUTOR_MEDIATOR__CONNECTION_PASSWORD:
				return getConnectionPassword();
			case MediatorPackage.ABSTRACT_SQL_EXECUTOR_MEDIATOR__PROPERTY_AUTOCOMMIT:
				return getPropertyAutocommit();
			case MediatorPackage.ABSTRACT_SQL_EXECUTOR_MEDIATOR__PROPERTY_ISOLATION:
				return getPropertyIsolation();
			case MediatorPackage.ABSTRACT_SQL_EXECUTOR_MEDIATOR__PROPERTY_MAXACTIVE:
				return getPropertyMaxactive();
			case MediatorPackage.ABSTRACT_SQL_EXECUTOR_MEDIATOR__PROPERTY_MAXIDLE:
				return getPropertyMaxidle();
			case MediatorPackage.ABSTRACT_SQL_EXECUTOR_MEDIATOR__PROPERTY_MAXOPENSTATEMENTS:
				return getPropertyMaxopenstatements();
			case MediatorPackage.ABSTRACT_SQL_EXECUTOR_MEDIATOR__PROPERTY_MAXWAIT:
				return getPropertyMaxwait();
			case MediatorPackage.ABSTRACT_SQL_EXECUTOR_MEDIATOR__PROPERTY_MINIDLE:
				return getPropertyMinidle();
			case MediatorPackage.ABSTRACT_SQL_EXECUTOR_MEDIATOR__PROPERTY_POOLSTATEMENTS:
				return getPropertyPoolstatements();
			case MediatorPackage.ABSTRACT_SQL_EXECUTOR_MEDIATOR__PROPERTY_TESTONBORROW:
				return getPropertyTestonborrow();
			case MediatorPackage.ABSTRACT_SQL_EXECUTOR_MEDIATOR__PROPERTY_TESTWHILEIDLE:
				return getPropertyTestwhileidle();
			case MediatorPackage.ABSTRACT_SQL_EXECUTOR_MEDIATOR__PROPERTY_VALIDATIONQUERY:
				return getPropertyValidationquery();
			case MediatorPackage.ABSTRACT_SQL_EXECUTOR_MEDIATOR__PROPERTY_INITIALSIZE:
