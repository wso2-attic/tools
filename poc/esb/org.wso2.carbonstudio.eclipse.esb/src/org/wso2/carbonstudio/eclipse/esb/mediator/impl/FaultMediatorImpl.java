 ...
 * <ul>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.FaultMediatorImpl#getSoapVersion <em>Soap Version</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.FaultMediatorImpl#getFaultCodeSoap11 <em>Fault Code Soap11</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.FaultMediatorImpl#getFaultStringType <em>Fault String Type</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.FaultMediatorImpl#getFaultStringValue <em>Fault String Value</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.FaultMediatorImpl#getFaultStringExpression <em>Fault String Expression</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.FaultMediatorImpl#getFaultActor <em>Fault Actor</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.FaultMediatorImpl#getFaultCodeSoap12 <em>Fault Code Soap12</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.FaultMediatorImpl#getFaultReasonType <em>Fault Reason Type</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.FaultMediatorImpl#getFaultReasonValue <em>Fault Reason Value</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.FaultMediatorImpl#getFaultReasonExpression <em>Fault Reason Expression</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.FaultMediatorImpl#getRoleName <em>Role Name</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.FaultMediatorImpl#getNodeName <em>Node Name</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.FaultMediatorImpl#getFaultDetailType <em>Fault Detail Type</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.FaultMediatorImpl#getFaultDetailValue <em>Fault Detail Value</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.FaultMediatorImpl#getFaultDetailExpression <em>Fault Detail Expression</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FaultMediatorImpl extends MediatorImpl implements FaultMediator {
	...
	protected EClass eStaticClass() {
		return MediatorPackage.Literals.FAULT_MEDIATOR;
	}
	...
	public void setSoapVersion(FaultSoapVersion newSoapVersion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.FAULT_MEDIATOR__SOAP_VERSION, oldSoapVersion, soapVersion));
	}
	...
	public void setFaultCodeSoap11(FaultCodeSoap11 newFaultCodeSoap11) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.FAULT_MEDIATOR__FAULT_CODE_SOAP11, oldFaultCodeSoap11, faultCodeSoap11));
	}
	...
	public void setFaultCodeSoap12(FaultCodeSoap12 newFaultCodeSoap12) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.FAULT_MEDIATOR__FAULT_CODE_SOAP12, oldFaultCodeSoap12, faultCodeSoap12));
	}
	...
	public void setFaultReasonType(FaultReasonType newFaultReasonType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.FAULT_MEDIATOR__FAULT_REASON_TYPE, oldFaultReasonType, faultReasonType));
	}
	...
	public void setFaultReasonValue(String newFaultReasonValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.FAULT_MEDIATOR__FAULT_REASON_VALUE, oldFaultReasonValue, faultReasonValue));
	}
	...
	public NotificationChain basicSetFaultReasonExpression(NamespacedProperty newFaultReasonExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MediatorPackage.FAULT_MEDIATOR__FAULT_REASON_EXPRESSION, oldFaultReasonExpression, newFaultReasonExpression);
	...
	public void setFaultReasonExpression(NamespacedProperty newFaultReasonExpression) {
		if (newFaultReasonExpression != faultReasonExpression) {
			...
			if (faultReasonExpression != null)
				msgs = ((InternalEObject)faultReasonExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MediatorPackage.FAULT_MEDIATOR__FAULT_REASON_EXPRESSION, null, msgs);
			if (newFaultReasonExpression != null)
				msgs = ((InternalEObject)newFaultReasonExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MediatorPackage.FAULT_MEDIATOR__FAULT_REASON_EXPRESSION, null, msgs);
			msgs = basicSetFaultReasonExpression(newFaultReasonExpression, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.FAULT_MEDIATOR__FAULT_REASON_EXPRESSION, newFaultReasonExpression, newFaultReasonExpression));
	}
	...
	public void setRoleName(String newRoleName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.FAULT_MEDIATOR__ROLE_NAME, oldRoleName, roleName));
	}
	...
	public void setNodeName(String newNodeName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.FAULT_MEDIATOR__NODE_NAME, oldNodeName, nodeName));
	}
	...
	public void setFaultDetailType(FaultDetailType newFaultDetailType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.FAULT_MEDIATOR__FAULT_DETAIL_TYPE, oldFaultDetailType, faultDetailType));
	}
	...
	public void setFaultDetailValue(String newFaultDetailValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.FAULT_MEDIATOR__FAULT_DETAIL_VALUE, oldFaultDetailValue, faultDetailValue));
	}
	...
	public NotificationChain basicSetFaultDetailExpression(NamespacedProperty newFaultDetailExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MediatorPackage.FAULT_MEDIATOR__FAULT_DETAIL_EXPRESSION, oldFaultDetailExpression, newFaultDetailExpression);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setFaultDetailExpression(NamespacedProperty newFaultDetailExpression) {
		if (newFaultDetailExpression != faultDetailExpression) {
			...
			if (faultDetailExpression != null)
				msgs = ((InternalEObject)faultDetailExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MediatorPackage.FAULT_MEDIATOR__FAULT_DETAIL_EXPRESSION, null, msgs);
			if (newFaultDetailExpression != null)
				msgs = ((InternalEObject)newFaultDetailExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MediatorPackage.FAULT_MEDIATOR__FAULT_DETAIL_EXPRESSION, null, msgs);
			msgs = basicSetFaultDetailExpression(newFaultDetailExpression, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.FAULT_MEDIATOR__FAULT_DETAIL_EXPRESSION, newFaultDetailExpression, newFaultDetailExpression));
	}
	...
	public void setFaultStringType(FaultStringType newFaultStringType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.FAULT_MEDIATOR__FAULT_STRING_TYPE, oldFaultStringType, faultStringType));
	}
	...
	public void setFaultStringValue(String newFaultStringValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.FAULT_MEDIATOR__FAULT_STRING_VALUE, oldFaultStringValue, faultStringValue));
	}
	...
	public NotificationChain basicSetFaultStringExpression(NamespacedProperty newFaultStringExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MediatorPackage.FAULT_MEDIATOR__FAULT_STRING_EXPRESSION, oldFaultStringExpression, newFaultStringExpression);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setFaultStringExpression(NamespacedProperty newFaultStringExpression) {
		if (newFaultStringExpression != faultStringExpression) {
			...
			if (faultStringExpression != null)
				msgs = ((InternalEObject)faultStringExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MediatorPackage.FAULT_MEDIATOR__FAULT_STRING_EXPRESSION, null, msgs);
			if (newFaultStringExpression != null)
				msgs = ((InternalEObject)newFaultStringExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MediatorPackage.FAULT_MEDIATOR__FAULT_STRING_EXPRESSION, null, msgs);
			msgs = basicSetFaultStringExpression(newFaultStringExpression, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.FAULT_MEDIATOR__FAULT_STRING_EXPRESSION, newFaultStringExpression, newFaultStringExpression));
	}
	...
	public void setFaultActor(String newFaultActor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.FAULT_MEDIATOR__FAULT_ACTOR, oldFaultActor, faultActor));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MediatorPackage.FAULT_MEDIATOR__FAULT_STRING_EXPRESSION:
				return basicSetFaultStringExpression(null, msgs);
			case MediatorPackage.FAULT_MEDIATOR__FAULT_REASON_EXPRESSION:
				return basicSetFaultReasonExpression(null, msgs);
			case MediatorPackage.FAULT_MEDIATOR__FAULT_DETAIL_EXPRESSION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MediatorPackage.FAULT_MEDIATOR__SOAP_VERSION:
				return getSoapVersion();
			case MediatorPackage.FAULT_MEDIATOR__FAULT_CODE_SOAP11:
				return getFaultCodeSoap11();
			case MediatorPackage.FAULT_MEDIATOR__FAULT_STRING_TYPE:
				return getFaultStringType();
			case MediatorPackage.FAULT_MEDIATOR__FAULT_STRING_VALUE:
				return getFaultStringValue();
			case MediatorPackage.FAULT_MEDIATOR__FAULT_STRING_EXPRESSION:
				return getFaultStringExpression();
			case MediatorPackage.FAULT_MEDIATOR__FAULT_ACTOR:
				return getFaultActor();
			case MediatorPackage.FAULT_MEDIATOR__FAULT_CODE_SOAP12:
				return getFaultCodeSoap12();
			case MediatorPackage.FAULT_MEDIATOR__FAULT_REASON_TYPE:
				return getFaultReasonType();
			case MediatorPackage.FAULT_MEDIATOR__FAULT_REASON_VALUE:
				return getFaultReasonValue();
			case MediatorPackage.FAULT_MEDIATOR__FAULT_REASON_EXPRESSION:
				return getFaultReasonExpression();
			case MediatorPackage.FAULT_MEDIATOR__ROLE_NAME:
				return getRoleName();
			case MediatorPackage.FAULT_MEDIATOR__NODE_NAME:
				return getNodeName();
			case MediatorPackage.FAULT_MEDIATOR__FAULT_DETAIL_TYPE:
				return getFaultDetailType();
			case MediatorPackage.FAULT_MEDIATOR__FAULT_DETAIL_VALUE:
