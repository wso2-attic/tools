 ...
 * <ul>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.FilterMediatorImpl#getConditionType <em>Condition Type</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.FilterMediatorImpl#getFilterXpath <em>Filter Xpath</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.FilterMediatorImpl#getFilterSource <em>Filter Source</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.FilterMediatorImpl#getFilterRegex <em>Filter Regex</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.FilterMediatorImpl#getThenBranch <em>Then Branch</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.FilterMediatorImpl#getElseBranch <em>Else Branch</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FilterMediatorImpl extends MediatorImpl implements FilterMediator {
	...
	protected EClass eStaticClass() {
		return MediatorPackage.Literals.FILTER_MEDIATOR;
	}
	...
	public void setConditionType(FilterConditionType newConditionType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.FILTER_MEDIATOR__CONDITION_TYPE, oldConditionType, conditionType));
	}
	...
	public NotificationChain basicSetFilterXpath(NamespacedProperty newFilterXpath, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MediatorPackage.FILTER_MEDIATOR__FILTER_XPATH, oldFilterXpath, newFilterXpath);
	...
	public void setFilterXpath(NamespacedProperty newFilterXpath) {
		if (newFilterXpath != filterXpath) {
			...
			if (filterXpath != null)
				msgs = ((InternalEObject)filterXpath).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MediatorPackage.FILTER_MEDIATOR__FILTER_XPATH, null, msgs);
			if (newFilterXpath != null)
				msgs = ((InternalEObject)newFilterXpath).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MediatorPackage.FILTER_MEDIATOR__FILTER_XPATH, null, msgs);
			msgs = basicSetFilterXpath(newFilterXpath, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.FILTER_MEDIATOR__FILTER_XPATH, newFilterXpath, newFilterXpath));
	}
	...
	public NotificationChain basicSetFilterSource(NamespacedProperty newFilterSource, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MediatorPackage.FILTER_MEDIATOR__FILTER_SOURCE, oldFilterSource, newFilterSource);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setFilterSource(NamespacedProperty newFilterSource) {
		if (newFilterSource != filterSource) {
			...
			if (filterSource != null)
				msgs = ((InternalEObject)filterSource).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MediatorPackage.FILTER_MEDIATOR__FILTER_SOURCE, null, msgs);
			if (newFilterSource != null)
				msgs = ((InternalEObject)newFilterSource).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MediatorPackage.FILTER_MEDIATOR__FILTER_SOURCE, null, msgs);
			msgs = basicSetFilterSource(newFilterSource, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.FILTER_MEDIATOR__FILTER_SOURCE, newFilterSource, newFilterSource));
	}
	...
	public void setFilterRegex(String newFilterRegex) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.FILTER_MEDIATOR__FILTER_REGEX, oldFilterRegex, filterRegex));
	}
	...
	public NotificationChain basicSetThenBranch(FilterThenBranch newThenBranch, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MediatorPackage.FILTER_MEDIATOR__THEN_BRANCH, oldThenBranch, newThenBranch);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setThenBranch(FilterThenBranch newThenBranch) {
		if (newThenBranch != thenBranch) {
			NotificationChain msgs = null;
			if (thenBranch != null)
				msgs = ((InternalEObject)thenBranch).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MediatorPackage.FILTER_MEDIATOR__THEN_BRANCH, null, msgs);
			if (newThenBranch != null)
				msgs = ((InternalEObject)newThenBranch).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MediatorPackage.FILTER_MEDIATOR__THEN_BRANCH, null, msgs);
			msgs = basicSetThenBranch(newThenBranch, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.FILTER_MEDIATOR__THEN_BRANCH, newThenBranch, newThenBranch));
	}
	...
	public NotificationChain basicSetElseBranch(FilterElseBranch newElseBranch, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MediatorPackage.FILTER_MEDIATOR__ELSE_BRANCH, oldElseBranch, newElseBranch);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setElseBranch(FilterElseBranch newElseBranch) {
		if (newElseBranch != elseBranch) {
			NotificationChain msgs = null;
			if (elseBranch != null)
				msgs = ((InternalEObject)elseBranch).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MediatorPackage.FILTER_MEDIATOR__ELSE_BRANCH, null, msgs);
			if (newElseBranch != null)
				msgs = ((InternalEObject)newElseBranch).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MediatorPackage.FILTER_MEDIATOR__ELSE_BRANCH, null, msgs);
			msgs = basicSetElseBranch(newElseBranch, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.FILTER_MEDIATOR__ELSE_BRANCH, newElseBranch, newElseBranch));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MediatorPackage.FILTER_MEDIATOR__FILTER_XPATH:
				return basicSetFilterXpath(null, msgs);
			case MediatorPackage.FILTER_MEDIATOR__FILTER_SOURCE:
				return basicSetFilterSource(null, msgs);
			case MediatorPackage.FILTER_MEDIATOR__THEN_BRANCH:
				return basicSetThenBranch(null, msgs);
			case MediatorPackage.FILTER_MEDIATOR__ELSE_BRANCH:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MediatorPackage.FILTER_MEDIATOR__CONDITION_TYPE:
				return getConditionType();
			case MediatorPackage.FILTER_MEDIATOR__FILTER_XPATH:
				return getFilterXpath();
			case MediatorPackage.FILTER_MEDIATOR__FILTER_SOURCE:
				return getFilterSource();
			case MediatorPackage.FILTER_MEDIATOR__FILTER_REGEX:
