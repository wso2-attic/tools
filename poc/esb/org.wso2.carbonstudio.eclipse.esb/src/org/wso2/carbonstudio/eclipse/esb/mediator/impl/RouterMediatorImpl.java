 ...
 * <ul>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.RouterMediatorImpl#isContinueAfterRouting <em>Continue After Routing</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.RouterMediatorImpl#getRoutes <em>Routes</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RouterMediatorImpl extends MediatorImpl implements RouterMediator {
	...
	protected EClass eStaticClass() {
		return MediatorPackage.Literals.ROUTER_MEDIATOR;
	}
	...
	public void setContinueAfterRouting(boolean newContinueAfterRouting) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.ROUTER_MEDIATOR__CONTINUE_AFTER_ROUTING, oldContinueAfterRouting, continueAfterRouting));
	}
	...
	public EList<RouterRoute> getRoutes() {
		if (routes == null) {
			routes = new EObjectContainmentEList<RouterRoute>(RouterRoute.class, this, MediatorPackage.ROUTER_MEDIATOR__ROUTES);
		}
		return routes;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MediatorPackage.ROUTER_MEDIATOR__ROUTES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MediatorPackage.ROUTER_MEDIATOR__CONTINUE_AFTER_ROUTING:
