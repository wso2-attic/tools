 ...
 * <ul>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.SmooksOutConfigurationImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.SmooksOutConfigurationImpl#getExpression <em>Expression</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.SmooksOutConfigurationImpl#getProperty <em>Property</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.SmooksOutConfigurationImpl#getAction <em>Action</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.SmooksOutConfigurationImpl#getOutputMethod <em>Output Method</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SmooksOutConfigurationImpl extends ModelObjectImpl implements SmooksOutConfiguration {
	...
	protected EClass eStaticClass() {
		return MediatorPackage.Literals.SMOOKS_OUT_CONFIGURATION;
	}
	...
	public void setType(SmooksIODataType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.SMOOKS_OUT_CONFIGURATION__TYPE, oldType, type));
	}
	...
	public NamespacedProperty getExpression() {
		if (expression != null && expression.eIsProxy()) {
			...
			if (expression != oldExpression) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MediatorPackage.SMOOKS_OUT_CONFIGURATION__EXPRESSION, oldExpression, expression));
			}
		}
		return expression;
	}
	...
	public void setExpression(NamespacedProperty newExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.SMOOKS_OUT_CONFIGURATION__EXPRESSION, oldExpression, expression));
	}
	...
	public void setProperty(String newProperty) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.SMOOKS_OUT_CONFIGURATION__PROPERTY, oldProperty, property));
	}
	...
	public void setAction(ExpressionAction newAction) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.SMOOKS_OUT_CONFIGURATION__ACTION, oldAction, action));
	}
	...
	public void setOutputMethod(OutputMethod newOutputMethod) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.SMOOKS_OUT_CONFIGURATION__OUTPUT_METHOD, oldOutputMethod, outputMethod));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MediatorPackage.SMOOKS_OUT_CONFIGURATION__TYPE:
				return getType();
			case MediatorPackage.SMOOKS_OUT_CONFIGURATION__EXPRESSION:
				if (resolve) return getExpression();
				return basicGetExpression();
			case MediatorPackage.SMOOKS_OUT_CONFIGURATION__PROPERTY:
				return getProperty();
			case MediatorPackage.SMOOKS_OUT_CONFIGURATION__ACTION:
				return getAction();
			case MediatorPackage.SMOOKS_OUT_CONFIGURATION__OUTPUT_METHOD:
