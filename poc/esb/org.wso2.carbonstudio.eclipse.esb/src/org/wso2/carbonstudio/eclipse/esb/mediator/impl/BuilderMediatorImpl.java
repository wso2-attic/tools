 ...
 * <ul>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.BuilderMediatorImpl#getMessageBuilders <em>Message Builders</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BuilderMediatorImpl extends MediatorImpl implements BuilderMediator {
	...
	protected EClass eStaticClass() {
		return MediatorPackage.Literals.BUILDER_MEDIATOR;
	}
	...
	public EList<MessageBuilder> getMessageBuilders() {
		if (messageBuilders == null) {
			messageBuilders = new EObjectContainmentEList<MessageBuilder>(MessageBuilder.class, this, MediatorPackage.BUILDER_MEDIATOR__MESSAGE_BUILDERS);
		}
