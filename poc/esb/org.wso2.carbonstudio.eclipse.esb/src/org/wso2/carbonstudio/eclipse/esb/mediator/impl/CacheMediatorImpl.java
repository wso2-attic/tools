 ...
 * <ul>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.CacheMediatorImpl#getCacheId <em>Cache Id</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.CacheMediatorImpl#getCacheScope <em>Cache Scope</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.CacheMediatorImpl#getCacheAction <em>Cache Action</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.CacheMediatorImpl#getHashGenerator <em>Hash Generator</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.CacheMediatorImpl#getCacheTimeout <em>Cache Timeout</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.CacheMediatorImpl#getMaxMessageSize <em>Max Message Size</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.CacheMediatorImpl#getImplementationType <em>Implementation Type</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.CacheMediatorImpl#getMaxEntryCount <em>Max Entry Count</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.CacheMediatorImpl#getOnHitBranch <em>On Hit Branch</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CacheMediatorImpl extends MediatorImpl implements CacheMediator {
	...
	protected EClass eStaticClass() {
		return MediatorPackage.Literals.CACHE_MEDIATOR;
	}
	...
	public void setCacheId(String newCacheId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.CACHE_MEDIATOR__CACHE_ID, oldCacheId, cacheId));
	}
	...
	public void setCacheScope(CacheScope newCacheScope) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.CACHE_MEDIATOR__CACHE_SCOPE, oldCacheScope, cacheScope));
	}
	...
	public void setCacheAction(CacheAction newCacheAction) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.CACHE_MEDIATOR__CACHE_ACTION, oldCacheAction, cacheAction));
	}
	...
	public void setHashGenerator(String newHashGenerator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.CACHE_MEDIATOR__HASH_GENERATOR, oldHashGenerator, hashGenerator));
	}
	...
	public void setCacheTimeout(int newCacheTimeout) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.CACHE_MEDIATOR__CACHE_TIMEOUT, oldCacheTimeout, cacheTimeout));
	}
	...
	public void setMaxMessageSize(int newMaxMessageSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.CACHE_MEDIATOR__MAX_MESSAGE_SIZE, oldMaxMessageSize, maxMessageSize));
	}
	...
	public void setImplementationType(CacheImplementationType newImplementationType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.CACHE_MEDIATOR__IMPLEMENTATION_TYPE, oldImplementationType, implementationType));
	}
	...
	public void setMaxEntryCount(int newMaxEntryCount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.CACHE_MEDIATOR__MAX_ENTRY_COUNT, oldMaxEntryCount, maxEntryCount));
	}
	...
	public NotificationChain basicSetOnHitBranch(CacheOnHitBranch newOnHitBranch, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MediatorPackage.CACHE_MEDIATOR__ON_HIT_BRANCH, oldOnHitBranch, newOnHitBranch);
	...
	public void setOnHitBranch(CacheOnHitBranch newOnHitBranch) {
		if (newOnHitBranch != onHitBranch) {
			...
			if (onHitBranch != null)
				msgs = ((InternalEObject)onHitBranch).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MediatorPackage.CACHE_MEDIATOR__ON_HIT_BRANCH, null, msgs);
			if (newOnHitBranch != null)
				msgs = ((InternalEObject)newOnHitBranch).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MediatorPackage.CACHE_MEDIATOR__ON_HIT_BRANCH, null, msgs);
			msgs = basicSetOnHitBranch(newOnHitBranch, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.CACHE_MEDIATOR__ON_HIT_BRANCH, newOnHitBranch, newOnHitBranch));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MediatorPackage.CACHE_MEDIATOR__ON_HIT_BRANCH:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MediatorPackage.CACHE_MEDIATOR__CACHE_ID:
				return getCacheId();
			case MediatorPackage.CACHE_MEDIATOR__CACHE_SCOPE:
				return getCacheScope();
			case MediatorPackage.CACHE_MEDIATOR__CACHE_ACTION:
				return getCacheAction();
			case MediatorPackage.CACHE_MEDIATOR__HASH_GENERATOR:
				return getHashGenerator();
			case MediatorPackage.CACHE_MEDIATOR__CACHE_TIMEOUT:
				return getCacheTimeout();
			case MediatorPackage.CACHE_MEDIATOR__MAX_MESSAGE_SIZE:
				return getMaxMessageSize();
			case MediatorPackage.CACHE_MEDIATOR__IMPLEMENTATION_TYPE:
				return getImplementationType();
			case MediatorPackage.CACHE_MEDIATOR__MAX_ENTRY_COUNT:
