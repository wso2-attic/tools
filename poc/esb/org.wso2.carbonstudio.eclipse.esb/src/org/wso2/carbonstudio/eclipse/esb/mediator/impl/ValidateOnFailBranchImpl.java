...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>On Fail Branch</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * </p>
 *
...
public class ValidateOnFailBranchImpl extends MediatorBranchImpl implements ValidateOnFailBranch {
	...
	public Element doSave(Element parent) throws Exception {
		Element self = createChildElement(parent, "on-fail");
	...
	protected EClass eStaticClass() {
		return MediatorPackage.Literals.VALIDATE_ON_FAIL_BRANCH;
	}
