 ...
 * <ul>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.SqlResultMappingImpl#getPropertyName <em>Property Name</em>}</li>
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.mediator.impl.SqlResultMappingImpl#getColumnId <em>Column Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SqlResultMappingImpl extends ModelObjectImpl implements SqlResultMapping {
	...
	protected EClass eStaticClass() {
		return MediatorPackage.Literals.SQL_RESULT_MAPPING;
	}
	...
	public void setPropertyName(String newPropertyName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.SQL_RESULT_MAPPING__PROPERTY_NAME, oldPropertyName, propertyName));
	}
	...
	public void setColumnId(String newColumnId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorPackage.SQL_RESULT_MAPPING__COLUMN_ID, oldColumnId, columnId));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MediatorPackage.SQL_RESULT_MAPPING__PROPERTY_NAME:
				return getPropertyName();
			case MediatorPackage.SQL_RESULT_MAPPING__COLUMN_ID:
				return getColumnId();
		}
