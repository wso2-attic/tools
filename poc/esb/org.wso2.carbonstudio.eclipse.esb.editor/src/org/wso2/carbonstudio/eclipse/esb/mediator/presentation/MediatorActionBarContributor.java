...
/**
 * This is the action bar contributor for the Mediator model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MediatorActionBarContributor
	 ...
	 * @generated
	 */
	public MediatorActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("mediator-settings"));
		toolBarManager.add(new Separator("mediator-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(EsbEditorPlugin.INSTANCE.getString("_UI_MediatorEditor_menu"), "org.wso2.carbonstudio.eclipse.esb.mediatorMenuID");
