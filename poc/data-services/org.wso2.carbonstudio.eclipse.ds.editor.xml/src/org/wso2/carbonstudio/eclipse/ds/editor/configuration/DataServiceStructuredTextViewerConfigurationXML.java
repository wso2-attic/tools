...
package org.wso2.carbonstudio.eclipse.ds.editor.configuration;
...
import org.wso2.carbonstudio.eclipse.ds.editor.contentassistant.DataServiceContentAssistantProcessor;
import org.wso2.carbonstudio.eclipse.ds.editor.contentassistant.DataserviceQuickAssistantProcessor;
...
//		    if(partitionType == IStructuredPartitions.DEFAULT_PARTITION || partitionType == IXMLPartitions.XML_DEFAULT) {
		      return new IContentAssistProcessor[] {new DataServiceContentAssistantProcessor(sourceViewer)};
//		    }
