 ...
 * {@link org.wso2.carbonstudio.eclipse.ds.ParameterMapping} object. <!--
...
public class ParameterMappingItemProvider extends ItemProviderAdapter implements
	...
	protected void addParameterNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getResourceLocator(),
				getString("_UI_ParameterMapping_parameterName_feature_display"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_ParameterMapping_parameterName_feature", "_UI_ParameterMapping_type"),
				DsPackage.Literals.PARAMETER_MAPPING__PARAMETER_NAME, true, false, false,
	...
	protected void addColumnNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
				getResourceLocator(),
				getString("_UI_ParameterMapping_columnName_feature_display"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_ParameterMapping_columnName_feature", "_UI_ParameterMapping_type"),
				DsPackage.Literals.PARAMETER_MAPPING__COLUMN_NAME, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addQueryParamPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
				getResourceLocator(),
				getString("_UI_ParameterMapping_queryParam_feature_display"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_ParameterMapping_queryParam_feature", "_UI_ParameterMapping_type"),
				DsPackage.Literals.PARAMETER_MAPPING__QUERY_PARAM, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}

	/**
	 * This returns with-param.gif. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	 * @generated_not
	 */
	...
	public String getText(Object object) {
		String label = ((ParameterMapping) object).getParameterName();
