 ...
 * {@link org.wso2.carbonstudio.eclipse.ds.EventTrigger} object. <!--
...
public class EventTriggerItemProvider extends ItemProviderAdapter implements
	...
	protected void addIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getResourceLocator(),
				getString("_UI_EventTrigger_id_feature_display"),
				getString("_UI_PropertyDescriptor_description", "_UI_EventTrigger_id_feature",
						"_UI_EventTrigger_type"), DsPackage.Literals.EVENT_TRIGGER__ID, true,
	...
	protected void addExpressionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
				getResourceLocator(),
				getString("_UI_EventTrigger_expression_feature_display"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_EventTrigger_expression_feature", "_UI_EventTrigger_type"),
				DsPackage.Literals.EVENT_TRIGGER__EXPRESSION, true, false, false,
	...
	protected void addTargetTopicPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
				getResourceLocator(),
				getString("_UI_EventTrigger_targetTopic_feature_display"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_EventTrigger_targetTopic_feature", "_UI_EventTrigger_type"),
				DsPackage.Literals.EVENT_TRIGGER__TARGET_TOPIC, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addLanguagePropertyDescriptor(Object object) {
		DSPropertyDescriptor descriptor = new DSPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
				getResourceLocator(), getString("_UI_EventTrigger_language_feature_display"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_EventTrigger_language_feature", "_UI_EventTrigger_type"),
				DsPackage.Literals.EVENT_TRIGGER__LANGUAGE, false, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null, -1);
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DsPackage.Literals.EVENT_TRIGGER__SUBSCRIPTIONS_LIST);
		}
	...
	/**
	 * This returns event-trigger.gif. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	 * @generated_not
	 */
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(
				DsPackage.Literals.EVENT_TRIGGER__SUBSCRIPTIONS_LIST,
