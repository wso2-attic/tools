 ...
 * {@link org.wso2.carbonstudio.eclipse.ds.ElementMapping} object. <!--
...
public class ElementMappingItemProvider extends ItemProviderAdapter implements
	...
	protected void addElementNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getResourceLocator(),
				getString("_UI_ElementMapping_elementName_feature_display"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_ElementMapping_elementName_feature", "_UI_ElementMapping_type"),
				DsPackage.Literals.ELEMENT_MAPPING__ELEMENT_NAME, true, false, false,
	...
	protected void addColumnNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
				getResourceLocator(),
				getString("_UI_ElementMapping_columnName_feature_display"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_ElementMapping_columnName_feature", "_UI_ElementMapping_type"),
				DsPackage.Literals.ELEMENT_MAPPING__COLUMN_NAME, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addQueryParamPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
				getResourceLocator(),
				getString("_UI_ElementMapping_queryParam_feature_display"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_ElementMapping_queryParam_feature", "_UI_ElementMapping_type"),
				DsPackage.Literals.ELEMENT_MAPPING__QUERY_PARAM, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addRequiredRolesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
				getResourceLocator(),
				getString("_UI_ElementMapping_requiredRoles_feature_display"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_ElementMapping_requiredRoles_feature", "_UI_ElementMapping_type"),
				DsPackage.Literals.ELEMENT_MAPPING__REQUIRED_ROLES, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addXsdTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(new DSPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
				getResourceLocator(), getString("_UI_ElementMapping_xsdType_feature_display"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_ElementMapping_xsdType_feature", "_UI_ElementMapping_type"),
				DsPackage.Literals.ELEMENT_MAPPING__XSD_TYPE, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null,
	...
	public String getText(Object object) {
		String label = ((ElementMapping) object).getElementName();
