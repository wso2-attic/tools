 ...
 * {@link org.wso2.carbonstudio.eclipse.ds.Operation} object. <!--
...
public class OperationItemProvider extends ItemProviderAdapter implements
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getResourceLocator(),
				getString("_UI_Operation_name_feature_display"),
				getString("_UI_PropertyDescriptor_description", "_UI_Operation_name_feature",
						"_UI_Operation_type"), DsPackage.Literals.OPERATION__NAME, true, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DsPackage.Literals.OPERATION__CALL_QUERY_LIST);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(DsPackage.Literals.OPERATION__CALL_QUERY,
				DsFactory.eINSTANCE.createCallQuery()));

		newChildDescriptors.add(createChildParameter(DsPackage.Literals.OPERATION__CALL_QUERY_LIST,
