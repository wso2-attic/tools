 ...
 * {@link org.wso2.carbonstudio.eclipse.ds.LengthValidator} object. <!--
...
public class LengthValidatorItemProvider extends ItemProviderAdapter implements
	...
	protected void addMinValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getResourceLocator(),
				getString("_UI_LengthValidator_minValue_feature_display"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_LengthValidator_minValue_feature", "_UI_LengthValidator_type"),
				DsPackage.Literals.LENGTH_VALIDATOR__MIN_VALUE, true, false, false,
	...
	protected void addMaxValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
				getResourceLocator(),
				getString("_UI_LengthValidator_maxValue_feature_display"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_LengthValidator_maxValue_feature", "_UI_LengthValidator_type"),
				DsPackage.Literals.LENGTH_VALIDATOR__MAX_VALUE, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}

	/**
	 * This returns validateLength.gif. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @generated_not
	 */
	...
	public String getText(Object object) {
		BigInteger labelValue = ((LengthValidator) object).getMinValue();
		String label = labelValue == null ? null : labelValue.toString();
		String type = " (" + getString("_UI_LengthValidator_type") + ")";
