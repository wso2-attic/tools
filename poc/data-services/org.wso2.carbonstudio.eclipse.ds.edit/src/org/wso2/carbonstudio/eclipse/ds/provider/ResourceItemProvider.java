 ...
 * {@link org.wso2.carbonstudio.eclipse.ds.Resource} object. <!-- begin-user-doc
 * --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class ResourceItemProvider extends ItemProviderAdapter implements
	...
	protected void addMethodPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getResourceLocator(),
				getString("_UI_Resource_method_feature_display"),
				getString("_UI_PropertyDescriptor_description", "_UI_Resource_method_feature",
						"_UI_Resource_type"), DsPackage.Literals.RESOURCE__METHOD, true, false,
	...
	protected void addPathPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
				getResourceLocator(),
				getString("_UI_Resource_path_feature_display"),
				getString("_UI_PropertyDescriptor_description", "_UI_Resource_path_feature",
						"_UI_Resource_type"), DsPackage.Literals.RESOURCE__PATH, true, false,
				false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DsPackage.Literals.RESOURCE__CALL_QUERY_LIST);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(DsPackage.Literals.RESOURCE__CALL_QUERY,
				DsFactory.eINSTANCE.createCallQuery()));

		newChildDescriptors.add(createChildParameter(DsPackage.Literals.RESOURCE__CALL_QUERY_LIST,
				DsFactory.eINSTANCE.createCallQueryList()));
	}
