 ...
 * {@link org.wso2.carbonstudio.eclipse.ds.ConfigurationProperty} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class ConfigurationPropertyItemProvider extends ItemProviderAdapter implements
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getResourceLocator(),
						getString("_UI_ConfigurationProperty_name_feature_display"),
						getString("_UI_PropertyDescriptor_description",
								"_UI_ConfigurationProperty_name_feature",
	...
	protected void addValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(),
						getString("_UI_ConfigurationProperty_value_feature_display"),
						getString("_UI_PropertyDescriptor_description",
								"_UI_ConfigurationProperty_value_feature",
								"_UI_ConfigurationProperty_type"),
	...
	// getResourceLocator(),
	// getString("_UI_ConfigurationProperty_display_feature"),
	// getString("_UI_PropertyDescriptor_description",
	// "_UI_ConfigurationProperty_display_feature",
	// "_UI_ConfigurationProperty_type"),
	// DsPackage.Literals.CONFIGURATION_PROPERTY__DISPLAY, true,
	...
	public String getText(Object object) {
		// String label = ((ConfigurationProperty) object).getDisplay();
		// String value = ((ConfigurationProperty) object).getValue();
		// if(label == null || label.equals("")) {
		// label =
		// DSEditPropertiesLabelProvider.getInstance().getDisplayLabel(((ConfigurationProperty)
		// object).getName());
		// }

		// Remove this line
		String label = DSEditPropertiesLabelProvider.getInstance().getDisplayLabel(
				((ConfigurationProperty) object).getName());
