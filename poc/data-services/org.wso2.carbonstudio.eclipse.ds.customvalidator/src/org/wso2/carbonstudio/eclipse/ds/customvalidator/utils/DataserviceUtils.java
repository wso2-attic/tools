...
public class DataserviceUtils {
	...
	public static File getDataserviceCoreLibraryPath(){
		URL resource = Platform.getBundle(Activator.PLUGIN_ID).getResource("lib/org.wso2.carbon.dataservices.core-3.0.0.jar");
