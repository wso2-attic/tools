...
package org.wso2.carbonstudio.eclipse.capp.artifact.axis2.model;

import org.eclipse.core.resources.IFolder;
import org.eclipse.core.resources.IProject;
import org.wso2.carbonstudio.eclipse.capp.core.artifacts.IArtifactSourcePath;

public class Axis2ArtifactLocationNode implements IArtifactSourcePath{
	private String path;
	private IProject project;

	public Axis2ArtifactLocationNode(IProject project, String path){
		setPath(path);
		setProject(project);
	}
