...
public class CAppAxis2ServiceEditor extends FormEditor{
	private static ICarbonStudioLog log=Logger.getLog(Activator.PLUGIN_ID);

    private boolean dirty;
	private CAppAxis2ServiceEditorPage cAppAxis2ServiceEditorPage;

	protected void addPages() {
	    try {
	    	cAppAxis2ServiceEditorPage = new CAppAxis2ServiceEditorPage(this,"org.wso2.carbonstudio.capp.artifact.axis2.editor","Axis2 Editor");
    ...
    public void doSave(IProgressMonitor arg0) {
	    if (isDirty()){
	    	Axis2SourceDescriptor currentAxis2SourceDescriptor = cAppAxis2ServiceEditorPage.getCurrentAxis2SourceDescriptor();
	    	try {
	    		IFile file = ((FileEditorInput)this.getEditorInput().getPersistable()).getFile();
	    		ByteArrayInputStream editorInputData = new ByteArrayInputStream(Axis2ServiceSourceDescriptorUtils.saveAxis2SourceDescriptor(currentAxis2SourceDescriptor));
