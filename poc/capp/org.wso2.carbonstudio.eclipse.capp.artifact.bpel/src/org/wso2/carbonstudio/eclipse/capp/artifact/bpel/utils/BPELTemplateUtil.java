...
public class BPELTemplateUtil extends TemplateUtil{
	
	private static BPELTemplateUtil INSTANCE;

	private BPELTemplateUtil() {
    }
	
	public static BPELTemplateUtil getInstance(){
		if (INSTANCE==null){
			INSTANCE=new BPELTemplateUtil();
		}
		return INSTANCE;
	}
