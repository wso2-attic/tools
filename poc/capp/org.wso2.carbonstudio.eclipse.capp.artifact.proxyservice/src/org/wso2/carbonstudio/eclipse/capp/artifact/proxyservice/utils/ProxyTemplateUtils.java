...
public class ProxyTemplateUtils extends TemplateUtil {
	private static ProxyTemplateUtils INSTANCE;
	public static ProxyTemplateUtils getInstance(){
		if (INSTANCE==null){
			INSTANCE=new ProxyTemplateUtils();
		}
		return INSTANCE;
	}
