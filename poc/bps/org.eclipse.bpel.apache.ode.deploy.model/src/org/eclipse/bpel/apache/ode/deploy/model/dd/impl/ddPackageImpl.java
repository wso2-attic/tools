...
public class ddPackageImpl extends EPackageImpl implements ddPackage {
	 ...
	 * @generated
	 */
	private EClass tCleanupEClass = null;
	 ...
	 * @generated
	 */
	private EEnum onTypeEEnum = null;
	 ...
	 * @generated
	 */
	private EDataType onTypeObjectEDataType = null;
	...
	public EReference getProcessType_Cleanup() {
		return (EReference)processTypeEClass.getEStructuralFeatures().get(9);
	}
	...
	public EAttribute getTCleanup_Category() {
		return (EAttribute)tCleanupEClass.getEStructuralFeatures().get(0);
	}
	...
	public EAttribute getTCleanup_On() {
		return (EAttribute)tCleanupEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		createEReference(processTypeEClass, PROCESS_TYPE__CLEANUP);
		...
		tCleanupEClass = createEClass(TCLEANUP);
		createEAttribute(tCleanupEClass, TCLEANUP__CATEGORY);
		createEAttribute(tCleanupEClass, TCLEANUP__ON);
		...
		onTypeEEnum = createEEnum(ON_TYPE);
		...
		onTypeObjectEDataType = createEDataType(ON_TYPE_OBJECT);
	}
	...
	public void initializePackageContents() {
		...
		initEReference(getProcessType_Cleanup(), this.getTCleanup(), null, "cleanup", null, 0, 3, ProcessType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(tCleanupEClass, TCleanup.class, "TCleanup", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getTCleanup_Category(), this.getCategoryType(), "category", "all", 0, -1, TCleanup.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTCleanup_On(), this.getOnType(), "on", null, 1, 1, TCleanup.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEEnumLiteral(categoryTypeEEnum, CategoryType.INSTANCE);
		addEEnumLiteral(categoryTypeEEnum, CategoryType.VARIABLE);
		addEEnumLiteral(categoryTypeEEnum, CategoryType.MESSAGES);
		addEEnumLiteral(categoryTypeEEnum, CategoryType.CORRELATIONS);
		addEEnumLiteral(categoryTypeEEnum, CategoryType.EVENTS);
		addEEnumLiteral(categoryTypeEEnum, CategoryType.ALL);
		...
		initEEnum(onTypeEEnum, OnType.class, "OnType");
		addEEnumLiteral(onTypeEEnum, OnType.SUCCESS);
		addEEnumLiteral(onTypeEEnum, OnType.FAILURE);
		addEEnumLiteral(onTypeEEnum, OnType.ALWAYS);
		...
		initEDataType(onTypeObjectEDataType, OnType.class, "OnTypeObject", IS_SERIALIZABLE, IS_GENERATED_INSTANCE_CLASS);
	...
	protected void createExtendedMetaDataAnnotations() {
		...
		addAnnotation
		  (onTypeObjectEDataType, 
		   source, 
		   new String[] {
			 "name", "on_._type:Object",
			 "baseType", "on_._type"
		   });		
		addAnnotation
		  (processTypeEClass, 
