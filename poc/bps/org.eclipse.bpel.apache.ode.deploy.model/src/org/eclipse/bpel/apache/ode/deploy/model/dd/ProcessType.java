 ...
 *   <li>{@link org.eclipse.bpel.apache.ode.deploy.model.dd.ProcessType#getCleanup <em>Cleanup</em>}</li>
...
public interface ProcessType extends EObject {
	...
	/**
	 * Returns the value of the '<em><b>Cleanup</b></em>' containment reference list.
	 * The list contents are of type {@link org.eclipse.bpel.apache.ode.deploy.model.dd.TCleanup}.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Cleanup</em>' containment reference list isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Cleanup</em>' containment reference list.
	 * @see org.eclipse.bpel.apache.ode.deploy.model.dd.ddPackage#getProcessType_Cleanup()
	 * @model containment="true" upper="3"
	 * @generated
	 */
	EList<TCleanup> getCleanup();
