...
public class ddFactoryImpl extends EFactoryImpl implements ddFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case ddPackage.TCLEANUP: return createTCleanup();
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			...
			case ddPackage.ON_TYPE:
				return createOnTypeFromString(eDataType, initialValue);
			case ddPackage.CATEGORY_TYPE_OBJECT:
			...
			case ddPackage.ON_TYPE_OBJECT:
				return createOnTypeObjectFromString(eDataType, initialValue);
			default:
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		switch (eDataType.getClassifierID()) {
			...
			case ddPackage.ON_TYPE:
				return convertOnTypeToString(eDataType, instanceValue);
			case ddPackage.CATEGORY_TYPE_OBJECT:
			...
			case ddPackage.ON_TYPE_OBJECT:
				return convertOnTypeObjectToString(eDataType, instanceValue);
			default:
				throw new IllegalArgumentException("The datatype '" + eDataType.getName() + "' is not a valid classifier");
		}
	}
	...
	public TCleanup createTCleanup() {
		TCleanupImpl tCleanup = new TCleanupImpl();
		return tCleanup;
	}
	 ...
	 * @generated
	 */
	public OnType createOnTypeFromString(EDataType eDataType, String initialValue) {
		OnType result = OnType.get(initialValue);
		if (result == null) throw new IllegalArgumentException("The value '" + initialValue + "' is not a valid enumerator of '" + eDataType.getName() + "'");
		return result;
	}
	 ...
	 * @generated
	 */
	public String convertOnTypeToString(EDataType eDataType, Object instanceValue) {
		return instanceValue == null ? null : instanceValue.toString();
	}
	...
	public CategoryType createCategoryTypeObjectFromString(EDataType eDataType, String initialValue) {
		return createCategoryTypeFromString(ddPackage.Literals.CATEGORY_TYPE, initialValue);
	}
	...
	public String convertCategoryTypeObjectToString(EDataType eDataType, Object instanceValue) {
		return convertCategoryTypeToString(ddPackage.Literals.CATEGORY_TYPE, instanceValue);
	}
	 ...
	 * @generated
	 */
	public OnType createOnTypeObjectFromString(EDataType eDataType, String initialValue) {
		return createOnTypeFromString(ddPackage.Literals.ON_TYPE, initialValue);
	}
	 ...
	 * @generated
	 */
	public String convertOnTypeObjectToString(EDataType eDataType, Object instanceValue) {
		return convertOnTypeToString(ddPackage.Literals.ON_TYPE, instanceValue);
	}
