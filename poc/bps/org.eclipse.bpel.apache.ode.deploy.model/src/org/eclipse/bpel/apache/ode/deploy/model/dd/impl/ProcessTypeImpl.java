 ...
 *   <li>{@link org.eclipse.bpel.apache.ode.deploy.model.dd.impl.ProcessTypeImpl#getCleanup <em>Cleanup</em>}</li>
...
public class ProcessTypeImpl extends EObjectImpl implements ProcessType {
	...
	/**
	 * The cached value of the '{@link #getCleanup() <em>Cleanup</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getCleanup()
	 * @generated
	 * @ordered
	 */
	protected EList<TCleanup> cleanup;
	 ...
	 * @generated
	 */
	public EList<TCleanup> getCleanup() {
		if (cleanup == null) {
			cleanup = new EObjectContainmentEList<TCleanup>(TCleanup.class, this, ddPackage.PROCESS_TYPE__CLEANUP);
		}
		return cleanup;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case ddPackage.PROCESS_TYPE__CLEANUP:
				return ((InternalEList<?>)getCleanup()).basicRemove(otherEnd, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ddPackage.PROCESS_TYPE__CLEANUP:
				getCleanup().clear();
				getCleanup().addAll((Collection<? extends TCleanup>)newValue);
				return;
			case ddPackage.PROCESS_TYPE__BPEL11WSDL_FILE_NAME:
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case ddPackage.PROCESS_TYPE__CLEANUP:
				return cleanup != null && !cleanup.isEmpty();
			case ddPackage.PROCESS_TYPE__BPEL11WSDL_FILE_NAME:
