...
public class ddAdapterFactory extends AdapterFactoryImpl {
	...
	protected ddSwitch<Adapter> modelSwitch =
		new ddSwitch<Adapter>() {
			...
			@Override
			public Adapter caseTCleanup(TCleanup object) {
				return createTCleanupAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.bpel.apache.ode.deploy.model.dd.TCleanup <em>TCleanup</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
