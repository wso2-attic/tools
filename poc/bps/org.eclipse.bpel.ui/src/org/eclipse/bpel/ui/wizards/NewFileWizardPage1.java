...
public class NewFileWizardPage1 extends WizardPage 
{
    ...
    protected boolean validatePage() {
        ...
        if( mContainer.findMember(processNameField.getText()+".bpel")!=null ) //$NON-NLS-1$
        {
            setErrorMessage(Messages.NewFileWizardPage1_12);
            return false;                     
        } 
	...
	public void setContainer(IContainer mC) {
		mContainer=mC;		
	}
