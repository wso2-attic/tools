...
package org.wso2.carbonstudio.eclipse.carbonserver31.configuration;
	...
	public void createSection(Composite parent) {
		...
		usernameText.addModifyListener(new ModifyListener(){
			public void modifyText(ModifyEvent arg0) {
				CarbonServer31Utils.setServerUsername(server.getOriginal(), usernameText.getText());
			}
		...
		passwordText.addModifyListener(new ModifyListener(){
			public void modifyText(ModifyEvent arg0) {
				if (updatePassword)
					CarbonServer31Utils.setServerPassword(server.getOriginal(), passwordText.getText());
			}
