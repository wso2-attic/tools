...
public class CarbonServerUIUtil {
	...
	public static void createWSASServerCombo(Composite container,int cols, int[] supportOperations, CarbonServerInformation wsasServerInformation){
		try{
			//UIUtils uiUtils = new UIUtils(Activator.PLUGIN_ID);
			//uiUtils.createCombo(container, "WSAS Server list", "select the wsas server of which you want to perform the operation", null, SWT.READ_ONLY);
