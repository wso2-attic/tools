...
public class ConfigurationCredentialsEditorSection extends ServerEditorSection{
	...
	public void createSection(Composite parent) {
		...
		usernameText.addModifyListener(new ModifyListener(){
			public void modifyText(ModifyEvent arg0) {
				CarbonServer30Utils.setServerUsername(server.getOriginal(), usernameText.getText());
			}
		...
		passwordText.addModifyListener(new ModifyListener(){
			public void modifyText(ModifyEvent arg0) {
				if (updatePassword)
					CarbonServer30Utils.setServerPassword(server.getOriginal(), passwordText.getText());
			}
	...
	protected void initialize() {
		if (usernameText!=null && passwordText!=null){
			...
			try {
				serverCredentials = CarbonServerManager.getServerCredentials(server.getOriginal());
				usernameText.setText(serverCredentials.get(CarbonServerConstants.ESB_USERNAME));
				setPasswordTextBoxOnLostFocus();
			} catch (Exception e) {
				log.error(e);
			}
