...
//	private Button createPathButton;
	 ...
	 * @param folder
	 */
	public CheckingToRegistryDialog(Shell parentShell, IFolder folder) {
		super(parentShell);
		this.folder = folder;
	}
	...
	protected Control createDialogArea(final Composite parent) {
		parent.getShell().setText("Checking to the Registry");
		GridData gd;
...
//		});
		...
		urlText.setText("");
		pathText.setText("/_system/local/" + folder.getName());
