...
//			ArrayList<String> metaList=(ArrayList<String>) Arrays.asList(metaFolder.list());
	...
	public static void download(String username, String password,String filePath, 
		...
		org.wso2.carbonstudio.eclipse.greg.base.core.Registry registry = new org.wso2.carbonstudio.eclipse.greg.base.core.Registry(username,password,registryUrl);
