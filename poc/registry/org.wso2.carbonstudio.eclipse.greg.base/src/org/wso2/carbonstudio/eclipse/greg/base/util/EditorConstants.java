 ...
 */
package org.wso2.carbonstudio.eclipse.greg.base.util;

public class EditorConstants {

	public static final String COLLECTION_PAGE_ID = "Collection";
	public static final String COLLECTION_PAGE_TITLE = "Collection";

	public static final String RESOURCE_PAGE_ID = "Resource";
	public static final String RESOURCE_PAGE_TITLE = "Resource";

	public static final String PROPERTY_PAGE_ID = "property";
	public static final String PROPERTY_PAGE_TITLE = "Property";
	...
	public static String FORM_EDITOR_ID = "org.wso2.carbonstudio.eclipse.editors.registry.formEditor";
