...
public class CarbonStudioProviderUtils {
	...
	public static boolean isInProjectFilterPassed(Map<String, List<String>> filters,
		...
		boolean passed=true;
		if (CarbonStudioProviderUtils.isFilterPresent(filters,CSProviderConstants.FILTER_PROJECT)) {
			String projectName = registryResource.getProject().getName();
			passed=false;
			List<String> filterValues = CarbonStudioProviderUtils.getFilterValues(filters,CSProviderConstants.FILTER_PROJECT);
	...
	public static boolean isMediaTypeFilterPassed(
		...
		if (CarbonStudioProviderUtils.isFilterPresent(filters,
			...
			passed = false;
			if (mediaType != null) {
				List<String> filterValues = CarbonStudioProviderUtils
