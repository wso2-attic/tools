...
public class ServiceXSLValidator {

    public static String FILE_RESOURCE_MAP = "file.resource.map";
    public static final String SERVICES_XSL_LOCATION = "org/wso2/tools/aar/service-validator.xsl";
    public static final String SERVICES_XSL_FORMATTER_LOCATION =
            "org/wso2/tools/aar/service-formatter.xsl";
    ...
    public String validate(String fileId) throws AxisFault {
        ...
        try {
            ...
            if (!aarFileLocation.endsWith(".aar")) {
                ...
                ZipInputStream zin = new ZipInputStream(new FileInputStream(aarFileLocation));
                ZipEntry entry;
                ...
                if (!servicesXMLFound) {
                    throw new AxisFault(
                            "services.xml not found in " + DeploymentConstants.SERVICES_XML);
                }
...
//                    .getResourceAsStream(MODULE_XSL_LOCATION);
            ...
            InputStream xslForamtterStream =
                    getClass().getClassLoader().getResourceAsStream(SERVICES_XSL_FORMATTER_LOCATION);
