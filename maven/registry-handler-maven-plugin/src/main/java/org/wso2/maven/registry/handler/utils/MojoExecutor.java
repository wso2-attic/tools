...
import org.wso2.maven.registry.handler.utils.MojoExecutor.Element.ElementAttribute;
...
public class MojoExecutor {
    ...
    public static void executeMojo(Plugin plugin, String goal, Xpp3Dom configuration, ExecutionEnvironment env) throws MojoExecutionException {
        ...
        try {
            ...
            List<Plugin> buildPlugins = env.getMavenProject().getBuildPlugins();
...
//                    Plugin pomPlugin = (Plugin) iterator.next();
     ...
     * @return The element object
     */
    public static ElementAttribute elementAttribute(String name, String value) {
    ...
    public static class Element {
        ...
        private ElementAttribute[] attributes;
        ...
        public void addAttributes(ElementAttribute...attributes){
        ...
        public static class ElementAttribute{
            ...
            public static ElementAttribute attribute(String name, String value) {
                return new ElementAttribute(name, value);
            }
