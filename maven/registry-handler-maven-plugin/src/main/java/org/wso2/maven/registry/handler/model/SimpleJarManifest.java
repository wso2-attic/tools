...
public class SimpleJarManifest extends AbstractManifest {
	...
	public String toString() {
		String manifest;
		manifest=appendLine(null, getManifestHeaderLine(new ManifestHeader("Manifest-Version",getManifestVersion())));
	...
	public String getManifestHeaderLine(ManifestHeader header){
		return header.getHeaderName()+": "+header.getHeaderValue();
	}
