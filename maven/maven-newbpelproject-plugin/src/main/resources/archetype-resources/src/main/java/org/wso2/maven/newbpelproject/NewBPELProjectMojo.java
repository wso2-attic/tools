package org.wso2.maven.newbpelproject;
...
/**
 * This is the Maven Mojo used for BPEL project to be copied to the output
 * directory in the resource-process phase.
 *
 * @goal package-newbpelproject
 *
 */
public class NewBPELProjectMojo extends AbstractMojo{
	/**
