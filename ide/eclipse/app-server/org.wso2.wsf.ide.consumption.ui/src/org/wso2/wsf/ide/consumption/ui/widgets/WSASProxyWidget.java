...
public class WSASProxyWidget extends SimpleWidgetDataContributor {
	...
	public WidgetDataEvents addControls( Composite parent, Listener statusListener )
	{
		...
		// unwrap classes
		unwrapClassesCheckBoxButton = new Button(mainComp, SWT.CHECK);
		gd = new GridData(GridData.FILL_HORIZONTAL);
		gd.horizontalSpan = 3;
		unwrapClassesCheckBoxButton .setLayoutData(gd);
		unwrapClassesCheckBoxButton .setSelection(context.isClientUnpackClasses());
		unwrapClassesCheckBoxButton .setText(WSASCoreUIMessages.LABEL_UNWRAP_CLASSES);
		unwrapClassesCheckBoxButton .addSelectionListener(new SelectionListener() {
			public void widgetSelected(SelectionEvent e) {
				model.setUnwrapClasses(unwrapClassesCheckBoxButton.getSelection());
			}
			public void widgetDefaultSelected(SelectionEvent e) {
			}
		});
