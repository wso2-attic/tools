package org.wso2.carbonstudio.eclipse.artifact.axis2.utils;

import java.util.List;
import java.util.Vector;

import org.wso2.carbonstudio.eclipse.artifact.axis2.model.DataModel;
...
public abstract class Axis2ParametersUtils {
	...
	public static List<String> getParameterList(DataModel model) {
		...
		if (model.getDatabindingType() != null && !model.getDatabindingType().equals("")) {
		...
		if (model.getSourceFolder() != null && !model.getSourceFolder().toString().equals("")) {
			parameterList.add(SOURCE_FOLDER);
			parameterList.add(model.getSourceFolder().toString());
		}
		if (model.getResourceFolder() != null && !model.getResourceFolder().toString().equals("")) {
		...
		if (model.getRepositoryFolder() != null && !model.getRepositoryFolder().toString().equals("")) {
...
//		}
		...
		if (model.getNamespaseToPackageMapping() != null && !model.getNamespaseToPackageMapping().equals("")) {
			parameterList.add(NAME_SPACE_PACKAGES);
		...
		if (model.getWsdlVersion() != null && !model.getWsdlVersion().equals("")) {
		...
		if (model.getSkeletonInterfaceName() != null && !model.getSkeletonInterfaceName().equals("")) {
			parameterList.add(SKELETON_INTERFACE_NAME);
			parameterList.add(model.getSkeletonInterfaceName());
		}
		if (model.getSkeletonClassName() != null && !model.getSkeletonClassName().equals("")) {
