...
package org.wso2.carbonstudio.eclipse.artifact.axis2serviceclient.core;
/*
 * Copyright (c) 2011, WSO2 Inc. (http://www.wso2.org) All Rights Reserved.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
public class StringConstants extends NLS {
	private static final String BUNDLE_NAME = "org.wso2.carbonstudio.eclipse.artifact.axis2serviceclient.core.stringconstants"; //$NON-NLS-1$
