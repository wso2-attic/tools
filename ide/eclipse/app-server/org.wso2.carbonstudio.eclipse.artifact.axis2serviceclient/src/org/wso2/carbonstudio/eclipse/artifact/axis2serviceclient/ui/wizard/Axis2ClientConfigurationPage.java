...
package org.wso2.carbonstudio.eclipse.artifact.axis2serviceclient.ui.wizard;
...
import org.wso2.carbonstudio.eclipse.artifact.axis2serviceclient.Activator;
import org.wso2.carbonstudio.eclipse.artifact.axis2serviceclient.utils.WSDL2Utils;
import org.wso2.carbonstudio.eclipse.logging.core.ICarbonStudioLog;
import org.wso2.carbonstudio.eclipse.logging.core.Logger;
import org.wso2.carbonstudio.eclipse.utils.wst.WSDLUtils;
...
public class Axis2ClientConfigurationPage extends WizardPage {
	...
	public void createControl(Composite parent) {
		...
		syncAndAsyncRadioButton.addSelectionListener(new SelectionListener() {
			public void widgetSelected(SelectionEvent e) {
				...
				model.setGenerateSyncCode(!syncAndAsyncRadioButton
						.getSelection());
				model.setGenerateAsyncCode(!syncAndAsyncRadioButton
						.getSelection());
			}
	...
	private void loadPortNames() {
		...
		if (selectionIndex != -1) {
			List<String> ports = WSDLUtils.getPortNameList(reader,
					serviceQNameList.get(selectionIndex));
			if (!ports.isEmpty()) {
				portNameCombo.removeAll();
