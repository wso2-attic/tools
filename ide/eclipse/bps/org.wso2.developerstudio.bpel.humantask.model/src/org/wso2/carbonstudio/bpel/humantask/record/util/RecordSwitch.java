 ...
 * $Id$
 */
package org.wso2.carbonstudio.bpel.humantask.record.util;
 ...
 * <!-- end-user-doc -->
 * @see org.wso2.carbonstudio.bpel.humantask.record.RecordPackage
 * @generated
 */
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case RecordPackage.EXTENSION_ELEMENT: {
				...
				if (result == null) result = caseBPELExtensibleElement(extensionElement);
				if (result == null) result = caseExtensibleElement(extensionElement);
				if (result == null) result = caseWSDLElement(extensionElement);
				if (result == null) result = caseIElementExtensible(extensionElement);
				if (result == null) result = caseIAttributeExtensible(extensionElement);
