...
public class CarbonFacetInstallDataModelProvider extends FacetInstallDataModelProvider {
	public CarbonFacetInstallDataModelProvider() {
	    ...
	    setProperty(FACET_ID, "org.wso2.carbonstudio.eclipse.carbon.facetId");
	    setProperty(FACET_VERSION, ProjectFacetsManager.getProjectFacet("org.wso2.carbonstudio.eclipse.carbon.facetId").getVersion("1.0"));//new FacetVersion());
    }
}
