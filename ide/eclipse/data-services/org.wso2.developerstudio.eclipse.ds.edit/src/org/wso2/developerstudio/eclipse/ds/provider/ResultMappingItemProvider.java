 ...
 * {@link org.wso2.developerstudio.eclipse.ds.ResultMapping} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
 * @generated
...
public class ResultMappingItemProvider extends ItemProviderAdapter implements
	...
	protected void addDefaultNamespacePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
		                                                         ...
		                                                         getString("_UI_PropertyDescriptor_description",
		                                                                   "_UI_ResultMapping_defaultNamespace_feature",
	...
	protected void addElementNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
		                                                         ...
		                                                         getString("_UI_PropertyDescriptor_description",
		                                                                   "_UI_ResultMapping_elementName_feature",
		                                                                   "_UI_ResultMapping_type"),
	...
	protected void addRowNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
		                                                         ...
		                                                         getString("_UI_PropertyDescriptor_description",
		                                                                   "_UI_ResultMapping_rowName_feature",
		                                                                   "_UI_ResultMapping_type"),
	...
	protected void addXsltPathPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
		                                                         ...
		                                                         getString("_UI_PropertyDescriptor_description",
		                                                                   "_UI_ResultMapping_xsltPath_feature",
		                                                                   "_UI_ResultMapping_type"),
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(DsPackage.Literals.RESULT_MAPPING__MIXED,
		...
		newChildDescriptors.add(createChildParameter(DsPackage.Literals.RESULT_MAPPING__MIXED,
		                                             FeatureMapUtil.createEntry(DsPackage.Literals.RESULT_MAPPING__ELEMENT,
		                                                                        DsFactory.eINSTANCE.createElementMapping())));

		newChildDescriptors.add(createChildParameter(DsPackage.Literals.RESULT_MAPPING__MIXED,
		                                             FeatureMapUtil.createEntry(DsPackage.Literals.RESULT_MAPPING__ATTRIBUTE,
		                                                                        DsFactory.eINSTANCE.createAttributeMapping())));

		newChildDescriptors.add(createChildParameter(DsPackage.Literals.RESULT_MAPPING__MIXED,
		                                             FeatureMapUtil.createEntry(DsPackage.Literals.RESULT_MAPPING__CALL_QUERY,
		                                                                        DsFactory.eINSTANCE.createCallQuery())));

		newChildDescriptors.add(createChildParameter(DsPackage.Literals.RESULT_MAPPING__ELEMENT,
		                                             DsFactory.eINSTANCE.createElementMapping()));

		newChildDescriptors.add(createChildParameter(DsPackage.Literals.RESULT_MAPPING__ATTRIBUTE,
		                                             DsFactory.eINSTANCE.createAttributeMapping()));

		newChildDescriptors.add(createChildParameter(DsPackage.Literals.RESULT_MAPPING__CALL_QUERY,
		                                             DsFactory.eINSTANCE.createCallQuery()));
	}
