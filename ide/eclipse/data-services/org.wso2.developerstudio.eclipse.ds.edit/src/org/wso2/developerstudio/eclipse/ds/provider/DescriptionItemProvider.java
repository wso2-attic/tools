...
/**
 * This is the item provider adapter for a {@link org.wso2.developerstudio.eclipse.ds.Description} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DescriptionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Description_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Description_value_feature", "_UI_Description_type"),
				 DsPackage.Literals.DESCRIPTION__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		String type = " (" + getString("_UI_Description_type") + ")";
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Description.class)) {
			case DsPackage.DESCRIPTION__VALUE:
