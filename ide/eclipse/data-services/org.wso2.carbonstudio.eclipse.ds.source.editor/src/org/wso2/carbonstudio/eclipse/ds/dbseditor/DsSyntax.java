package org.wso2.carbonstudio.eclipse.ds.dbseditor;
...
public interface DsSyntax {
	  ...
	  public static final String [] queryLevel = {"sql","result","param","sparql","properties",
		  										  "excel","gspread"};
	  public static final String [] gspreadLevel = {"worksheetnumber","startingrow","maxrowcount","hasheader"};
	  
	  public static final String [] exelLevel = {"workbookname","hasheader","startingrow","maxrowcount"};
	  
	  public static final String [] resultLevel = {"element","attribute","call-query"};
	  
	  public static final String [] queryParamLevel = {"validateLongRange","validateDoubleRange","validateLength","validatePattern","validateCustom"};
	  ...
	  // Attributes
	  public static final String [] dataAttributes = {"name","enableBatchRequests","enableBoxcarring","serviceStatus","baseURI","enableDTP","serviceGroup"};
	  
	  public static final String [] configAttributes = {"id"};
	  
	  public static final String [] queryAttributes = {"id","useConfig","input-event-trigger","output-event-trigger","returnGeneratedKeys","keyColumns"};
	  ...
	  public static final String [] resultAttributes ={"element","rowName","defaultNamespace","xsltPath","useColumnNumbers"};
	  
	  public static final String [] elementAtrributes ={"name","column","xsdType","requiredRoles","export"};
	  
	  public static final String [] resultAttributeAtrributes ={"name","column","xsdType","requiredRoles"};
	  
	  public static final String [] resultParamAttributes ={"name","paramType","sqlType","type","ordinal","defaultValue","structType"};
	  ...
	  Object[] allWords = {rootTag,leveLOne,configLevel,queryLevel,gspreadLevel,exelLevel,resourceLevel,queryParamLevel
				,callQueryLevel,eventTrigLevel,eventTrigSubscriptionLevel,operationLevel,callQueryGroupLevel};
