...
public class DsDocumentProvider extends FileDocumentProvider {
	...
	public static final String DS_PARTITIONING= "org.wso2.carbonstudio.eclipse.ds.dbseditor.dspartitioning"; //$NON-NLS-1$
	...
	private IDocumentPartitioner createDsPartitioner() {
		...
		MultiLineRule comment = new MultiLineRule("<!--", "-->", xmlComment);   //define the comment multiline rule
