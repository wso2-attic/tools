...
public class DetailSection {
	...
	private void configurationPropertyObjectConfigurator(ConfigurationProperty configProperty){
		...
		if(configProperty.getName().equals(DSActionConstants.PROTOCOL_PROPERTY)){
		...
		if(configProperty.getName().equals(DSActionConstants.PASSWORD_PROPERTY)){
		...
		if(configProperty.getName().equals(DSActionConstants.MINPOOLSIZE_PROPERTY)){
		...
		if(configProperty.getName().equals(DSActionConstants.MAXPOOLSIZE_PROPERTY)){
		...
		if(configProperty.getName().equals(DSActionConstants.VALIDATIONQUERY_PROPERTY)){
