...
import org.wso2.carbonstudio.eclipse.gmf.esb.diagram.edit.policies.DefaultEndPointCanonicalEditPolicy;
...
public class DefaultEndPointEditPart extends BorderedBorderItemEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		} else if (childEditPart instanceof DefaultEndPointOutputConnectorEditPart) {
