...
import org.wso2.carbonstudio.eclipse.gmf.esb.diagram.edit.commands.CommandMediatorInputConnectorCreateCommand;
import org.wso2.carbonstudio.eclipse.gmf.esb.diagram.edit.commands.CommandMediatorOutputConnectorCreateCommand;
...
public class CommandMediatorItemSemanticEditPolicy extends
	...
	public CommandMediatorItemSemanticEditPolicy() {
		super(EsbElementTypes.CommandMediator_3072);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.CommandMediatorInputConnector_3073 == req
				.getElementType()) {
			return getGEFWrapper(new CommandMediatorInputConnectorCreateCommand(
					req));
		}
		if (EsbElementTypes.CommandMediatorOutputConnector_3074 == req
				.getElementType()) {
