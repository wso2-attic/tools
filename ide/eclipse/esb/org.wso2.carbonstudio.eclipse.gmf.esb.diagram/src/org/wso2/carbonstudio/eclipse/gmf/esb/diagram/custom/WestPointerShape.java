...
public class WestPointerShape extends AbstractPointerShape {	
	/**
	 * {@inheritDoc}
	 */
	public PointList getDrawPoints() {
		...
		result.addPoint(new PrecisionPoint(bounds.preciseWidth(), 0.0));
//		result.addPoint(new PrecisionPoint(cellWidth * 2, 0.0));
		result.addPoint(new PrecisionPoint(bounds.preciseWidth() , bounds.preciseHeight()));
		result.addPoint(new PrecisionPoint(cellWidth, bounds.preciseHeight()));
		result.addPoint(new PrecisionPoint(0.0 , cellHeight));
