 ...
 * @generated
 */
public class SequenceNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
		...
		if (parser == null) {
			parser = EsbParserProvider
					.getParser(
							...
							getParserElement(),
							EsbVisualIDRegistry
									.getType(org.wso2.carbonstudio.eclipse.gmf.esb.diagram.edit.parts.SequenceNameEditPart.VISUAL_ID));
		}
		return parser;
	}
