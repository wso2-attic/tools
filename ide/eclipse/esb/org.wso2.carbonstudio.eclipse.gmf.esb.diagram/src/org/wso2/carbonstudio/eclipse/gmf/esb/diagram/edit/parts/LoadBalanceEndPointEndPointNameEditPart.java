 ...
 * @generated
 *//*
public class LoadBalanceEndPointEndPointNameEditPart extends
	...
	*//**
	 * @generated
	 *//*
	public LoadBalanceEndPointEndPointNameEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = EsbParserProvider
					.getParser(
							...
							getParserElement(),
							EsbVisualIDRegistry
									.getType(org.wso2.carbonstudio.eclipse.gmf.esb.diagram.edit.parts.LoadBalanceEndPointEndPointNameEditPart.VISUAL_ID));
		}
		return parser;
	}
