...
import org.wso2.carbonstudio.eclipse.gmf.esb.diagram.edit.commands.ScriptMediatorInputConnectorCreateCommand;
import org.wso2.carbonstudio.eclipse.gmf.esb.diagram.edit.commands.ScriptMediatorOutputConnectorCreateCommand;
...
public class ScriptMediatorItemSemanticEditPolicy extends
	...
	public ScriptMediatorItemSemanticEditPolicy() {
		super(EsbElementTypes.ScriptMediator_3063);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.ScriptMediatorInputConnector_3064 == req
				.getElementType()) {
			return getGEFWrapper(new ScriptMediatorInputConnectorCreateCommand(
					req));
		}
		if (EsbElementTypes.ScriptMediatorOutputConnector_3065 == req
				.getElementType()) {
