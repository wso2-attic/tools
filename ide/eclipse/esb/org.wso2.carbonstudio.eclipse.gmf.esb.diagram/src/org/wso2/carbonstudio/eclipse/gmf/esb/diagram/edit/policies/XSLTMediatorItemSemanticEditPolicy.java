...
import org.wso2.carbonstudio.eclipse.gmf.esb.diagram.edit.commands.XSLTMediatorInputConnectorCreateCommand;
import org.wso2.carbonstudio.eclipse.gmf.esb.diagram.edit.commands.XSLTMediatorOutputConnectorCreateCommand;
...
public class XSLTMediatorItemSemanticEditPolicy extends
	...
	public XSLTMediatorItemSemanticEditPolicy() {
		super(EsbElementTypes.XSLTMediator_3038);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.XSLTMediatorInputConnector_3039 == req
				.getElementType()) {
			return getGEFWrapper(new XSLTMediatorInputConnectorCreateCommand(
					req));
		}
		if (EsbElementTypes.XSLTMediatorOutputConnector_3040 == req
				.getElementType()) {
