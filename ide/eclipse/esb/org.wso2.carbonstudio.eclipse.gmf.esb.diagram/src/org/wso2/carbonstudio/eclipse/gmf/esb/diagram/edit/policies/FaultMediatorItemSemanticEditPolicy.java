...
import org.wso2.carbonstudio.eclipse.gmf.esb.diagram.edit.commands.FaultMediatorInputConnectorCreateCommand;
import org.wso2.carbonstudio.eclipse.gmf.esb.diagram.edit.commands.FaultMediatorOutputConnectorCreateCommand;
...
public class FaultMediatorItemSemanticEditPolicy extends
	...
	public FaultMediatorItemSemanticEditPolicy() {
		super(EsbElementTypes.FaultMediator_3066);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.FaultMediatorInputConnector_3067 == req
				.getElementType()) {
			return getGEFWrapper(new FaultMediatorInputConnectorCreateCommand(
					req));
		}
		if (EsbElementTypes.FaultMediatorOutputConnector_3068 == req
				.getElementType()) {
