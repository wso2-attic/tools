...
import org.wso2.carbonstudio.eclipse.gmf.esb.diagram.edit.commands.SpringMediatorInputConnectorCreateCommand;
import org.wso2.carbonstudio.eclipse.gmf.esb.diagram.edit.commands.SpringMediatorOutputConnectorCreateCommand;
...
public class SpringMediatorItemSemanticEditPolicy extends
	...
	public SpringMediatorItemSemanticEditPolicy() {
		super(EsbElementTypes.SpringMediator_3060);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.SpringMediatorInputConnector_3061 == req
				.getElementType()) {
			return getGEFWrapper(new SpringMediatorInputConnectorCreateCommand(
					req));
		}
		if (EsbElementTypes.SpringMediatorOutputConnector_3062 == req
				.getElementType()) {
