...
import org.wso2.carbonstudio.eclipse.gmf.esb.diagram.edit.commands.DBLookupMediatorInputConnectorCreateCommand;
import org.wso2.carbonstudio.eclipse.gmf.esb.diagram.edit.commands.DBLookupMediatorOutputConnectorCreateCommand;
...
public class DBLookupMediatorItemSemanticEditPolicy extends
	...
	public DBLookupMediatorItemSemanticEditPolicy() {
		super(EsbElementTypes.DBLookupMediator_3075);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.DBLookupMediatorInputConnector_3076 == req
				.getElementType()) {
			return getGEFWrapper(new DBLookupMediatorInputConnectorCreateCommand(
					req));
		}
		if (EsbElementTypes.DBLookupMediatorOutputConnector_3077 == req
				.getElementType()) {
