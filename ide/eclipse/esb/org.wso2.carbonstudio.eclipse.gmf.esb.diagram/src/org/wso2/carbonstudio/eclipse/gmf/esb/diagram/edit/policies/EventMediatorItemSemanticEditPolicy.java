...
import org.wso2.carbonstudio.eclipse.gmf.esb.diagram.edit.commands.EventMediatorInputConnectorCreateCommand;
import org.wso2.carbonstudio.eclipse.gmf.esb.diagram.edit.commands.EventMediatorOutputConnectorCreateCommand;
...
public class EventMediatorItemSemanticEditPolicy extends
	...
	public EventMediatorItemSemanticEditPolicy() {
		super(EsbElementTypes.EventMediator_3051);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.EventMediatorInputConnector_3052 == req
				.getElementType()) {
			return getGEFWrapper(new EventMediatorInputConnectorCreateCommand(
					req));
		}
		if (EsbElementTypes.EventMediatorOutputConnector_3053 == req
				.getElementType()) {
