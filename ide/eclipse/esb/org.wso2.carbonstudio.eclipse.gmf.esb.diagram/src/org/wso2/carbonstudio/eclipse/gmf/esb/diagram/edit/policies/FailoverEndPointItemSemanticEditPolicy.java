...
import org.wso2.carbonstudio.eclipse.gmf.esb.diagram.edit.commands.FailoverEndPointInputConnectorCreateCommand;
import org.wso2.carbonstudio.eclipse.gmf.esb.diagram.edit.commands.FailoverEndPointOutputConnectorCreateCommand;
import org.wso2.carbonstudio.eclipse.gmf.esb.diagram.edit.commands.FailoverEndPointWestOutputConnectorCreateCommand;
 ...
 * @generated
 */
public class FailoverEndPointItemSemanticEditPolicy extends
	...
	public FailoverEndPointItemSemanticEditPolicy() {
		super(EsbElementTypes.FailoverEndPoint_3087);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.FailoverEndPointInputConnector_3088 == req
				.getElementType()) {
			return getGEFWrapper(new FailoverEndPointInputConnectorCreateCommand(
					req));
		}
		if (EsbElementTypes.FailoverEndPointOutputConnector_3090 == req
				.getElementType()) {
			return getGEFWrapper(new FailoverEndPointOutputConnectorCreateCommand(
					req));
		}
		if (EsbElementTypes.FailoverEndPointWestOutputConnector_3097 == req
				.getElementType()) {
			return getGEFWrapper(new FailoverEndPointWestOutputConnectorCreateCommand(
					req));
		}
