...
import org.wso2.carbonstudio.eclipse.gmf.esb.diagram.edit.commands.CloneMediatorInputConnectorCreateCommand;
import org.wso2.carbonstudio.eclipse.gmf.esb.diagram.edit.commands.CloneMediatorOutputConnectorCreateCommand;
import org.wso2.carbonstudio.eclipse.gmf.esb.diagram.edit.commands.CloneMediatorTargetOutputConnectorCreateCommand;
...
import org.wso2.carbonstudio.eclipse.gmf.esb.diagram.edit.parts.CloneMediatorTargetOutputConnectorEditPart;
...
public class CloneMediatorItemSemanticEditPolicy extends
	...
	public CloneMediatorItemSemanticEditPolicy() {
		super(EsbElementTypes.CloneMediator_3102);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.CloneMediatorInputConnector_3103 == req
				.getElementType()) {
			return getGEFWrapper(new CloneMediatorInputConnectorCreateCommand(
					req));
		}
		if (EsbElementTypes.CloneMediatorOutputConnector_3104 == req
				.getElementType()) {
			return getGEFWrapper(new CloneMediatorOutputConnectorCreateCommand(
					req));
		}
		if (EsbElementTypes.CloneMediatorTargetOutputConnector_3133 == req
				.getElementType()) {
			return getGEFWrapper(new CloneMediatorTargetOutputConnectorCreateCommand(
					req));
		}
