...
import org.wso2.carbonstudio.eclipse.gmf.esb.diagram.edit.commands.DBReportMediatorInputConnectorCreateCommand;
import org.wso2.carbonstudio.eclipse.gmf.esb.diagram.edit.commands.DBReportMediatorOutputConnectorCreateCommand;
...
public class DBReportMediatorItemSemanticEditPolicy extends
	...
	public DBReportMediatorItemSemanticEditPolicy() {
		super(EsbElementTypes.DBReportMediator_3078);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.DBReportMediatorInputConnector_3079 == req
				.getElementType()) {
			return getGEFWrapper(new DBReportMediatorInputConnectorCreateCommand(
					req));
		}
		if (EsbElementTypes.DBReportMediatorOutputConnector_3080 == req
				.getElementType()) {
