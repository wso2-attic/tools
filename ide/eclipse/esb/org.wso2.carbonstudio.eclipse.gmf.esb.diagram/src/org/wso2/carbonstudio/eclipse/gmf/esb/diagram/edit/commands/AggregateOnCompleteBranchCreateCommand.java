 ...
 * @generated
 */
public class AggregateOnCompleteBranchCreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public AggregateOnCompleteBranchCreateCommand(CreateElementRequest req) {
	...
	public boolean canExecute() {
		...
		if (container.getOnCompleteBranch() != null) {
			return false;
		}
		return true;
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		AggregateOnCompleteBranch newElement = EsbFactory.eINSTANCE
				.createAggregateOnCompleteBranch();

		AggregateMediator owner = (AggregateMediator) getElementToEdit();
		owner.setOnCompleteBranch(newElement);
	 ...
	 * @generated
	 */
	protected void doConfigure(AggregateOnCompleteBranch newElement,
