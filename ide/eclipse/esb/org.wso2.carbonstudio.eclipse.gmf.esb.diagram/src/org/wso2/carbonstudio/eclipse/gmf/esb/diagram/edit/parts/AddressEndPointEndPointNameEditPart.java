 ...
 * @generated
 */
public class AddressEndPointEndPointNameEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public AddressEndPointEndPointNameEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = EsbParserProvider
					.getParser(
							...
							getParserElement(),
							EsbVisualIDRegistry
									.getType(org.wso2.carbonstudio.eclipse.gmf.esb.diagram.edit.parts.AddressEndPointEndPointNameEditPart.VISUAL_ID));
		}
		return parser;
	}
