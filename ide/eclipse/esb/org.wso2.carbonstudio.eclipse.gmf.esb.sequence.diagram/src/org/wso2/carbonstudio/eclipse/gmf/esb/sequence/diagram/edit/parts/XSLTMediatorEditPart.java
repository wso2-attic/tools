...
import org.wso2.carbonstudio.eclipse.gmf.esb.sequence.diagram.edit.policies.XSLTMediatorCanonicalEditPolicy;
import org.wso2.carbonstudio.eclipse.gmf.esb.sequence.diagram.edit.policies.XSLTMediatorItemSemanticEditPolicy;
import org.wso2.carbonstudio.eclipse.gmf.esb.sequence.diagram.part.EsbVisualIDRegistry;

/**
 * @generated
 */
public class XSLTMediatorEditPart extends AbstractBorderedShapeEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 3528;
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new XSLTMediatorItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE,
				new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new XSLTMediatorCanonicalEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new XSLTMediatorFigure();
	}

	/**
	 * @generated
	 */
	public XSLTMediatorFigure getPrimaryShape() {
		return (XSLTMediatorFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		} else if (childEditPart instanceof XSLTMediatorOutputConnectorEditPart) {

			IFigure borderItemFigure = ((XSLTMediatorOutputConnectorEditPart) childEditPart)
					.getFigure();
			BorderItemLocator locator = new FixedBorderItemLocator(
	...
	public class XSLTMediatorFigure extends EsbGraphicalShape {
		...
		private void createContents() {
			...
			this.getPropertyValueRectangle1().add(
					fFigureXSLTMediatorPropertyValueLabel);
