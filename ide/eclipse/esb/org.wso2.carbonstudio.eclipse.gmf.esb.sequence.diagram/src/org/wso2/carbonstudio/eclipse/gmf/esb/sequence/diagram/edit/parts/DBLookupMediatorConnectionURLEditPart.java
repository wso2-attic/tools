...
import org.wso2.carbonstudio.eclipse.gmf.esb.sequence.diagram.edit.policies.EsbTextSelectionEditPolicy;
		...
		if (parser == null) {
			parser = EsbParserProvider
					.getParser(
							...
							getParserElement(),
							EsbVisualIDRegistry
									.getType(org.wso2.carbonstudio.eclipse.gmf.esb.sequence.diagram.edit.parts.DBLookupMediatorConnectionURLEditPart.VISUAL_ID));
		}
		return parser;
	}
