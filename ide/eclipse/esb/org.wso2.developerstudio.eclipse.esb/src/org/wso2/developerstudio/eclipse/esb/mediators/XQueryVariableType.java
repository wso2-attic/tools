 ...
 * <!-- end-user-doc -->
 * @see org.wso2.developerstudio.eclipse.esb.mediators.MediatorsPackage#getXQueryVariableType()
 * @model
 * @generated
 */
public enum XQueryVariableType implements Enumerator {
	/**
     ...
     * @ordered
     */
	DOCUMENT_ELEMENT(1, "DOCUMENT_ELEMENT", "DOCUMENT_ELEMENT"),
	...
	/**
     * The '<em><b>DOCUMENT ELEMENT</b></em>' literal value.
     * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of '<em><b>DOCUMENT ELEMENT</b></em>' literal object isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
     ...
     * @ordered
     */
	public static final int DOCUMENT_ELEMENT_VALUE = 1;
     ...
     * @generated
     */
	private static final XQueryVariableType[] VALUES_ARRAY =
		new XQueryVariableType[] {
            DOCUMENT,
            DOCUMENT_ELEMENT,
            ELEMENT,
            INT,
	...
	public static XQueryVariableType get(String literal) {
        for (int i = 0; i < VALUES_ARRAY.length; ++i) {
            XQueryVariableType result = VALUES_ARRAY[i];
