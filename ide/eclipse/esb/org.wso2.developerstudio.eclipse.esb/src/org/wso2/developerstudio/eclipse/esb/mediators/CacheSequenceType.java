...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Cache On Hit Sequence Type</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.wso2.developerstudio.eclipse.esb.mediators.MediatorsPackage#getCacheSequenceType()
 * @model
 * @generated
 */
public enum CacheSequenceType implements Enumerator {
	/**
	...
	/**
     * An array of all the '<em><b>Cache Sequence Type</b></em>' enumerators.
     * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
     * @generated
     */
	private static final CacheSequenceType[] VALUES_ARRAY =
		new CacheSequenceType[] {
            ANONYMOUS,
            REGISTRY_REFERENCE,
        };

	/**
     * A public read-only list of all the '<em><b>Cache Sequence Type</b></em>' enumerators.
     * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
     * @generated
     */
	public static final List<CacheSequenceType> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
	...
	public static CacheSequenceType get(String literal) {
        for (int i = 0; i < VALUES_ARRAY.length; ++i) {
            CacheSequenceType result = VALUES_ARRAY[i];
     ...
     * @generated
     */
	private CacheSequenceType(int value, String name, String literal) {
        this.value = value;
        this.name = name;
