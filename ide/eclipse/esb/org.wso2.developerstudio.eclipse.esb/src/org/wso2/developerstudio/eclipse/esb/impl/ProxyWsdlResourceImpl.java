...
public class ProxyWsdlResourceImpl extends AbstractLocationKeyResourceImpl implements ProxyWsdlResource {
	...
	protected ProxyWsdlResourceImpl() {
		...
		DeveloperStudioProviderUtils.addFilter((Map<String, List<String>>)wsdlResourceKey.getFilters(), CSProviderConstants.FILTER_MEDIA_TYPE, PlatformMediaTypeConstants.MEDIA_TYPE_WSDL);
