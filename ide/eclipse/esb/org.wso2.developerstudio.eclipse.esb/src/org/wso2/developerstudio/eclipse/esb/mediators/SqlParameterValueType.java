 ...
 * <!-- end-user-doc -->
 * @see org.wso2.developerstudio.eclipse.esb.mediators.MediatorsPackage#getSqlParameterValueType()
 * @model
 * @generated
 */
public enum SqlParameterValueType implements Enumerator {
     ...
     * @generated
     */
	private static final SqlParameterValueType[] VALUES_ARRAY =
		new SqlParameterValueType[] {
            LITERAL,
            EXPRESSION,
        };
