 ...
 * <!-- end-user-doc -->
 * @see org.wso2.developerstudio.eclipse.esb.mediators.MediatorsPackage#getRuleFactType()
 * @model
 * @generated
 */
public enum RuleFactType implements Enumerator {
	/**
     ...
     * @generated
     */
	private static final RuleFactType[] VALUES_ARRAY =
		new RuleFactType[] {
            CUSTOM,
            DOM,
            MESSAGE,
     ...
     * @generated
     */
	public static RuleFactType get(String literal) {
        for (int i = 0; i < VALUES_ARRAY.length; ++i) {
            RuleFactType result = VALUES_ARRAY[i];
     ...
     * @generated
     */
	public static RuleFactType getByName(String name) {
        for (int i = 0; i < VALUES_ARRAY.length; ++i) {
            RuleFactType result = VALUES_ARRAY[i];
