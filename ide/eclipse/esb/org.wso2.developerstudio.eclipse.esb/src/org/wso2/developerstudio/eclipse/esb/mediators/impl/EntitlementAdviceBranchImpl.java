...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Entitlement Advice Branch</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.wso2.developerstudio.eclipse.esb.mediators.impl.EntitlementAdviceBranchImpl#getSequenceType <em>Sequence Type</em>}</li>
 *   <li>{@link org.wso2.developerstudio.eclipse.esb.mediators.impl.EntitlementAdviceBranchImpl#getSequenceKey <em>Sequence Key</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class EntitlementAdviceBranchImpl extends MediatorBranchImpl implements EntitlementAdviceBranch {
	/**
	 ...
	 * 
	 *  */
	protected EntitlementAdviceBranchImpl() {
		super();
		// Sequence key.
		...
		sequenceKey.setKeyName("onAdvice");
	...
	protected EClass eStaticClass() {
		return MediatorsPackage.Literals.ENTITLEMENT_ADVICE_BRANCH;
	}
	...
	public void setSequenceType(EntitlementSequence newSequenceType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorsPackage.ENTITLEMENT_ADVICE_BRANCH__SEQUENCE_TYPE, oldSequenceType, sequenceType));
	}
	...
	public RegistryKeyProperty getSequenceKey() {
		if (sequenceKey != null && sequenceKey.eIsProxy()) {
			...
			if (sequenceKey != oldSequenceKey) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MediatorsPackage.ENTITLEMENT_ADVICE_BRANCH__SEQUENCE_KEY, oldSequenceKey, sequenceKey));
			}
		}
		return sequenceKey;
	}
	...
	public void setSequenceKey(RegistryKeyProperty newSequenceKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorsPackage.ENTITLEMENT_ADVICE_BRANCH__SEQUENCE_KEY, oldSequenceKey, sequenceKey));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MediatorsPackage.ENTITLEMENT_ADVICE_BRANCH__SEQUENCE_TYPE:
				return getSequenceType();
			case MediatorsPackage.ENTITLEMENT_ADVICE_BRANCH__SEQUENCE_KEY:
