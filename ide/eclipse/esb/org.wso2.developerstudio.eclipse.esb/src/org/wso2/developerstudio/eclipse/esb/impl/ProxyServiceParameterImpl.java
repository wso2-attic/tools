...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Proxy Service Parameter</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.wso2.developerstudio.eclipse.esb.impl.ProxyServiceParameterImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.wso2.developerstudio.eclipse.esb.impl.ProxyServiceParameterImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ProxyServiceParameterImpl extends ModelObjectImpl implements ProxyServiceParameter {
	/**
	...
	public void doLoad(Element self) throws Exception {
		...
		if (!children.isEmpty()) {
			...
			setValue(EsbUtils.renderElement(children.get(0), true));
	...
	public Element doSave(Element parent) throws Exception {
		...
		// First attempt to parse the parameter value to an XML string.
		try {
			Element valueElem = EsbUtils.parseElement(getValue());
			valueElem = (Element) self.getOwnerDocument().importNode(valueElem, true);
			self.appendChild(valueElem);
		} catch (Exception ex) {
