...
import org.wso2.carbonstudio.eclipse.gmf.esb.sequence.diagram.edit.policies.FaultMediatorCanonicalEditPolicy;
import org.wso2.carbonstudio.eclipse.gmf.esb.sequence.diagram.edit.policies.FaultMediatorItemSemanticEditPolicy;
import org.wso2.carbonstudio.eclipse.gmf.esb.sequence.diagram.part.EsbVisualIDRegistry;

/**
 * @generated
 */
public class FaultMediatorEditPart extends AbstractBorderedShapeEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 3550;
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new FaultMediatorItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE,
				new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new FaultMediatorCanonicalEditPolicy());
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof FaultMediatorInputConnectorEditPart) {
			getBorderedFigure().getBorderItemContainer().remove(
					((FaultMediatorInputConnectorEditPart) childEditPart)
							.getFigure());
			return true;
		}
		if (childEditPart instanceof FaultMediatorOutputConnectorEditPart) {
			getBorderedFigure().getBorderItemContainer().remove(
					((FaultMediatorOutputConnectorEditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
