...
import org.wso2.carbonstudio.eclipse.gmf.esb.sequence.diagram.edit.policies.SpringMediatorCanonicalEditPolicy;
import org.wso2.carbonstudio.eclipse.gmf.esb.sequence.diagram.edit.policies.SpringMediatorItemSemanticEditPolicy;
import org.wso2.carbonstudio.eclipse.gmf.esb.sequence.diagram.part.EsbVisualIDRegistry;

/**
 * @generated
 */
public class SpringMediatorEditPart extends AbstractBorderedShapeEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 3544;
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new SpringMediatorItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE,
				new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new SpringMediatorCanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof SpringMediatorInputConnectorEditPart) {
			...
			IFigure borderItemFigure = ((SpringMediatorInputConnectorEditPart) childEditPart)
					.getFigure();
		...
		} else if (childEditPart instanceof SpringMediatorOutputConnectorEditPart) {

			IFigure borderItemFigure = ((SpringMediatorOutputConnectorEditPart) childEditPart)
					.getFigure();
			BorderItemLocator locator = new FixedBorderItemLocator(
		...
		if (childEditPart instanceof SpringMediatorBeanNameEditPart) {
			((SpringMediatorBeanNameEditPart) childEditPart)
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof SpringMediatorInputConnectorEditPart) {
			getBorderedFigure().getBorderItemContainer().remove(
					((SpringMediatorInputConnectorEditPart) childEditPart)
							.getFigure());
			return true;
		}
		if (childEditPart instanceof SpringMediatorOutputConnectorEditPart) {
			getBorderedFigure().getBorderItemContainer().remove(
					((SpringMediatorOutputConnectorEditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
