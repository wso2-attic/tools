...
import org.wso2.carbonstudio.eclipse.gmf.esb.sequence.diagram.edit.policies.EventMediatorCanonicalEditPolicy;
import org.wso2.carbonstudio.eclipse.gmf.esb.sequence.diagram.edit.policies.EventMediatorItemSemanticEditPolicy;
import org.wso2.carbonstudio.eclipse.gmf.esb.sequence.diagram.part.EsbVisualIDRegistry;

/**
 * @generated
 */
public class EventMediatorEditPart extends AbstractBorderedShapeEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 3531;
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new EventMediatorItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE,
				new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new EventMediatorCanonicalEditPolicy());
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof EventMediatorInputConnectorEditPart) {
			getBorderedFigure().getBorderItemContainer().remove(
					((EventMediatorInputConnectorEditPart) childEditPart)
							.getFigure());
			return true;
		}
		if (childEditPart instanceof EventMediatorOutputConnectorEditPart) {
			getBorderedFigure().getBorderItemContainer().remove(
					((EventMediatorOutputConnectorEditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
