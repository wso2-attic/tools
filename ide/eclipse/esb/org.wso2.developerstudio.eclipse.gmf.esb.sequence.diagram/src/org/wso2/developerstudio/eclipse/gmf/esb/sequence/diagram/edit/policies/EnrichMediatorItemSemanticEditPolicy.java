...
import org.wso2.developerstudio.eclipse.gmf.esb.sequence.diagram.edit.commands.EnrichMediatorInputConnectorCreateCommand;
import org.wso2.developerstudio.eclipse.gmf.esb.sequence.diagram.edit.commands.EnrichMediatorOutputConnectorCreateCommand;
 ...
 * @generated
 */
public class EnrichMediatorItemSemanticEditPolicy extends
	...
	public EnrichMediatorItemSemanticEditPolicy() {
		super(EsbElementTypes.EnrichMediator_3521);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.EnrichMediatorInputConnector_3522 == req
				.getElementType()) {
			return getGEFWrapper(new EnrichMediatorInputConnectorCreateCommand(
					req));
		}
		if (EsbElementTypes.EnrichMediatorOutputConnector_3523 == req
				.getElementType()) {
			return getGEFWrapper(new EnrichMediatorOutputConnectorCreateCommand(
					req));
		}
