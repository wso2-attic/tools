...
import org.wso2.developerstudio.eclipse.gmf.esb.sequence.diagram.edit.commands.SwitchCaseBranchOutputConnectorCreateCommand;
import org.wso2.developerstudio.eclipse.gmf.esb.sequence.diagram.edit.commands.SwitchDefaultBranchOutputConnectorCreateCommand;
import org.wso2.developerstudio.eclipse.gmf.esb.sequence.diagram.edit.commands.SwitchMediatorInputConnectorCreateCommand;
...
public class SwitchMediatorItemSemanticEditPolicy extends
	...
	public SwitchMediatorItemSemanticEditPolicy() {
		super(EsbElementTypes.SwitchMediator_3537);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.SwitchMediatorInputConnector_3538 == req
				.getElementType()) {
			return getGEFWrapper(new SwitchMediatorInputConnectorCreateCommand(
					req));
		}
		if (EsbElementTypes.SwitchCaseBranchOutputConnector_3539 == req
				.getElementType()) {
			return getGEFWrapper(new SwitchCaseBranchOutputConnectorCreateCommand(
					req));
		}
		if (EsbElementTypes.SwitchDefaultBranchOutputConnector_3540 == req
				.getElementType()) {
