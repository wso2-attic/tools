...
import org.wso2.developerstudio.eclipse.gmf.esb.sequence.diagram.edit.policies.EsbTextSelectionEditPolicy;
 ...
 * @generated
 */
public class OAuthMediatorRemoteServiceUrlEditPart extends CompartmentEditPart
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new SequenceDiagramEditPart.NodeLabelDragPolicy());
	}
		...
		if (parser == null) {
			parser = EsbParserProvider
					.getParser(
							...
							getParserElement(),
							EsbVisualIDRegistry
									.getType(org.wso2.developerstudio.eclipse.gmf.esb.sequence.diagram.edit.parts.OAuthMediatorRemoteServiceUrlEditPart.VISUAL_ID));
		}
		return parser;
	}
