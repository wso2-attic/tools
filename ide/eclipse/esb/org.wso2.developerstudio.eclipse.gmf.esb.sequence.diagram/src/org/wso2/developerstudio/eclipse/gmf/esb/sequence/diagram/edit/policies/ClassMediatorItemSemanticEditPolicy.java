...
import org.wso2.developerstudio.eclipse.gmf.esb.sequence.diagram.edit.commands.ClassMediatorInputConnectorCreateCommand;
import org.wso2.developerstudio.eclipse.gmf.esb.sequence.diagram.edit.commands.ClassMediatorOutputConnectorCreateCommand;
 ...
 * @generated
 */
public class ClassMediatorItemSemanticEditPolicy extends
	...
	public ClassMediatorItemSemanticEditPolicy() {
		super(EsbElementTypes.ClassMediator_3541);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.ClassMediatorInputConnector_3542 == req
				.getElementType()) {
			return getGEFWrapper(new ClassMediatorInputConnectorCreateCommand(
					req));
		}
		if (EsbElementTypes.ClassMediatorOutputConnector_3543 == req
				.getElementType()) {
			return getGEFWrapper(new ClassMediatorOutputConnectorCreateCommand(
					req));
		}
