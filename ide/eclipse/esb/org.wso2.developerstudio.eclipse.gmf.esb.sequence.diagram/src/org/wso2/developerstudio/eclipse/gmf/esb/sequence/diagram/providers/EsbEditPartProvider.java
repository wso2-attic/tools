...
import org.wso2.developerstudio.eclipse.gmf.esb.sequence.diagram.edit.parts.EsbEditPartFactory;
 ...
 * @generated
 */
public class EsbEditPartProvider extends AbstractEditPartProvider {
	...
	public EsbEditPartProvider() {
		setFactory(new EsbEditPartFactory());
