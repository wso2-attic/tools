...
import org.wso2.developerstudio.eclipse.gmf.esb.sequence.diagram.edit.commands.CalloutMediatorInputConnectorCreateCommand;
import org.wso2.developerstudio.eclipse.gmf.esb.sequence.diagram.edit.commands.CalloutMediatorOutputConnectorCreateCommand;
 ...
 * @generated
 */
public class CalloutMediatorItemSemanticEditPolicy extends
	...
	public CalloutMediatorItemSemanticEditPolicy() {
		super(EsbElementTypes.CalloutMediator_3586);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.CalloutMediatorInputConnector_3587 == req
				.getElementType()) {
			return getGEFWrapper(new CalloutMediatorInputConnectorCreateCommand(
					req));
		}
		if (EsbElementTypes.CalloutMediatorOutputConnector_3588 == req
				.getElementType()) {
			return getGEFWrapper(new CalloutMediatorOutputConnectorCreateCommand(
					req));
		}
