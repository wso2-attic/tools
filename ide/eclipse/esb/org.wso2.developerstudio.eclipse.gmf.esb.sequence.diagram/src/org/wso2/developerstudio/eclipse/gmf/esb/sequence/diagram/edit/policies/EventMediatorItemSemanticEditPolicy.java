...
import org.wso2.developerstudio.eclipse.gmf.esb.sequence.diagram.edit.commands.EventMediatorInputConnectorCreateCommand;
import org.wso2.developerstudio.eclipse.gmf.esb.sequence.diagram.edit.commands.EventMediatorOutputConnectorCreateCommand;
 ...
 * @generated
 */
public class EventMediatorItemSemanticEditPolicy extends
	...
	public EventMediatorItemSemanticEditPolicy() {
		super(EsbElementTypes.EventMediator_3531);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.EventMediatorInputConnector_3532 == req
				.getElementType()) {
			return getGEFWrapper(new EventMediatorInputConnectorCreateCommand(
					req));
		}
		if (EsbElementTypes.EventMediatorOutputConnector_3533 == req
				.getElementType()) {
			return getGEFWrapper(new EventMediatorOutputConnectorCreateCommand(
					req));
		}
