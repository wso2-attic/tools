...
import org.wso2.developerstudio.eclipse.gmf.esb.sequence.diagram.edit.commands.CacheMediatorInputConnectorCreateCommand;
import org.wso2.developerstudio.eclipse.gmf.esb.sequence.diagram.edit.commands.CacheMediatorOutputConnectorCreateCommand;
...
public class CacheMediatorItemSemanticEditPolicy extends
	...
	public CacheMediatorItemSemanticEditPolicy() {
		super(EsbElementTypes.CacheMediator_3577);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.CacheMediatorInputConnector_3578 == req
				.getElementType()) {
			return getGEFWrapper(new CacheMediatorInputConnectorCreateCommand(
					req));
		}
		if (EsbElementTypes.CacheMediatorOutputConnector_3579 == req
				.getElementType()) {
