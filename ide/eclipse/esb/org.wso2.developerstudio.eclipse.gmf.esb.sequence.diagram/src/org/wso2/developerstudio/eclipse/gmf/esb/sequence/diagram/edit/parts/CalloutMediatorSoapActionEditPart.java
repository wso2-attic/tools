 ...
 * @generated
 */
public class CalloutMediatorSoapActionEditPart extends CompartmentEditPart
		...
		if (parser == null) {
			parser = EsbParserProvider
					.getParser(
							...
							getParserElement(),
							EsbVisualIDRegistry
									.getType(org.wso2.developerstudio.eclipse.gmf.esb.sequence.diagram.edit.parts.CalloutMediatorSoapActionEditPart.VISUAL_ID));
		}
		return parser;
	}
