...
import org.wso2.developerstudio.eclipse.gmf.esb.sequence.diagram.edit.commands.XSLTMediatorInputConnectorCreateCommand;
import org.wso2.developerstudio.eclipse.gmf.esb.sequence.diagram.edit.commands.XSLTMediatorOutputConnectorCreateCommand;
 ...
 * @generated
 */
public class XSLTMediatorItemSemanticEditPolicy extends
	...
	public XSLTMediatorItemSemanticEditPolicy() {
		super(EsbElementTypes.XSLTMediator_3528);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.XSLTMediatorInputConnector_3529 == req
				.getElementType()) {
			return getGEFWrapper(new XSLTMediatorInputConnectorCreateCommand(
					req));
		}
		if (EsbElementTypes.XSLTMediatorOutputConnector_3530 == req
				.getElementType()) {
			return getGEFWrapper(new XSLTMediatorOutputConnectorCreateCommand(
					req));
		}
