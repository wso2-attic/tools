 ...
 * @generated
 */
public class EsbSequenceSeqContentsCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<EsbNodeDescriptor> childDescriptors = EsbDiagramUpdater
				.getEsbSequenceSeqContentsCompartment_7501SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<EsbNodeDescriptor> childDescriptors = EsbDiagramUpdater
				.getEsbSequenceSeqContentsCompartment_7501SemanticChildren((View) getHost()
						.getModel());
