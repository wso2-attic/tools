...
import org.wso2.developerstudio.eclipse.gmf.esb.sequence.diagram.edit.commands.RuleMediatorInputConnectorCreateCommand;
import org.wso2.developerstudio.eclipse.gmf.esb.sequence.diagram.edit.commands.RuleMediatorOutputConnectorCreateCommand;
...
public class RuleMediatorItemSemanticEditPolicy extends
	...
	public RuleMediatorItemSemanticEditPolicy() {
		super(EsbElementTypes.RuleMediator_3598);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.RuleMediatorInputConnector_3599 == req
				.getElementType()) {
			return getGEFWrapper(new RuleMediatorInputConnectorCreateCommand(
					req));
		}
		if (EsbElementTypes.RuleMediatorOutputConnector_3600 == req
				.getElementType()) {
