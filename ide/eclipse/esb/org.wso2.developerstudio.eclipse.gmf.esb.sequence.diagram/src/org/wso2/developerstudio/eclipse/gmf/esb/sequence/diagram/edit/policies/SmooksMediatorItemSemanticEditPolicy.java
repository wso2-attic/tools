...
import org.wso2.developerstudio.eclipse.gmf.esb.sequence.diagram.edit.commands.SmooksMediatorInputConnectorCreateCommand;
import org.wso2.developerstudio.eclipse.gmf.esb.sequence.diagram.edit.commands.SmooksMediatorOutputConnectorCreateCommand;
 ...
 * @generated
 */
public class SmooksMediatorItemSemanticEditPolicy extends
	...
	public SmooksMediatorItemSemanticEditPolicy() {
		super(EsbElementTypes.SmooksMediator_3565);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.SmooksMediatorInputConnector_3566 == req
				.getElementType()) {
			return getGEFWrapper(new SmooksMediatorInputConnectorCreateCommand(
					req));
		}
		if (EsbElementTypes.SmooksMediatorOutputConnector_3567 == req
				.getElementType()) {
			return getGEFWrapper(new SmooksMediatorOutputConnectorCreateCommand(
					req));
		}
