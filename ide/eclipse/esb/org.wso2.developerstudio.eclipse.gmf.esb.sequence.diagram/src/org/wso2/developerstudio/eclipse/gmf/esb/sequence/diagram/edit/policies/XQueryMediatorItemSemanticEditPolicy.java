...
import org.wso2.developerstudio.eclipse.gmf.esb.sequence.diagram.edit.commands.XQueryMediatorInputConnectorCreateCommand;
import org.wso2.developerstudio.eclipse.gmf.esb.sequence.diagram.edit.commands.XQueryMediatorOutputConnectorCreateCommand;
 ...
 * @generated
 */
public class XQueryMediatorItemSemanticEditPolicy extends
	...
	public XQueryMediatorItemSemanticEditPolicy() {
		super(EsbElementTypes.XQueryMediator_3553);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.XQueryMediatorInputConnector_3554 == req
				.getElementType()) {
			return getGEFWrapper(new XQueryMediatorInputConnectorCreateCommand(
					req));
		}
		if (EsbElementTypes.XQueryMediatorOutputConnector_3555 == req
				.getElementType()) {
			return getGEFWrapper(new XQueryMediatorOutputConnectorCreateCommand(
					req));
		}
