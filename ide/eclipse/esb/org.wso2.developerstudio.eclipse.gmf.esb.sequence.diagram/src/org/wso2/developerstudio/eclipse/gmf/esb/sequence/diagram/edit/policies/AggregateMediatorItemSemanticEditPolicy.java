...
import org.wso2.developerstudio.eclipse.gmf.esb.sequence.diagram.edit.commands.AggregateMediatorInputConnectorCreateCommand;
import org.wso2.developerstudio.eclipse.gmf.esb.sequence.diagram.edit.commands.AggregateMediatorOnCompleteOutputConnectorCreateCommand;
import org.wso2.developerstudio.eclipse.gmf.esb.sequence.diagram.edit.commands.AggregateMediatorOutputConnectorCreateCommand;
...
public class AggregateMediatorItemSemanticEditPolicy extends
	...
	public AggregateMediatorItemSemanticEditPolicy() {
		super(EsbElementTypes.AggregateMediator_3583);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.AggregateMediatorInputConnector_3584 == req
				.getElementType()) {
			return getGEFWrapper(new AggregateMediatorInputConnectorCreateCommand(
					req));
		}
		if (EsbElementTypes.AggregateMediatorOutputConnector_3585 == req
				.getElementType()) {
			return getGEFWrapper(new AggregateMediatorOutputConnectorCreateCommand(
					req));
		}
		if (EsbElementTypes.AggregateMediatorOnCompleteOutputConnector_3604 == req
				.getElementType()) {
