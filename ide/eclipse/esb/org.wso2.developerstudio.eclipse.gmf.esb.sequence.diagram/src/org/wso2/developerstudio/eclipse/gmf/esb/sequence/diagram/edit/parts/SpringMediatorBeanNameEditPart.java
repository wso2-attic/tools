 ...
 * @generated
 */
public class SpringMediatorBeanNameEditPart extends CompartmentEditPart
		...
		if (parser == null) {
			parser = EsbParserProvider
					.getParser(
							...
							getParserElement(),
							EsbVisualIDRegistry
									.getType(org.wso2.developerstudio.eclipse.gmf.esb.sequence.diagram.edit.parts.SpringMediatorBeanNameEditPart.VISUAL_ID));
		}
		return parser;
	}
