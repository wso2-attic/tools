...
import org.wso2.developerstudio.eclipse.gmf.esb.sequence.diagram.edit.commands.DBReportMediatorInputConnectorCreateCommand;
import org.wso2.developerstudio.eclipse.gmf.esb.sequence.diagram.edit.commands.DBReportMediatorOutputConnectorCreateCommand;
 ...
 * @generated
 */
public class DBReportMediatorItemSemanticEditPolicy extends
	...
	public DBReportMediatorItemSemanticEditPolicy() {
		super(EsbElementTypes.DBReportMediator_3562);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.DBReportMediatorInputConnector_3563 == req
				.getElementType()) {
			return getGEFWrapper(new DBReportMediatorInputConnectorCreateCommand(
					req));
		}
		if (EsbElementTypes.DBReportMediatorOutputConnector_3564 == req
				.getElementType()) {
			return getGEFWrapper(new DBReportMediatorOutputConnectorCreateCommand(
					req));
		}
