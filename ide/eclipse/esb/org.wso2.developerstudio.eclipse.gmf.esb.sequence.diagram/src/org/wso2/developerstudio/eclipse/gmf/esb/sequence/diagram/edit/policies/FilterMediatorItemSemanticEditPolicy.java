...
import org.wso2.developerstudio.eclipse.gmf.esb.sequence.diagram.edit.commands.FilterMediatorFailOutputConnectorCreateCommand;
import org.wso2.developerstudio.eclipse.gmf.esb.sequence.diagram.edit.commands.FilterMediatorInputConnectorCreateCommand;
import org.wso2.developerstudio.eclipse.gmf.esb.sequence.diagram.edit.commands.FilterMediatorPassOutputConnectorCreateCommand;
 ...
 * @generated
 */
public class FilterMediatorItemSemanticEditPolicy extends
	...
	public FilterMediatorItemSemanticEditPolicy() {
		super(EsbElementTypes.FilterMediator_3524);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.FilterMediatorInputConnector_3525 == req
				.getElementType()) {
			return getGEFWrapper(new FilterMediatorInputConnectorCreateCommand(
					req));
		}
		if (EsbElementTypes.FilterMediatorPassOutputConnector_3526 == req
				.getElementType()) {
			return getGEFWrapper(new FilterMediatorPassOutputConnectorCreateCommand(
					req));
		}
		if (EsbElementTypes.FilterMediatorFailOutputConnector_3527 == req
				.getElementType()) {
			return getGEFWrapper(new FilterMediatorFailOutputConnectorCreateCommand(
					req));
		}
