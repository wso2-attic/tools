 ...
 * @generated
 */
public class CacheMediatorCacheIdEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
		...
		if (parser == null) {
			parser = EsbParserProvider
					.getParser(
							...
							getParserElement(),
							EsbVisualIDRegistry
									.getType(org.wso2.developerstudio.eclipse.gmf.esb.sequence.diagram.edit.parts.CacheMediatorCacheIdEditPart.VISUAL_ID));
		}
		return parser;
	}
