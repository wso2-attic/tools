...
import org.wso2.developerstudio.eclipse.gmf.esb.sequence.diagram.edit.commands.IterateMediatorInputConnectorCreateCommand;
import org.wso2.developerstudio.eclipse.gmf.esb.sequence.diagram.edit.commands.IterateMediatorOutputConnectorCreateCommand;
...
public class IterateMediatorItemSemanticEditPolicy extends
	...
	public IterateMediatorItemSemanticEditPolicy() {
		super(EsbElementTypes.IterateMediator_3580);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.IterateMediatorInputConnector_3581 == req
				.getElementType()) {
			return getGEFWrapper(new IterateMediatorInputConnectorCreateCommand(
					req));
		}
		if (EsbElementTypes.IterateMediatorOutputConnector_3582 == req
				.getElementType()) {
