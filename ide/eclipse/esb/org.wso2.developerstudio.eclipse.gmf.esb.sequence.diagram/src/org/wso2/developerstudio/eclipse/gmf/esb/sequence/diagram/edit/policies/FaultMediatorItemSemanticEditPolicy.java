...
import org.wso2.developerstudio.eclipse.gmf.esb.sequence.diagram.edit.commands.FaultMediatorInputConnectorCreateCommand;
import org.wso2.developerstudio.eclipse.gmf.esb.sequence.diagram.edit.commands.FaultMediatorOutputConnectorCreateCommand;
 ...
 * @generated
 */
public class FaultMediatorItemSemanticEditPolicy extends
	...
	public FaultMediatorItemSemanticEditPolicy() {
		super(EsbElementTypes.FaultMediator_3550);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.FaultMediatorInputConnector_3551 == req
				.getElementType()) {
			return getGEFWrapper(new FaultMediatorInputConnectorCreateCommand(
					req));
		}
		if (EsbElementTypes.FaultMediatorOutputConnector_3552 == req
				.getElementType()) {
			return getGEFWrapper(new FaultMediatorOutputConnectorCreateCommand(
					req));
		}
