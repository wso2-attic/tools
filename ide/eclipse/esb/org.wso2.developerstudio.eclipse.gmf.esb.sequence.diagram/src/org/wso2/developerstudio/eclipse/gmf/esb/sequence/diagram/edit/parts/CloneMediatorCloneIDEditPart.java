 ...
 * @generated
 */
public class CloneMediatorCloneIDEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
		...
		if (parser == null) {
			parser = EsbParserProvider
					.getParser(
							...
							getParserElement(),
							EsbVisualIDRegistry
									.getType(org.wso2.developerstudio.eclipse.gmf.esb.sequence.diagram.edit.parts.CloneMediatorCloneIDEditPart.VISUAL_ID));
		}
		return parser;
	}
