...
import org.wso2.developerstudio.eclipse.gmf.esb.sequence.diagram.edit.commands.OAuthMediatorInputConnectorCreateCommand;
import org.wso2.developerstudio.eclipse.gmf.esb.sequence.diagram.edit.commands.OAuthMediatorOutputConnectorCreateCommand;
...
public class OAuthMediatorItemSemanticEditPolicy extends
	...
	public OAuthMediatorItemSemanticEditPolicy() {
		super(EsbElementTypes.OAuthMediator_3601);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.OAuthMediatorInputConnector_3602 == req
				.getElementType()) {
			return getGEFWrapper(new OAuthMediatorInputConnectorCreateCommand(
					req));
		}
		if (EsbElementTypes.OAuthMediatorOutputConnector_3603 == req
				.getElementType()) {
