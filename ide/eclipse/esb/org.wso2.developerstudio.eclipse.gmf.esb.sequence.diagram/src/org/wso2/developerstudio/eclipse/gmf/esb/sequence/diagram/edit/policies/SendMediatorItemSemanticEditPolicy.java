...
import org.wso2.developerstudio.eclipse.gmf.esb.sequence.diagram.edit.commands.SendMediatorInputConnectorCreateCommand;
import org.wso2.developerstudio.eclipse.gmf.esb.sequence.diagram.edit.commands.SendMediatorOutputConnectorCreateCommand;
 ...
 * @generated
 */
public class SendMediatorItemSemanticEditPolicy extends
	...
	public SendMediatorItemSemanticEditPolicy() {
		super(EsbElementTypes.SendMediator_3568);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.SendMediatorInputConnector_3569 == req
				.getElementType()) {
			return getGEFWrapper(new SendMediatorInputConnectorCreateCommand(
					req));
		}
		if (EsbElementTypes.SendMediatorOutputConnector_3570 == req
				.getElementType()) {
			return getGEFWrapper(new SendMediatorOutputConnectorCreateCommand(
					req));
		}
