...
import org.wso2.developerstudio.eclipse.gmf.esb.sequence.diagram.edit.commands.SpringMediatorInputConnectorCreateCommand;
import org.wso2.developerstudio.eclipse.gmf.esb.sequence.diagram.edit.commands.SpringMediatorOutputConnectorCreateCommand;
 ...
 * @generated
 */
public class SpringMediatorItemSemanticEditPolicy extends
	...
	public SpringMediatorItemSemanticEditPolicy() {
		super(EsbElementTypes.SpringMediator_3544);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.SpringMediatorInputConnector_3545 == req
				.getElementType()) {
			return getGEFWrapper(new SpringMediatorInputConnectorCreateCommand(
					req));
		}
		if (EsbElementTypes.SpringMediatorOutputConnector_3546 == req
				.getElementType()) {
			return getGEFWrapper(new SpringMediatorOutputConnectorCreateCommand(
					req));
		}
