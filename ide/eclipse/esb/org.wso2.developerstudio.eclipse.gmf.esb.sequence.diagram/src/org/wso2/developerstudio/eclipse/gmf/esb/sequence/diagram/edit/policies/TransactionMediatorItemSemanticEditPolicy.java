...
import org.wso2.developerstudio.eclipse.gmf.esb.sequence.diagram.edit.commands.TransactionMediatorInputConnectorCreateCommand;
import org.wso2.developerstudio.eclipse.gmf.esb.sequence.diagram.edit.commands.TransactionMediatorOutputConnectorCreateCommand;
 ...
 * @generated
 */
public class TransactionMediatorItemSemanticEditPolicy extends
	...
	public TransactionMediatorItemSemanticEditPolicy() {
		super(EsbElementTypes.TransactionMediator_3589);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.TransactionMediatorInputConnector_3590 == req
				.getElementType()) {
			return getGEFWrapper(new TransactionMediatorInputConnectorCreateCommand(
					req));
		}
		if (EsbElementTypes.TransactionMediatorOutputConnector_3591 == req
				.getElementType()) {
			return getGEFWrapper(new TransactionMediatorOutputConnectorCreateCommand(
					req));
		}
