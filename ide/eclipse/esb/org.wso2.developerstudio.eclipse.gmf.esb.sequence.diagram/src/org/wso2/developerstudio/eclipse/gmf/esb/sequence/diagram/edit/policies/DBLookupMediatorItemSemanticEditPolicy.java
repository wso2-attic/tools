...
import org.wso2.developerstudio.eclipse.gmf.esb.sequence.diagram.edit.commands.DBLookupMediatorInputConnectorCreateCommand;
import org.wso2.developerstudio.eclipse.gmf.esb.sequence.diagram.edit.commands.DBLookupMediatorOutputConnectorCreateCommand;
 ...
 * @generated
 */
public class DBLookupMediatorItemSemanticEditPolicy extends
	...
	public DBLookupMediatorItemSemanticEditPolicy() {
		super(EsbElementTypes.DBLookupMediator_3559);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.DBLookupMediatorInputConnector_3560 == req
				.getElementType()) {
			return getGEFWrapper(new DBLookupMediatorInputConnectorCreateCommand(
					req));
		}
		if (EsbElementTypes.DBLookupMediatorOutputConnector_3561 == req
				.getElementType()) {
			return getGEFWrapper(new DBLookupMediatorOutputConnectorCreateCommand(
					req));
		}
