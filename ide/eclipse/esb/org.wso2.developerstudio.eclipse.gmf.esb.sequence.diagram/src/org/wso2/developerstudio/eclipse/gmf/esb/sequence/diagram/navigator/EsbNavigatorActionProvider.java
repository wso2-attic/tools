...
import org.wso2.developerstudio.eclipse.gmf.esb.sequence.diagram.part.EsbDiagramEditor;
 ...
 * @generated
 */
public class EsbNavigatorActionProvider extends CommonActionProvider {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof Diagram) {
					...
					if (SequenceDiagramEditPart.MODEL_ID
							.equals(EsbVisualIDRegistry.getModelID(diagram))) {
						myDiagram = diagram;
					}
				}
			}
