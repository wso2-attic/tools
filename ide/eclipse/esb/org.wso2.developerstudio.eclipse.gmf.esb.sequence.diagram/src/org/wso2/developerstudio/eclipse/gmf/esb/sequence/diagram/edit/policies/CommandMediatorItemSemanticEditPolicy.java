...
import org.wso2.developerstudio.eclipse.gmf.esb.sequence.diagram.edit.commands.CommandMediatorInputConnectorCreateCommand;
import org.wso2.developerstudio.eclipse.gmf.esb.sequence.diagram.edit.commands.CommandMediatorOutputConnectorCreateCommand;
 ...
 * @generated
 */
public class CommandMediatorItemSemanticEditPolicy extends
	...
	public CommandMediatorItemSemanticEditPolicy() {
		super(EsbElementTypes.CommandMediator_3556);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.CommandMediatorInputConnector_3557 == req
				.getElementType()) {
			return getGEFWrapper(new CommandMediatorInputConnectorCreateCommand(
					req));
		}
		if (EsbElementTypes.CommandMediatorOutputConnector_3558 == req
				.getElementType()) {
			return getGEFWrapper(new CommandMediatorOutputConnectorCreateCommand(
					req));
		}
