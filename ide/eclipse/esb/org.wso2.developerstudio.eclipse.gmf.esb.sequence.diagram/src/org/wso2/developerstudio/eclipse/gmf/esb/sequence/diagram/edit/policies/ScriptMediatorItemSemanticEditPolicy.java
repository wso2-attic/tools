...
import org.wso2.developerstudio.eclipse.gmf.esb.sequence.diagram.edit.commands.ScriptMediatorInputConnectorCreateCommand;
import org.wso2.developerstudio.eclipse.gmf.esb.sequence.diagram.edit.commands.ScriptMediatorOutputConnectorCreateCommand;
 ...
 * @generated
 */
public class ScriptMediatorItemSemanticEditPolicy extends
	...
	public ScriptMediatorItemSemanticEditPolicy() {
		super(EsbElementTypes.ScriptMediator_3547);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.ScriptMediatorInputConnector_3548 == req
				.getElementType()) {
			return getGEFWrapper(new ScriptMediatorInputConnectorCreateCommand(
					req));
		}
		if (EsbElementTypes.ScriptMediatorOutputConnector_3549 == req
				.getElementType()) {
			return getGEFWrapper(new ScriptMediatorOutputConnectorCreateCommand(
					req));
		}
