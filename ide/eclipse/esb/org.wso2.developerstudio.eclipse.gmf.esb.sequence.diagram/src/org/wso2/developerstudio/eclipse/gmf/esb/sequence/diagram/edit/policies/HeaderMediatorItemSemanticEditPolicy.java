...
import org.wso2.developerstudio.eclipse.gmf.esb.sequence.diagram.edit.commands.HeaderMediatorInputConnectorCreateCommand;
import org.wso2.developerstudio.eclipse.gmf.esb.sequence.diagram.edit.commands.HeaderMediatorOutputConnectorCreateCommand;
 ...
 * @generated
 */
public class HeaderMediatorItemSemanticEditPolicy extends
	...
	public HeaderMediatorItemSemanticEditPolicy() {
		super(EsbElementTypes.HeaderMediator_3571);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.HeaderMediatorInputConnector_3572 == req
				.getElementType()) {
			return getGEFWrapper(new HeaderMediatorInputConnectorCreateCommand(
					req));
		}
		if (EsbElementTypes.HeaderMediatorOutputConnector_3573 == req
				.getElementType()) {
			return getGEFWrapper(new HeaderMediatorOutputConnectorCreateCommand(
					req));
		}
