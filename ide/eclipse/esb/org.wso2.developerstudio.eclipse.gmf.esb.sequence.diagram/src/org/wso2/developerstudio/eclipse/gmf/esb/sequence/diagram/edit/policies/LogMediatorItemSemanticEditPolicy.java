...
import org.wso2.developerstudio.eclipse.gmf.esb.sequence.diagram.edit.commands.LogMediatorInputConnectorCreateCommand;
import org.wso2.developerstudio.eclipse.gmf.esb.sequence.diagram.edit.commands.LogMediatorOutputConnectorCreateCommand;
 ...
 * @generated
 */
public class LogMediatorItemSemanticEditPolicy extends
	...
	public LogMediatorItemSemanticEditPolicy() {
		super(EsbElementTypes.LogMediator_3501);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.LogMediatorInputConnector_3502 == req
				.getElementType()) {
			return getGEFWrapper(new LogMediatorInputConnectorCreateCommand(req));
		}
		if (EsbElementTypes.LogMediatorOutputConnector_3503 == req
				.getElementType()) {
			return getGEFWrapper(new LogMediatorOutputConnectorCreateCommand(
					req));
		}
