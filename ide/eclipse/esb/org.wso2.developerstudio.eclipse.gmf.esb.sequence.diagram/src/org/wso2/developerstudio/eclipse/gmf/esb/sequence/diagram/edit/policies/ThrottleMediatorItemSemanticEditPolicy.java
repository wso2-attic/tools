...
import org.wso2.developerstudio.eclipse.gmf.esb.sequence.diagram.edit.commands.ThrottleMediatorInputConnectorCreateCommand;
import org.wso2.developerstudio.eclipse.gmf.esb.sequence.diagram.edit.commands.ThrottleMediatorOutputConnectorCreateCommand;
...
public class ThrottleMediatorItemSemanticEditPolicy extends
	...
	public ThrottleMediatorItemSemanticEditPolicy() {
		super(EsbElementTypes.ThrottleMediator_3592);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.ThrottleMediatorInputConnector_3593 == req
				.getElementType()) {
			return getGEFWrapper(new ThrottleMediatorInputConnectorCreateCommand(
					req));
		}
		if (EsbElementTypes.ThrottleMediatorOutputConnector_3594 == req
				.getElementType()) {
