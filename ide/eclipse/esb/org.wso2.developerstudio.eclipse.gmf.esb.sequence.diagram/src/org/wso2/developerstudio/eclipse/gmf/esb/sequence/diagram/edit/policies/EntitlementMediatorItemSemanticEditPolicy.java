...
import org.wso2.developerstudio.eclipse.gmf.esb.sequence.diagram.edit.commands.EntitlementMediatorInputConnectorCreateCommand;
import org.wso2.developerstudio.eclipse.gmf.esb.sequence.diagram.edit.commands.EntitlementMediatorOutputConnectorCreateCommand;
 ...
 * @generated
 */
public class EntitlementMediatorItemSemanticEditPolicy extends
	...
	public EntitlementMediatorItemSemanticEditPolicy() {
		super(EsbElementTypes.EntitlementMediator_3534);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.EntitlementMediatorInputConnector_3535 == req
				.getElementType()) {
			return getGEFWrapper(new EntitlementMediatorInputConnectorCreateCommand(
					req));
		}
		if (EsbElementTypes.EntitlementMediatorOutputConnector_3536 == req
				.getElementType()) {
			return getGEFWrapper(new EntitlementMediatorOutputConnectorCreateCommand(
					req));
		}
