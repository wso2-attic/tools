...
import org.wso2.developerstudio.eclipse.gmf.esb.sequence.diagram.edit.commands.RMSequenceMediatorInputConnectorCreateCommand;
import org.wso2.developerstudio.eclipse.gmf.esb.sequence.diagram.edit.commands.RMSequenceMediatorOutputConnectorCreateCommand;
 ...
 * @generated
 */
public class RMSequenceMediatorItemSemanticEditPolicy extends
	...
	public RMSequenceMediatorItemSemanticEditPolicy() {
		super(EsbElementTypes.RMSequenceMediator_3595);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.RMSequenceMediatorInputConnector_3596 == req
				.getElementType()) {
			return getGEFWrapper(new RMSequenceMediatorInputConnectorCreateCommand(
					req));
		}
		if (EsbElementTypes.RMSequenceMediatorOutputConnector_3597 == req
				.getElementType()) {
			return getGEFWrapper(new RMSequenceMediatorOutputConnectorCreateCommand(
					req));
		}
