...
import org.wso2.carbonstudio.eclipse.gmf.esb.diagram.edit.commands.SendMediatorInputConnectorCreateCommand;
import org.wso2.carbonstudio.eclipse.gmf.esb.diagram.edit.commands.SendMediatorOutputConnectorCreateCommand;
...
public class SendMediatorItemSemanticEditPolicy extends
	...
	public SendMediatorItemSemanticEditPolicy() {
		super(EsbElementTypes.SendMediator_3226);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.SendMediatorInputConnector_3085 == req
				.getElementType()) {
			return getGEFWrapper(new SendMediatorInputConnectorCreateCommand(
					req));
		}
		if (EsbElementTypes.SendMediatorOutputConnector_3086 == req
				.getElementType()) {
