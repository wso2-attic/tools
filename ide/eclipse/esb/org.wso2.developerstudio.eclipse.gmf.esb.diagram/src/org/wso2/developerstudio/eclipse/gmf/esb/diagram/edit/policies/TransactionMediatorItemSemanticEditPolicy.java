...
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.commands.TransactionMediatorInputConnectorCreateCommand;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.commands.TransactionMediatorOutputConnectorCreateCommand;
 ...
 * @generated
 */
public class TransactionMediatorItemSemanticEditPolicy extends EsbBaseItemSemanticEditPolicy {
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.TransactionMediatorInputConnector_3118 == req.getElementType()) {
			return getGEFWrapper(new TransactionMediatorInputConnectorCreateCommand(req));
		}
		if (EsbElementTypes.TransactionMediatorOutputConnector_3119 == req.getElementType()) {
			return getGEFWrapper(new TransactionMediatorOutputConnectorCreateCommand(req));
		}
