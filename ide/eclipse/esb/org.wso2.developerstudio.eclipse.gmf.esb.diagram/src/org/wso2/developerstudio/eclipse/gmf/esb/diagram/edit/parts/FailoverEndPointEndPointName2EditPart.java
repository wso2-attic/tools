 ...
 * @generated
 */
public class FailoverEndPointEndPointName2EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public FailoverEndPointEndPointName2EditPart(View view) {
		super(view);
	}
	...
	public void setLabelText(String text) {
		...
		if (pdEditPolicy instanceof EsbTextSelectionEditPolicy) {
			((EsbTextSelectionEditPolicy) pdEditPolicy).refreshFeedback();
		}
		Object sfEditPolicy = getEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE);
		if (sfEditPolicy instanceof EsbTextSelectionEditPolicy) {
			((EsbTextSelectionEditPolicy) sfEditPolicy).refreshFeedback();
		}
	}
		...
		if (parser == null) {
			parser = EsbParserProvider
					.getParser(
							...
							getParserElement(),
							EsbVisualIDRegistry
									.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.FailoverEndPointEndPointName2EditPart.VISUAL_ID));
		}
		return parser;
	}
 ...
 */
/*
 public class FailoverEndPointEndPointName2EditPart extends CompartmentEditPart implements
 ITextAwareEditPart {
...
/*
 ...
 if (parserElement != null && getParser() != null) {
 text =
 getParser().getPrintString(new EObjectAdapter(parserElement),
 getParserOptions().intValue());
 }
 if (text == null || text.length() == 0) {
 text = defaultText;
...
/*
 ...
 (IParserEditStatus) getEditingDomain().runExclusive(new RunnableWithResult.Impl<IParserEditStatus>() {
...
/*
 ...
 getParserElement(),
 EsbVisualIDRegistry.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.FailoverEndPointEndPointName2EditPart.VISUAL_ID));
 }
 return parser;
 }
...
/*
 ...
 (Character) theRequest.getExtendedData()
 .get(RequestConstants.REQ_DIRECTEDIT_EXTENDEDDATA_INITIAL_CHAR);
 performDirectEdit(initialChar.charValue());
 } else if ((theRequest instanceof DirectEditRequest) &&
 (getEditText().equals(getLabelText()))) {
...
/*
 protected void refreshUnderline() {
 FontStyle style =
 (FontStyle) getFontStyleOwnerView().getStyle(NotationPackage.eINSTANCE.getFontStyle());
 if (style != null && getFigure() instanceof WrappingLabel) {
 ((WrappingLabel) getFigure()).setTextUnderline(style.isUnderline());
 }
 }
