 ...
 * @generated
 */
public class ScriptMediatorScriptLanguage2EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public ScriptMediatorScriptLanguage2EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = EsbParserProvider
					.getParser(
							...
							getParserElement(),
							EsbVisualIDRegistry
									.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.ScriptMediatorScriptLanguage2EditPart.VISUAL_ID));
		}
		return parser;
	}
