 ...
 * @generated
 */
public class FaultMediatorFaultStringType2EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public FaultMediatorFaultStringType2EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = EsbParserProvider
					.getParser(
							...
							getParserElement(),
							EsbVisualIDRegistry
									.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.FaultMediatorFaultStringType2EditPart.VISUAL_ID));
		}
		return parser;
	}
