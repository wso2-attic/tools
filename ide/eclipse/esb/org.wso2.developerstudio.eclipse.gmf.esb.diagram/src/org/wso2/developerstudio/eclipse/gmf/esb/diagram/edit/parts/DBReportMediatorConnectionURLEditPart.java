 ...
 * @generated
 */
public class DBReportMediatorConnectionURLEditPart extends CompartmentEditPart implements
                                                                              ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public DBReportMediatorConnectionURLEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser =
			         EsbParserProvider.getParser(EsbElementTypes.DBReportMediator_3513,
			                                     getParserElement(),
			                                     EsbVisualIDRegistry.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.DBReportMediatorConnectionURLEditPart.VISUAL_ID));
		}
		return parser;
	}
