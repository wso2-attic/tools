 ...
 * @generated
 */
public class CommandMediatorClassName3EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public CommandMediatorClassName3EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = EsbParserProvider
					.getParser(
							...
							getParserElement(),
							EsbVisualIDRegistry
									.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.CommandMediatorClassName3EditPart.VISUAL_ID));
		}
		return parser;
	}
