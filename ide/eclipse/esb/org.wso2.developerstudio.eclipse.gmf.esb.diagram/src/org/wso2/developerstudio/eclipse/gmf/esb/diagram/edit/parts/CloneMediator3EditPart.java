...
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.CloneMediator3CanonicalEditPolicy;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.CloneMediator3ItemSemanticEditPolicy;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.part.EsbVisualIDRegistry;

/**
 * @generated NOT
 */
public class CloneMediator3EditPart extends AbstractMediator {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 3296;
	 ...
	 * @generated
	 */
	public CloneMediator3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new CloneMediator3ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE,
				new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new CloneMediator3CanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof CloneMediatorCloneID3EditPart) {
			((CloneMediatorCloneID3EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureCloneMediatorPropertyValue());
			return true;
		}
		if (childEditPart instanceof CloneMediatorInputConnector3EditPart) {
			IFigure borderItemFigure = ((CloneMediatorInputConnector3EditPart) childEditPart)
					.getFigure();
		...
		if (childEditPart instanceof CloneMediatorTargetOutputConnector3EditPart) {

			IFigure borderItemFigure = ((CloneMediatorTargetOutputConnector3EditPart) childEditPart)
					.getFigure();
		...
		if (childEditPart instanceof CloneMediatorOutputConnector3EditPart) {
			IFigure borderItemFigure = ((CloneMediatorOutputConnector3EditPart) childEditPart)
					.getFigure();
			BorderItemLocator locator = new FixedBorderItemLocator(
					getMainFigure(), borderItemFigure, PositionConstants.EAST,
					0.5);
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof CloneMediatorInputConnector3EditPart) {
			getBorderedFigure().getBorderItemContainer().remove(
					((CloneMediatorInputConnector3EditPart) childEditPart)
							.getFigure());
			return true;
		}
		if (childEditPart instanceof CloneMediatorOutputConnector3EditPart) {
			getBorderedFigure().getBorderItemContainer().remove(
					((CloneMediatorOutputConnector3EditPart) childEditPart)
							.getFigure());
			return true;
		}
		if (childEditPart instanceof CloneMediatorTargetOutputConnector3EditPart) {
			getBorderedFigure()
					...
					.remove(((CloneMediatorTargetOutputConnector3EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
