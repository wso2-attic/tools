...
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.FaultMediator2CanonicalEditPolicy;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.FaultMediator2ItemSemanticEditPolicy;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.part.EsbVisualIDRegistry;

/**
 * @generated NOT
 */
public class FaultMediator2EditPart extends AbstractMediator {
	 ...
	 * @generated
	 */
	public FaultMediator2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new FaultMediator2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE,
				new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new FaultMediator2CanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof FaultMediatorFaultStringType2EditPart) {
			((FaultMediatorFaultStringType2EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureFaultMediatorPropertyValue());
			return true;
		}
		if (childEditPart instanceof FaultMediatorInputConnector2EditPart) {
			IFigure borderItemFigure = ((FaultMediatorInputConnector2EditPart) childEditPart)
					.getFigure();
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof FaultMediatorInputConnector2EditPart) {
			getBorderedFigure().getBorderItemContainer().remove(
					((FaultMediatorInputConnector2EditPart) childEditPart)
							.getFigure());
			return true;
		}
		if (childEditPart instanceof FaultMediatorOutputConnector2EditPart) {
			getBorderedFigure().getBorderItemContainer().remove(
					((FaultMediatorOutputConnector2EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
