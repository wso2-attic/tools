...
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.DBLookupMediator3CanonicalEditPolicy;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.DBLookupMediator3ItemSemanticEditPolicy;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.part.EsbVisualIDRegistry;

/**
 * @generated NOT
 */
public class DBLookupMediator3EditPart extends AbstractMediator {
	 ...
	 * @generated
	 */
	public DBLookupMediator3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new DBLookupMediator3ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE,
				new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new DBLookupMediator3CanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DBLookupMediatorConnectionURL3EditPart) {
			((DBLookupMediatorConnectionURL3EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureDBLookupMediatorPropertyValue());
			return true;
		}
		if (childEditPart instanceof DBLookupMediatorInputConnector3EditPart) {
			IFigure borderItemFigure = ((DBLookupMediatorInputConnector3EditPart) childEditPart)
					.getFigure();
		...
		if (childEditPart instanceof DBLookupMediatorOutputConnector3EditPart) {
			IFigure borderItemFigure = ((DBLookupMediatorOutputConnector3EditPart) childEditPart)
					.getFigure();
			BorderItemLocator locator = new FixedBorderItemLocator(
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof DBLookupMediatorInputConnector3EditPart) {
			getBorderedFigure().getBorderItemContainer().remove(
					((DBLookupMediatorInputConnector3EditPart) childEditPart)
							.getFigure());
			return true;
		}
		if (childEditPart instanceof DBLookupMediatorOutputConnector3EditPart) {
			getBorderedFigure().getBorderItemContainer().remove(
					((DBLookupMediatorOutputConnector3EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
