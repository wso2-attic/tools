 ...
 * @generated
 */
public class HeaderMediatorValueLiteral3EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public HeaderMediatorValueLiteral3EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = EsbParserProvider
					.getParser(
							...
							getParserElement(),
							EsbVisualIDRegistry
									.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.HeaderMediatorValueLiteral3EditPart.VISUAL_ID));
		}
		return parser;
	}
