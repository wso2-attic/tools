 ...
 * @generated
 */
public class FilterMediatorConditionType3EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public FilterMediatorConditionType3EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = EsbParserProvider
					.getParser(
							...
							getParserElement(),
							EsbVisualIDRegistry
									.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.FilterMediatorConditionType3EditPart.VISUAL_ID));
		}
		return parser;
	}
