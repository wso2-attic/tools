 ...
 * @generated
 */
public class EsbNavigatorLinkHelper implements ILinkHelper {
	...
	public IStructuredSelection findSelection(IEditorInput anInput) {
		IDiagramDocument document =
		                            EsbDiagramEditorPlugin.getInstance().getDocumentProvider()
	...
	public void activateEditor(IWorkbenchPage aPage, IStructuredSelection aSelection) {
		...
		if (false == aSelection.getFirstElement() instanceof EsbAbstractNavigatorItem) {
			return;
		}

		EsbAbstractNavigatorItem abstractNavigatorItem =
		                                                 (EsbAbstractNavigatorItem) aSelection.getFirstElement();
		...
		if (editor instanceof DiagramEditor) {
			...
			EObject selectedView =
			                       diagramEditorResourceSet.getEObject(EcoreUtil.getURI(navigatorView),
			                                                           true);
			...
			EditPart selectedEditPart =
			                            (EditPart) graphicalViewer.getEditPartRegistry()
			                                                      .get(selectedView);
