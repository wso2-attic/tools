...
public abstract class AbstractEndpointAdditionalOutputConnector extends AbstractBorderItemEditPart {

	public NodeFigure figure_;	
	protected IFigure primaryShapeForward;
	public IFigure primaryShapeReverse;
	
	public AbstractEndpointAdditionalOutputConnector(View view) {
		super(view);
