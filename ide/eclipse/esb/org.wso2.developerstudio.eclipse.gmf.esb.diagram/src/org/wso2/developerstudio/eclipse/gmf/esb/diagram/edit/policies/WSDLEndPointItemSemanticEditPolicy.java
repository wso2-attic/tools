...
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.commands.WSDLEndPointInputConnectorCreateCommand;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.commands.WSDLEndPointOutputConnectorCreateCommand;
 ...
 * @generated
 */
public class WSDLEndPointItemSemanticEditPolicy extends EsbBaseItemSemanticEditPolicy {
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.WSDLEndPointInputConnector_3092 == req.getElementType()) {
			return getGEFWrapper(new WSDLEndPointInputConnectorCreateCommand(req));
		}
		if (EsbElementTypes.WSDLEndPointOutputConnector_3093 == req.getElementType()) {
			return getGEFWrapper(new WSDLEndPointOutputConnectorCreateCommand(req));
		}
