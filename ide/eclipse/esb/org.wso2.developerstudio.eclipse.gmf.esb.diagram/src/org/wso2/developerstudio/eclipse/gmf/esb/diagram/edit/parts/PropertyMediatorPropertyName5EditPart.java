 ...
 * @generated
 */
public class PropertyMediatorPropertyName5EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public PropertyMediatorPropertyName5EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = EsbParserProvider
					.getParser(
							...
							getParserElement(),
							EsbVisualIDRegistry
									.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.PropertyMediatorPropertyName5EditPart.VISUAL_ID));
		}
		return parser;
	}
