...
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.commands.HeaderMediatorInputConnectorCreateCommand;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.commands.HeaderMediatorOutputConnectorCreateCommand;
 ...
 * @generated
 */
public class HeaderMediatorItemSemanticEditPolicy extends EsbBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public HeaderMediatorItemSemanticEditPolicy() {
		super(EsbElementTypes.HeaderMediator_3516);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.HeaderMediatorInputConnector_3100 == req.getElementType()) {
			return getGEFWrapper(new HeaderMediatorInputConnectorCreateCommand(req));
		}
		if (EsbElementTypes.HeaderMediatorOutputConnector_3101 == req.getElementType()) {
			return getGEFWrapper(new HeaderMediatorOutputConnectorCreateCommand(req));
		}
