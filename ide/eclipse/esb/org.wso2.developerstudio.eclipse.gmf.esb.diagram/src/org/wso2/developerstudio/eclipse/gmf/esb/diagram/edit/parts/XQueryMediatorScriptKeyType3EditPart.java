 ...
 * @generated
 */
public class XQueryMediatorScriptKeyType3EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public XQueryMediatorScriptKeyType3EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = EsbParserProvider
					.getParser(
							...
							getParserElement(),
							EsbVisualIDRegistry
									.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.XQueryMediatorScriptKeyType3EditPart.VISUAL_ID));
		}
		return parser;
	}
