...
public class ProxyServiceOutSequenceCreateCommand extends EditElementCommand {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info)
		...
		ProxyServiceOutSequence newElement = EsbFactory.eINSTANCE.createProxyServiceOutSequence();

		ProxyServiceSequenceContainer owner = (ProxyServiceSequenceContainer) getElementToEdit();
		owner.setOutSequence(newElement);
	 ...
	 * @generated
	 */
	protected void doConfigure(ProxyServiceOutSequence newElement, IProgressMonitor monitor,
