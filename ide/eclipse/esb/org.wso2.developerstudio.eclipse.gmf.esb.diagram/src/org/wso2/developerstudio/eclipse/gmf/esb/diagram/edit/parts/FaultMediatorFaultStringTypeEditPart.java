 ...
 * @generated
 */
public class FaultMediatorFaultStringTypeEditPart extends CompartmentEditPart implements
                                                                             ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public FaultMediatorFaultStringTypeEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser =
			         EsbParserProvider.getParser(EsbElementTypes.FaultMediator_3509,
			                                     getParserElement(),
			                                     EsbVisualIDRegistry.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.FaultMediatorFaultStringTypeEditPart.VISUAL_ID));
		}
		return parser;
	}
