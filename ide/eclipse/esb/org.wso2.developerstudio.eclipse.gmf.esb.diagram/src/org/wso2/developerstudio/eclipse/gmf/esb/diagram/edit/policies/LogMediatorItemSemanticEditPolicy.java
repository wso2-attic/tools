...
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.commands.LogMediatorInputConnectorCreateCommand;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.commands.LogMediatorOutputConnectorCreateCommand;
 ...
 * @generated
 */
public class LogMediatorItemSemanticEditPolicy extends EsbBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public LogMediatorItemSemanticEditPolicy() {
		super(EsbElementTypes.LogMediator_3495);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.LogMediatorInputConnector_3018 == req.getElementType()) {
			return getGEFWrapper(new LogMediatorInputConnectorCreateCommand(req));
		}
		if (EsbElementTypes.LogMediatorOutputConnector_3019 == req.getElementType()) {
			return getGEFWrapper(new LogMediatorOutputConnectorCreateCommand(req));
		}
