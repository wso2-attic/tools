 ...
 * @generated
 */
public class OAuthMediatorRemoteServiceUrlEditPart extends CompartmentEditPart implements
                                                                              ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public OAuthMediatorRemoteServiceUrlEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser =
			         EsbParserProvider.getParser(EsbElementTypes.OAuthMediator_3524,
			                                     getParserElement(),
			                                     EsbVisualIDRegistry.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.OAuthMediatorRemoteServiceUrlEditPart.VISUAL_ID));
		}
		return parser;
	}
