...
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.commands.CalloutMediatorInputConnectorCreateCommand;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.commands.CalloutMediatorOutputConnectorCreateCommand;
 ...
 * @generated
 */
public class CalloutMediatorItemSemanticEditPolicy extends EsbBaseItemSemanticEditPolicy {
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.CalloutMediatorInputConnector_3115 == req.getElementType()) {
			return getGEFWrapper(new CalloutMediatorInputConnectorCreateCommand(req));
		}
		if (EsbElementTypes.CalloutMediatorOutputConnector_3116 == req.getElementType()) {
			return getGEFWrapper(new CalloutMediatorOutputConnectorCreateCommand(req));
		}
