...
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.commands.MediatorFlow2CreateCommand;
 ...
 * @generated
 */
public class SwitchCaseContainerItemSemanticEditPolicy extends EsbBaseItemSemanticEditPolicy {
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.MediatorFlow_3502 == req.getElementType()) {
			return getGEFWrapper(new MediatorFlow2CreateCommand(req));
		}
