 ...
 * @generated
 */
public class DBReportMediatorConnectionURL2EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public DBReportMediatorConnectionURL2EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = EsbParserProvider
					.getParser(
							...
							getParserElement(),
							EsbVisualIDRegistry
									.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.DBReportMediatorConnectionURL2EditPart.VISUAL_ID));
		}
		return parser;
	}
