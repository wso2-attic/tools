...
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.MergeNodeSecondInputConnectorItemSemanticEditPolicy;
...
public class MergeNodeSecondInputConnectorEditPart extends AbstractBorderItemEditPart {
	 ...
	 * @generated
	 */
	public MergeNodeSecondInputConnectorEditPart(View view) {
		super(view);
	}
