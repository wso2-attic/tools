 ...
 * @generated NOT
 */
public class CalloutMediatorEditPart extends AbstractMediator {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new CalloutMediatorCanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CalloutMediatorSoapActionEditPart) {
			((CalloutMediatorSoapActionEditPart) childEditPart).setLabel(getPrimaryShape().getFigureCalloutMediatorPropertyValue());
			return true;
		}
		if (childEditPart instanceof CalloutMediatorInputConnectorEditPart) {
			IFigure borderItemFigure =
			                           ((CalloutMediatorInputConnectorEditPart) childEditPart).getFigure();
		...
		if (childEditPart instanceof CalloutMediatorOutputConnectorEditPart) {
			IFigure borderItemFigure =
			                           ((CalloutMediatorOutputConnectorEditPart) childEditPart).getFigure();
			BorderItemLocator locator =
			                            new FixedBorderItemLocator(getMainFigure(),
			                                                       borderItemFigure,
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof CalloutMediatorInputConnectorEditPart) {
			getBorderedFigure().getBorderItemContainer()
			                   .remove(((CalloutMediatorInputConnectorEditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof CalloutMediatorOutputConnectorEditPart) {
			getBorderedFigure().getBorderItemContainer()
			                   .remove(((CalloutMediatorOutputConnectorEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(EsbVisualIDRegistry.getType(CalloutMediatorSoapActionEditPart.VISUAL_ID));
	}
