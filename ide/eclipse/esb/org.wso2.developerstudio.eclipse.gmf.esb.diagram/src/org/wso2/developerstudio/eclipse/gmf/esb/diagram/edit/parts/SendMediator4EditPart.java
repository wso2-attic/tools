...
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.SendMediator4CanonicalEditPolicy;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.SendMediator4ItemSemanticEditPolicy;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.part.EsbVisualIDRegistry;

/**
 * @generated NOT
 */
public class SendMediator4EditPart extends AbstractMediator {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 3353;
	 ...
	 * @generated
	 */
	public SendMediator4EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new SendMediator4ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE,
				new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new SendMediator4CanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof SendMediatorInputConnector4EditPart) {

			IFigure borderItemFigure = ((SendMediatorInputConnector4EditPart) childEditPart)
					.getFigure();
		...
		} else if (childEditPart instanceof SendMediatorOutputConnector4EditPart) {

			IFigure borderItemFigure = ((SendMediatorOutputConnector4EditPart) childEditPart)
					.getFigure();
			BorderItemLocator locator = new FixedBorderItemLocator(
