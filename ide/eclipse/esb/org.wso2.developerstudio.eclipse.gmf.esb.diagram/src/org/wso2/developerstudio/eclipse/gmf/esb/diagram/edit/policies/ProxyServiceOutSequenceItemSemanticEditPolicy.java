...
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.commands.MediatorFlow5CreateCommand;
 ...
 * @generated
 */
public class ProxyServiceOutSequenceItemSemanticEditPolicy extends EsbBaseItemSemanticEditPolicy {
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.MediatorFlow_3529 == req.getElementType()) {
			return getGEFWrapper(new MediatorFlow5CreateCommand(req));
		}
