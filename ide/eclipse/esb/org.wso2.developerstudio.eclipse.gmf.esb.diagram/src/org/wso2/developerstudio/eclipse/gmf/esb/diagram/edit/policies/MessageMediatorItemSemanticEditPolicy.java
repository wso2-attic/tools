...
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.commands.MessageInputConnectorCreateCommand;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.commands.MessageOutputConnectorCreateCommand;
 ...
 * @generated
 */
public class MessageMediatorItemSemanticEditPolicy extends EsbBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public MessageMediatorItemSemanticEditPolicy() {
		super(EsbElementTypes.MessageMediator_3045);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.MessageInputConnector_3046 == req.getElementType()) {
			return getGEFWrapper(new MessageInputConnectorCreateCommand(req));
		}
		if (EsbElementTypes.MessageOutputConnector_3047 == req.getElementType()) {
			return getGEFWrapper(new MessageOutputConnectorCreateCommand(req));
		}
