 ...
 * @generated
 */
public class LogMediatorLogCategory2EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public LogMediatorLogCategory2EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = EsbParserProvider
					.getParser(
							...
							getParserElement(),
							EsbVisualIDRegistry
									.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.LogMediatorLogCategory2EditPart.VISUAL_ID));
		}
		return parser;
	}
