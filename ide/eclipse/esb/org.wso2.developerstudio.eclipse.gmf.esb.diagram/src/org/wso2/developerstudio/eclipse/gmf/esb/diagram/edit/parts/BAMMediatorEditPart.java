...
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.BAMMediatorCanonicalEditPolicy;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.BAMMediatorItemSemanticEditPolicy;
...
public class BAMMediatorEditPart extends FixedSizedAbstractMediator {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof BAMMediatorOutputConnectorEditPart) {
			IFigure borderItemFigure = ((BAMMediatorOutputConnectorEditPart) childEditPart)
					.getFigure();
			BorderItemLocator locator = new FixedBorderItemLocator(getMainFigure(),
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof BAMMediatorOutputConnectorEditPart) {
			getBorderedFigure().getBorderItemContainer().remove(
					((BAMMediatorOutputConnectorEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
