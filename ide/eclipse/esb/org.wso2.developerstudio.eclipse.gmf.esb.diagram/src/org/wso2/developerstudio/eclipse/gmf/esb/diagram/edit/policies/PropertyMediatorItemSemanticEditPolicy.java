 ...
 * @generated
 */
public class PropertyMediatorItemSemanticEditPolicy extends EsbBaseItemSemanticEditPolicy {
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.PropertyMediatorInputConnector_3033 == req.getElementType()) {
			return getGEFWrapper(new PropertyMediatorInputConnectorCreateCommand(req));
		}
		if (EsbElementTypes.PropertyMediatorOutputConnector_3034 == req.getElementType()) {
			return getGEFWrapper(new PropertyMediatorOutputConnectorCreateCommand(req));
		}
