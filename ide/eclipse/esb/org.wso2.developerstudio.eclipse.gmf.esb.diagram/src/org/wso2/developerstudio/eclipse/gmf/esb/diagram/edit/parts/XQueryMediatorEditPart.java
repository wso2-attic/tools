...
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.XQueryMediatorCanonicalEditPolicy;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.XQueryMediatorItemSemanticEditPolicy;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.part.EsbVisualIDRegistry;

/**
 * @generated NOT
 */
public class XQueryMediatorEditPart extends AbstractMediator {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof XQueryMediatorScriptKeyTypeEditPart) {
			((XQueryMediatorScriptKeyTypeEditPart) childEditPart).setLabel(getPrimaryShape().getFigureXQueryMediatorPropertyValue());
			return true;
		}
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof XQueryMediatorInputConnectorEditPart) {
			getBorderedFigure().getBorderItemContainer()
			                   .remove(((XQueryMediatorInputConnectorEditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof XQueryMediatorOutputConnectorEditPart) {
			getBorderedFigure().getBorderItemContainer()
			                   .remove(((XQueryMediatorOutputConnectorEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(EsbVisualIDRegistry.getType(XQueryMediatorScriptKeyTypeEditPart.VISUAL_ID));
	}
