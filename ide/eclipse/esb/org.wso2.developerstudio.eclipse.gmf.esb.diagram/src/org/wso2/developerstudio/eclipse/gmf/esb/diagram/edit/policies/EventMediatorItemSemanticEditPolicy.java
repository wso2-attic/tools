...
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.commands.EventMediatorInputConnectorCreateCommand;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.commands.EventMediatorOutputConnectorCreateCommand;
 ...
 * @generated
 */
public class EventMediatorItemSemanticEditPolicy extends EsbBaseItemSemanticEditPolicy {
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.EventMediatorInputConnector_3052 == req.getElementType()) {
			return getGEFWrapper(new EventMediatorInputConnectorCreateCommand(req));
		}
		if (EsbElementTypes.EventMediatorOutputConnector_3053 == req.getElementType()) {
			return getGEFWrapper(new EventMediatorOutputConnectorCreateCommand(req));
		}
