...
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.commands.DefaultEndPointInputConnectorCreateCommand;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.commands.DefaultEndPointOutputConnectorCreateCommand;
 ...
 * @generated
 */
public class DefaultEndPointItemSemanticEditPolicy extends EsbBaseItemSemanticEditPolicy {
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.DefaultEndPointInputConnector_3021 == req.getElementType()) {
			return getGEFWrapper(new DefaultEndPointInputConnectorCreateCommand(req));
		}
		if (EsbElementTypes.DefaultEndPointOutputConnector_3022 == req.getElementType()) {
			return getGEFWrapper(new DefaultEndPointOutputConnectorCreateCommand(req));
		}
