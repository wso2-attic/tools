...
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.SendMediator2CanonicalEditPolicy;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.SendMediator2ItemSemanticEditPolicy;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.part.EsbVisualIDRegistry;

/**
 * @generated NOT
 */
public class SendMediator2EditPart extends AbstractMediator {
	 ...
	 * @generated
	 */
	public SendMediator2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new SendMediator2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE,
				new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new SendMediator2CanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof SendMediatorInputConnector2EditPart) {

			IFigure borderItemFigure = ((SendMediatorInputConnector2EditPart) childEditPart)
					.getFigure();
		...
		} else if (childEditPart instanceof SendMediatorOutputConnector2EditPart) {

			IFigure borderItemFigure = ((SendMediatorOutputConnector2EditPart) childEditPart)
					.getFigure();
			BorderItemLocator locator = new FixedBorderItemLocator(
