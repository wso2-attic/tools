		...
		Platform.getAdapterManager().registerAdapters(new IAdapterFactory() {
			...
			public Object getAdapter(Object adaptableObject, Class adapterType) {
				if (adaptableObject instanceof org.wso2.developerstudio.eclipse.gmf.esb.diagram.navigator.EsbNavigatorItem &&
					...
					return ((org.wso2.developerstudio.eclipse.gmf.esb.diagram.navigator.EsbNavigatorItem) adaptableObject).getView();
				}
				return null;
			}
	...
	public boolean equals(Object obj) {
		if (obj instanceof org.wso2.developerstudio.eclipse.gmf.esb.diagram.navigator.EsbNavigatorItem) {
			return EcoreUtil.getURI(getView())
			                .equals(EcoreUtil.getURI(((org.wso2.developerstudio.eclipse.gmf.esb.diagram.navigator.EsbNavigatorItem) obj).getView()));
		}
