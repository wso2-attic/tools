...
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.commands.DBReportMediatorInputConnectorCreateCommand;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.commands.DBReportMediatorOutputConnectorCreateCommand;
 ...
 * @generated
 */
public class DBReportMediatorItemSemanticEditPolicy extends EsbBaseItemSemanticEditPolicy {
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.DBReportMediatorInputConnector_3079 == req.getElementType()) {
			return getGEFWrapper(new DBReportMediatorInputConnectorCreateCommand(req));
		}
		if (EsbElementTypes.DBReportMediatorOutputConnector_3080 == req.getElementType()) {
			return getGEFWrapper(new DBReportMediatorOutputConnectorCreateCommand(req));
		}
