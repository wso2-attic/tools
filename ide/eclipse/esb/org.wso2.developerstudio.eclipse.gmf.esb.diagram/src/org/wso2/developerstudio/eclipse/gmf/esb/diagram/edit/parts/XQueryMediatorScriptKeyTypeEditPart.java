 ...
 * @generated
 */
public class XQueryMediatorScriptKeyTypeEditPart extends CompartmentEditPart implements
                                                                            ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public XQueryMediatorScriptKeyTypeEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser =
			         EsbParserProvider.getParser(EsbElementTypes.XQueryMediator_3510,
			                                     getParserElement(),
			                                     EsbVisualIDRegistry.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.XQueryMediatorScriptKeyTypeEditPart.VISUAL_ID));
		}
		return parser;
	}
