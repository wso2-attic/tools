 ...
 * @generated
 */
public class HeaderMediatorValueLiteralEditPart extends CompartmentEditPart implements
                                                                           ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public HeaderMediatorValueLiteralEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser =
			         EsbParserProvider.getParser(EsbElementTypes.HeaderMediator_3516,
			                                     getParserElement(),
			                                     EsbVisualIDRegistry.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.HeaderMediatorValueLiteralEditPart.VISUAL_ID));
		}
		return parser;
	}
