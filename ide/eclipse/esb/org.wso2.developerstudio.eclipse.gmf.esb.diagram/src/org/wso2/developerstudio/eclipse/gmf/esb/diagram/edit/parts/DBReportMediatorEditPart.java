...
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.DBReportMediatorCanonicalEditPolicy;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.DBReportMediatorItemSemanticEditPolicy;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.part.EsbVisualIDRegistry;

/**
 * @generated NOT
 */
public class DBReportMediatorEditPart extends AbstractMediator {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DBReportMediatorConnectionURLEditPart) {
			((DBReportMediatorConnectionURLEditPart) childEditPart).setLabel(getPrimaryShape()
