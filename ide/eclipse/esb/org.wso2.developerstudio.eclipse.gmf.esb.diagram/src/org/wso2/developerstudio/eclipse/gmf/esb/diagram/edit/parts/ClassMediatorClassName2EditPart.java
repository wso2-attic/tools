 ...
 * @generated
 */
public class ClassMediatorClassName2EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public ClassMediatorClassName2EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = EsbParserProvider
					.getParser(
							...
							getParserElement(),
							EsbVisualIDRegistry
									.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.ClassMediatorClassName2EditPart.VISUAL_ID));
		}
		return parser;
	}
