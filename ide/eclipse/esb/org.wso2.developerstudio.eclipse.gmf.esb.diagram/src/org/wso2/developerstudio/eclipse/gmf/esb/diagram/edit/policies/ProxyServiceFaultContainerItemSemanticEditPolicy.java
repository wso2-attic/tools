...
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.commands.MediatorFlow6CreateCommand;
 ...
 * @generated
 */
public class ProxyServiceFaultContainerItemSemanticEditPolicy extends EsbBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public ProxyServiceFaultContainerItemSemanticEditPolicy() {
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.MediatorFlow_3530 == req.getElementType()) {
			return getGEFWrapper(new MediatorFlow6CreateCommand(req));
		}
