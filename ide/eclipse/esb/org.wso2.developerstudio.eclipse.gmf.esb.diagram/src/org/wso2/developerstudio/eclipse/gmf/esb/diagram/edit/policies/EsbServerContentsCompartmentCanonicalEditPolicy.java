 ...
 * @generated
 */
public class EsbServerContentsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<EsbNodeDescriptor> childDescriptors =
		                                           EsbDiagramUpdater.getEsbServerContentsCompartment_7001SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<EsbNodeDescriptor> childDescriptors =
		                                           EsbDiagramUpdater.getEsbServerContentsCompartment_7001SemanticChildren((View) getHost().getModel());
