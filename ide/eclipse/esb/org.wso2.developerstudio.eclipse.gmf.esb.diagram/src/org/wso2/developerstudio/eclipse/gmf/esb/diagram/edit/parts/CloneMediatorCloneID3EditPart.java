 ...
 * @generated
 */
public class CloneMediatorCloneID3EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public CloneMediatorCloneID3EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = EsbParserProvider
					.getParser(
							...
							getParserElement(),
							EsbVisualIDRegistry
									.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.CloneMediatorCloneID3EditPart.VISUAL_ID));
		}
		return parser;
	}
