...
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.commands.OAuthMediatorInputConnectorCreateCommand;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.commands.OAuthMediatorOutputConnectorCreateCommand;
 ...
 * @generated
 */
public class OAuthMediatorItemSemanticEditPolicy extends EsbBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public OAuthMediatorItemSemanticEditPolicy() {
		super(EsbElementTypes.OAuthMediator_3524);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.OAuthMediatorInputConnector_3130 == req.getElementType()) {
			return getGEFWrapper(new OAuthMediatorInputConnectorCreateCommand(req));
		}
		if (EsbElementTypes.OAuthMediatorOutputConnector_3131 == req.getElementType()) {
			return getGEFWrapper(new OAuthMediatorOutputConnectorCreateCommand(req));
		}
