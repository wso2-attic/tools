...
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.DBLookupMediator4CanonicalEditPolicy;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.DBLookupMediator4ItemSemanticEditPolicy;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.part.EsbVisualIDRegistry;

/**
 * @generated NOT
 */
public class DBLookupMediator4EditPart extends AbstractMediator {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 3347;
	 ...
	 * @generated
	 */
	public DBLookupMediator4EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new DBLookupMediator4ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE,
				new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new DBLookupMediator4CanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DBLookupMediatorConnectionURL4EditPart) {
			((DBLookupMediatorConnectionURL4EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureDBLookupMediatorPropertyValue());
			return true;
		}
		if (childEditPart instanceof DBLookupMediatorInputConnector4EditPart) {

			IFigure borderItemFigure = ((DBLookupMediatorInputConnector4EditPart) childEditPart)
					.getFigure();
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof DBLookupMediatorInputConnector4EditPart) {
			getBorderedFigure().getBorderItemContainer().remove(
					((DBLookupMediatorInputConnector4EditPart) childEditPart)
							.getFigure());
			return true;
		}
		if (childEditPart instanceof DBLookupMediatorOutputConnector4EditPart) {
			getBorderedFigure().getBorderItemContainer().remove(
					((DBLookupMediatorOutputConnector4EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
