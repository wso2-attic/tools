...
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.custom.configure.ui.ConfigureRuleMediatorFactsDialog.FactWrapper;
...
public class ConfigureScriptKeysDialog extends TitleAreaDialog {
	...
	public ConfigureScriptKeysDialog(Shell parentShell,ScriptMediator ruleMediator, TransactionalEditingDomain editingDomain) {
		super(parentShell);
