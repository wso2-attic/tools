 ...
 * @generated
 */
public class AggregateMediatorAggregateID2EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public AggregateMediatorAggregateID2EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = EsbParserProvider
					.getParser(
							...
							getParserElement(),
							EsbVisualIDRegistry
									.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.AggregateMediatorAggregateID2EditPart.VISUAL_ID));
		}
		return parser;
	}
