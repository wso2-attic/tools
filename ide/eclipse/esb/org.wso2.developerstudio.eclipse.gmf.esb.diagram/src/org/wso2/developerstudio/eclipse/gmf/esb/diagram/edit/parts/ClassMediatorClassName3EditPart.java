 ...
 * @generated
 */
public class ClassMediatorClassName3EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public ClassMediatorClassName3EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = EsbParserProvider
					.getParser(
							...
							getParserElement(),
							EsbVisualIDRegistry
									.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.ClassMediatorClassName3EditPart.VISUAL_ID));
		}
		return parser;
	}
