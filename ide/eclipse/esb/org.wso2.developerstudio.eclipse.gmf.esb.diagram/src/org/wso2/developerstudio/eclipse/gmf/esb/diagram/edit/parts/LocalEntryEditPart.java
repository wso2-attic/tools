 ...
 * @generated
 */
public class LocalEntryEditPart extends ShapeNodeEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 3663;
	 ...
	 * @generated
	 */
	public LocalEntryEditPart(View view) {
		super(view);
	}
	...
	protected IFigure createNodeShape() {
		return primaryShape = new LocalEntryFigure();
	}

	/**
	 * @generated
	 */
	public LocalEntryFigure getPrimaryShape() {
		return (LocalEntryFigure) primaryShape;
	}
	...
	public class LocalEntryFigure extends EsbGraphicalShape {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureLocalEntryNamePropertyLabel;
		...
		private void createContents() {
			...
			fFigureLocalEntryNamePropertyLabel = new WrappingLabel();
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureLocalEntryNamePropertyLabel() {
			return fFigureLocalEntryNamePropertyLabel;
		}
