...
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.commands.MediatorFlow4CreateCommand;
 ...
 * @generated
 */
public class SwitchDefaultContainerItemSemanticEditPolicy extends EsbBaseItemSemanticEditPolicy {
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.MediatorFlow_3528 == req.getElementType()) {
			return getGEFWrapper(new MediatorFlow4CreateCommand(req));
		}
