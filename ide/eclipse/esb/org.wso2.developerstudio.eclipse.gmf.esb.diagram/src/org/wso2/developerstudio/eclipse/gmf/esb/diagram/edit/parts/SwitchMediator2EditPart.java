...
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.SwitchMediator2CanonicalEditPolicy;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.SwitchMediator2ItemSemanticEditPolicy;
...
public class SwitchMediator2EditPart extends AbstractBorderedShapeEditPart {
	 ...
	 * @generated
	 */
	public SwitchMediator2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new SwitchMediator2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE,
				new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new SwitchMediator2CanonicalEditPolicy());
