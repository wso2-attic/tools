...
public class ScriptMediatorEditPart extends AbstractMediator {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ScriptMediatorScriptLanguageEditPart) {
			((ScriptMediatorScriptLanguageEditPart) childEditPart).setLabel(getPrimaryShape().getFigureScriptMediatorPropertyValue());
			return true;
		}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(EsbVisualIDRegistry.getType(ScriptMediatorScriptLanguageEditPart.VISUAL_ID));
	}
