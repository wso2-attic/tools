...
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.commands.XQueryMediatorInputConnectorCreateCommand;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.commands.XQueryMediatorOutputConnectorCreateCommand;
 ...
 * @generated
 */
public class XQueryMediatorItemSemanticEditPolicy extends EsbBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public XQueryMediatorItemSemanticEditPolicy() {
		super(EsbElementTypes.XQueryMediator_3510);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.XQueryMediatorInputConnector_3070 == req.getElementType()) {
			return getGEFWrapper(new XQueryMediatorInputConnectorCreateCommand(req));
		}
		if (EsbElementTypes.XQueryMediatorOutputConnector_3071 == req.getElementType()) {
			return getGEFWrapper(new XQueryMediatorOutputConnectorCreateCommand(req));
		}
