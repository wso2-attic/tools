 ...
 * @generated
 */
public class ThrottleMediatorGroupIdEditPart extends CompartmentEditPart implements
                                                                        ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ThrottleMediatorGroupIdEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser =
			         EsbParserProvider.getParser(EsbElementTypes.ThrottleMediator_3493,
			                                     getParserElement(),
			                                     EsbVisualIDRegistry.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.ThrottleMediatorGroupIdEditPart.VISUAL_ID));
		}
		return parser;
	}
