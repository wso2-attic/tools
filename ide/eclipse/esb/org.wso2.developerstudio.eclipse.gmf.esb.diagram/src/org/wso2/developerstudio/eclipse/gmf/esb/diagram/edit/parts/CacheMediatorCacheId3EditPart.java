 ...
 * @generated
 */
public class CacheMediatorCacheId3EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public CacheMediatorCacheId3EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = EsbParserProvider
					.getParser(
							...
							getParserElement(),
							EsbVisualIDRegistry
									.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.CacheMediatorCacheId3EditPart.VISUAL_ID));
		}
		return parser;
	}
