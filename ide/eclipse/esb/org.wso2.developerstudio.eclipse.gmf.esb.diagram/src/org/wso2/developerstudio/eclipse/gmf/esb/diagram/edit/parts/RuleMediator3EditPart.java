...
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.RuleMediator3CanonicalEditPolicy;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.RuleMediator3ItemSemanticEditPolicy;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.part.EsbVisualIDRegistry;

/**
 * @generated NOT
 */
public class RuleMediator3EditPart extends AbstractMediator {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 3480;
	 ...
	 * @generated
	 */
	public RuleMediator3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new RuleMediator3ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE,
				new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new RuleMediator3CanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof RuleMediatorInputConnector3EditPart) {

			IFigure borderItemFigure = ((RuleMediatorInputConnector3EditPart) childEditPart)
					.getFigure();
		...
		} else if (childEditPart instanceof RuleMediatorOutputConnector3EditPart) {

			IFigure borderItemFigure = ((RuleMediatorOutputConnector3EditPart) childEditPart)
					.getFigure();
			BorderItemLocator locator = new FixedBorderItemLocator(
