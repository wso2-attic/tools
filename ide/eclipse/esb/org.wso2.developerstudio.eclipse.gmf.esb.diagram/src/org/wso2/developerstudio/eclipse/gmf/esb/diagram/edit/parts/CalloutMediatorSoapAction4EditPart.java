 ...
 * @generated
 */
public class CalloutMediatorSoapAction4EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public CalloutMediatorSoapAction4EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = EsbParserProvider
					.getParser(
							...
							getParserElement(),
							EsbVisualIDRegistry
									.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.CalloutMediatorSoapAction4EditPart.VISUAL_ID));
		}
		return parser;
	}
