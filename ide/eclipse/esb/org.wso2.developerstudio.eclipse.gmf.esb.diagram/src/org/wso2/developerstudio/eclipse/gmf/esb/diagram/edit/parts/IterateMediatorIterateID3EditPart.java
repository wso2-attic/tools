 ...
 * @generated
 */
public class IterateMediatorIterateID3EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public IterateMediatorIterateID3EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = EsbParserProvider
					.getParser(
							...
							getParserElement(),
							EsbVisualIDRegistry
									.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.IterateMediatorIterateID3EditPart.VISUAL_ID));
		}
		return parser;
	}
