...
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.SmooksMediator3CanonicalEditPolicy;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.SmooksMediator3ItemSemanticEditPolicy;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.part.EsbVisualIDRegistry;

/**
 * @generated NOT
 */
public class SmooksMediator3EditPart extends AbstractMediator {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 3452;
	 ...
	 * @generated
	 */
	public SmooksMediator3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new SmooksMediator3ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE,
				new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new SmooksMediator3CanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof SmooksMediatorInputConnector3EditPart) {

			IFigure borderItemFigure = ((SmooksMediatorInputConnector3EditPart) childEditPart)
					.getFigure();
		...
		} else if (childEditPart instanceof SmooksMediatorOutputConnector3EditPart) {

			IFigure borderItemFigure = ((SmooksMediatorOutputConnector3EditPart) childEditPart)
					.getFigure();
			BorderItemLocator locator = new FixedBorderItemLocator(
