...
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.EJBMediatorCanonicalEditPolicy;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.EJBMediatorItemSemanticEditPolicy;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.part.EsbVisualIDRegistry;

/**
 * @generated NOT
 */
public class EJBMediatorEditPart extends FixedSizedAbstractMediator {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 3686;
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new EJBMediatorItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new EJBMediatorCanonicalEditPolicy());
	 ...
	 * @generated
	 */
	public EJBMediatorFigure getPrimaryShape() {
		return (EJBMediatorFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof EJBMediatorOutputConnectorEditPart) {
			IFigure borderItemFigure = ((EJBMediatorOutputConnectorEditPart) childEditPart)
					.getFigure();
			BorderItemLocator locator = new FixedBorderItemLocator(getMainFigure(),
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof EJBMediatorOutputConnectorEditPart) {
			getBorderedFigure().getBorderItemContainer().remove(
					((EJBMediatorOutputConnectorEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
