 ...
 * @generated
 */
public class EntitlementMediatorServerURL2EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public EntitlementMediatorServerURL2EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = EsbParserProvider
					.getParser(
							...
							getParserElement(),
							EsbVisualIDRegistry
									.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.EntitlementMediatorServerURL2EditPart.VISUAL_ID));
		}
		return parser;
	}
