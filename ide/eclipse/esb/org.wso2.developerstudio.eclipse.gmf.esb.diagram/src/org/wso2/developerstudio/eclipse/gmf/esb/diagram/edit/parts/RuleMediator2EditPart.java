...
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.RuleMediator2CanonicalEditPolicy;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.RuleMediator2ItemSemanticEditPolicy;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.part.EsbVisualIDRegistry;

/**
 * @generated NOT
 */
public class RuleMediator2EditPart extends AbstractMediator {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 3315;
	 ...
	 * @generated
	 */
	public RuleMediator2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new RuleMediator2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE,
				new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new RuleMediator2CanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof RuleMediatorInputConnector2EditPart) {

			IFigure borderItemFigure = ((RuleMediatorInputConnector2EditPart) childEditPart)
					.getFigure();
		...
		} else if (childEditPart instanceof RuleMediatorOutputConnector2EditPart) {

			IFigure borderItemFigure = ((RuleMediatorOutputConnector2EditPart) childEditPart)
					.getFigure();
			BorderItemLocator locator = new FixedBorderItemLocator(
