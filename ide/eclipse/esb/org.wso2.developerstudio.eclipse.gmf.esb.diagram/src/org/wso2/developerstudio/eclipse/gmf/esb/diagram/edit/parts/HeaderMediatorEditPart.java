...
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.HeaderMediatorCanonicalEditPolicy;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.HeaderMediatorItemSemanticEditPolicy;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.part.EsbVisualIDRegistry;

/**
 * @generated NOT
 */
public class HeaderMediatorEditPart extends AbstractMediator {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof HeaderMediatorValueLiteralEditPart) {
			((HeaderMediatorValueLiteralEditPart) childEditPart).setLabel(getPrimaryShape().getFigureHeaderMediatorPropertyValue());
			return true;
		}
		if (childEditPart instanceof HeaderMediatorInputConnectorEditPart) {
			IFigure borderItemFigure =
			                           ((HeaderMediatorInputConnectorEditPart) childEditPart).getFigure();
		...
		if (childEditPart instanceof HeaderMediatorOutputConnectorEditPart) {
			IFigure borderItemFigure =
			                           ((HeaderMediatorOutputConnectorEditPart) childEditPart).getFigure();
			BorderItemLocator locator =
			                            new FixedBorderItemLocator(getMainFigure(),
			                                                       borderItemFigure,
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(EsbVisualIDRegistry.getType(HeaderMediatorValueLiteralEditPart.VISUAL_ID));
	}
