 ...
 * @generated
 */
public class DBLookupMediatorConnectionURL3EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public DBLookupMediatorConnectionURL3EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = EsbParserProvider
					.getParser(
							...
							getParserElement(),
							EsbVisualIDRegistry
									.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.DBLookupMediatorConnectionURL3EditPart.VISUAL_ID));
		}
		return parser;
	}
