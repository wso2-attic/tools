...
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.RMSequenceMediator5CanonicalEditPolicy;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.RMSequenceMediator5ItemSemanticEditPolicy;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.part.EsbVisualIDRegistry;

/**
 * @generated NOT
 */
public class RMSequenceMediator5EditPart extends AbstractMediator {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 3477;
	 ...
	 * @generated
	 */
	public RMSequenceMediator5EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new RMSequenceMediator5ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE,
				new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new RMSequenceMediator5CanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof RMSequenceMediatorInputConnector5EditPart) {

			IFigure borderItemFigure = ((RMSequenceMediatorInputConnector5EditPart) childEditPart)
					.getFigure();
		...
		} else if (childEditPart instanceof RMSequenceMediatorOutputConnector5EditPart) {

			IFigure borderItemFigure = ((RMSequenceMediatorOutputConnector5EditPart) childEditPart)
					.getFigure();
			BorderItemLocator locator = new FixedBorderItemLocator(
	...
	public class RMSequenceMediatorFigure extends EsbGraphicalShape {
		...
		private void createContents() {
			...
			this.getPropertyValueRectangle1().add(
					fFigureRMSequenceMediatorPropertyValue);
