...
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.DBLookupMediator2CanonicalEditPolicy;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.DBLookupMediator2ItemSemanticEditPolicy;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.part.EsbVisualIDRegistry;

/**
 * @generated NOT
 */
public class DBLookupMediator2EditPart extends AbstractMediator {
	 ...
	 * @generated
	 */
	public DBLookupMediator2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new DBLookupMediator2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DBLookupMediatorConnectionURL2EditPart) {
			((DBLookupMediatorConnectionURL2EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureDBLookupMediatorPropertyValue());
			return true;
		}
		if (childEditPart instanceof DBLookupMediatorInputConnector2EditPart) {
			IFigure borderItemFigure = ((DBLookupMediatorInputConnector2EditPart) childEditPart)
					.getFigure();
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof DBLookupMediatorInputConnector2EditPart) {
			getBorderedFigure().getBorderItemContainer().remove(
					((DBLookupMediatorInputConnector2EditPart) childEditPart)
							.getFigure());
			return true;
		}
		if (childEditPart instanceof DBLookupMediatorOutputConnector2EditPart) {
			getBorderedFigure().getBorderItemContainer().remove(
					((DBLookupMediatorOutputConnector2EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
