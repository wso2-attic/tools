 ...
 * @generated
 */
public class ThrottleMediatorGroupId3EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public ThrottleMediatorGroupId3EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = EsbParserProvider
					.getParser(
							...
							getParserElement(),
							EsbVisualIDRegistry
									.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.ThrottleMediatorGroupId3EditPart.VISUAL_ID));
		}
		return parser;
	}
