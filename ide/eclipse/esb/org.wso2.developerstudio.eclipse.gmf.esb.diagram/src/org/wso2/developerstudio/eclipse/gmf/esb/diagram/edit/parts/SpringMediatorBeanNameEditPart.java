 ...
 * @generated
 */
public class SpringMediatorBeanNameEditPart extends CompartmentEditPart implements
                                                                       ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public SpringMediatorBeanNameEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser =
			         EsbParserProvider.getParser(EsbElementTypes.SpringMediator_3507,
			                                     getParserElement(),
			                                     EsbVisualIDRegistry.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.SpringMediatorBeanNameEditPart.VISUAL_ID));
		}
		return parser;
	}
