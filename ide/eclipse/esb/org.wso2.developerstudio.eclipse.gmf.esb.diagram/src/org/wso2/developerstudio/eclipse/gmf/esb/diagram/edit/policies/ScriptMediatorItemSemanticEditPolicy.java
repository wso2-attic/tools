...
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.commands.ScriptMediatorInputConnectorCreateCommand;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.commands.ScriptMediatorOutputConnectorCreateCommand;
 ...
 * @generated
 */
public class ScriptMediatorItemSemanticEditPolicy extends EsbBaseItemSemanticEditPolicy {
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.ScriptMediatorInputConnector_3064 == req.getElementType()) {
			return getGEFWrapper(new ScriptMediatorInputConnectorCreateCommand(req));
		}
		if (EsbElementTypes.ScriptMediatorOutputConnector_3065 == req.getElementType()) {
			return getGEFWrapper(new ScriptMediatorOutputConnectorCreateCommand(req));
		}
