 ...
 * @generated
 */
public class FaultMediatorFaultStringType5EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public FaultMediatorFaultStringType5EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = EsbParserProvider
					.getParser(
							...
							getParserElement(),
							EsbVisualIDRegistry
									.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.FaultMediatorFaultStringType5EditPart.VISUAL_ID));
		}
		return parser;
	}
