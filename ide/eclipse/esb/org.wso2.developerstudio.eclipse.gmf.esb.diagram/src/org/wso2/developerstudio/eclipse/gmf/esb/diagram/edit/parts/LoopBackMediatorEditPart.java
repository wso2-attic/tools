...
public class LoopBackMediatorEditPart extends FixedSizedAbstractMediator {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new LoopBackMediatorCanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof LoopBackMediatorDescriptionEditPart) {
			((LoopBackMediatorDescriptionEditPart) childEditPart).setLabel(getPrimaryShape()
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof LoopBackMediatorInputConnectorEditPart) {
			getBorderedFigure().getBorderItemContainer().remove(
					((LoopBackMediatorInputConnectorEditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof LoopBackMediatorOutputConnectorEditPart) {
			getBorderedFigure().getBorderItemContainer().remove(
					((LoopBackMediatorOutputConnectorEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
