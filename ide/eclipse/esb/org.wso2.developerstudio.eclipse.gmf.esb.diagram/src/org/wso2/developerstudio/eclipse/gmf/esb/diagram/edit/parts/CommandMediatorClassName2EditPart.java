 ...
 * @generated
 */
public class CommandMediatorClassName2EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public CommandMediatorClassName2EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = EsbParserProvider
					.getParser(
							...
							getParserElement(),
							EsbVisualIDRegistry
									.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.CommandMediatorClassName2EditPart.VISUAL_ID));
		}
		return parser;
	}
