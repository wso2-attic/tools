...
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.PropertyMediator4CanonicalEditPolicy;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.PropertyMediator4ItemSemanticEditPolicy;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.part.EsbVisualIDRegistry;

/**
 * @generated NOT
 */
public class PropertyMediator4EditPart extends AbstractMediator {
	 ...
	 * @generated
	 */
	public PropertyMediator4EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new PropertyMediator4ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE,
				new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new PropertyMediator4CanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PropertyMediatorPropertyName4EditPart) {
			((PropertyMediatorPropertyName4EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigurePropertyMediatorPropertyValueLabel());
			return true;
		}
		if (childEditPart instanceof PropertyMediatorInputConnector3EditPart) {
			IFigure borderItemFigure = ((PropertyMediatorInputConnector3EditPart) childEditPart)
					.getFigure();
		...
		if (childEditPart instanceof PropertyMediatorOutputConnector3EditPart) {
			IFigure borderItemFigure = ((PropertyMediatorOutputConnector3EditPart) childEditPart)
					.getFigure();
			BorderItemLocator locator = new FixedBorderItemLocator(
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof PropertyMediatorInputConnector3EditPart) {
			getBorderedFigure().getBorderItemContainer().remove(
					((PropertyMediatorInputConnector3EditPart) childEditPart)
							.getFigure());
			return true;
		}
		if (childEditPart instanceof PropertyMediatorOutputConnector3EditPart) {
			getBorderedFigure().getBorderItemContainer().remove(
					((PropertyMediatorOutputConnector3EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
