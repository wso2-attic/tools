 ...
 * @generated
 */
public class DefaultEndPointEndPointNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public DefaultEndPointEndPointNameEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = EsbParserProvider
					.getParser(
							...
							getParserElement(),
							EsbVisualIDRegistry
									.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.DefaultEndPointEndPointNameEditPart.VISUAL_ID));
		}
		return parser;
	}
