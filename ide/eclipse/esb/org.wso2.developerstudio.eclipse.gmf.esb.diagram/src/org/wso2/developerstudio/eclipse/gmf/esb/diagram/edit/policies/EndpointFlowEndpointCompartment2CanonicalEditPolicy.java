 ...
 * @generated
 */
public class EndpointFlowEndpointCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<EsbNodeDescriptor> childDescriptors = EsbDiagramUpdater
				.getEndpointFlowEndpointCompartment_7029SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<EsbNodeDescriptor> childDescriptors = EsbDiagramUpdater
				.getEndpointFlowEndpointCompartment_7029SemanticChildren((View) getHost()
						.getModel());
