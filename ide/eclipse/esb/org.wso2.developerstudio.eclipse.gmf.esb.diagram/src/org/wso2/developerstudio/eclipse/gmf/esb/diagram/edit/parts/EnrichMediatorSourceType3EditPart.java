 ...
 * @generated
 */
public class EnrichMediatorSourceType3EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public EnrichMediatorSourceType3EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = EsbParserProvider
					.getParser(
							...
							getParserElement(),
							EsbVisualIDRegistry
									.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.EnrichMediatorSourceType3EditPart.VISUAL_ID));
		}
		return parser;
	}
