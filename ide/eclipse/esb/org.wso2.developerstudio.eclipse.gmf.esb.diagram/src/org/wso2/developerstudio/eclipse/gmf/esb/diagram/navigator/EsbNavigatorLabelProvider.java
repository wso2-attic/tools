...
public class EsbNavigatorLabelProvider extends LabelProvider implements ICommonLabelProvider,
	...
	private String getSendMediator_3515Text(View view) {
		IParser parser = EsbParserProvider.getParser(EsbElementTypes.SendMediator_3515,
				view.getElement() != null ? view.getElement() : view,
		...
		if (parser != null) {
			...
			EsbDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5182); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
