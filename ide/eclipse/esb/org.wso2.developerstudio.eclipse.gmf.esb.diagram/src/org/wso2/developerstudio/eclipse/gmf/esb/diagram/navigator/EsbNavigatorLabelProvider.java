...
public class EsbNavigatorLabelProvider extends LabelProvider implements ICommonLabelProvider,
	...
	private String getAddressEndPoint_3564Text(View view) {
		IParser parser = EsbParserProvider.getParser(EsbElementTypes.AddressEndPoint_3564,
				view.getElement() != null ? view.getElement() : view,
		...
		if (parser != null) {
			...
			EsbDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5151); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getDefaultEndPoint_3563Text(View view) {
		IParser parser = EsbParserProvider.getParser(EsbElementTypes.DefaultEndPoint_3563,
				view.getElement() != null ? view.getElement() : view,
		...
		if (parser != null) {
			...
			EsbDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5150); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getLoadBalanceEndPoint_3567Text(View view) {
		IParser parser = EsbParserProvider.getParser(EsbElementTypes.LoadBalanceEndPoint_3567,
				view.getElement() != null ? view.getElement() : view,
		...
		if (parser != null) {
			...
			EsbDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5154); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getFailoverEndPoint_3565Text(View view) {
		IParser parser = EsbParserProvider.getParser(EsbElementTypes.FailoverEndPoint_3565,
				view.getElement() != null ? view.getElement() : view,
		...
		if (parser != null) {
			...
			EsbDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5152); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getWSDLEndPoint_3566Text(View view) {
		IParser parser = EsbParserProvider.getParser(EsbElementTypes.WSDLEndPoint_3566,
				view.getElement() != null ? view.getElement() : view,
		...
		if (parser != null) {
			...
			EsbDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5153); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
