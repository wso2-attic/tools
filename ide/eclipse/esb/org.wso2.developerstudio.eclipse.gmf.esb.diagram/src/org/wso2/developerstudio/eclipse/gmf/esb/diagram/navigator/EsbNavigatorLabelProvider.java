...
public class EsbNavigatorLabelProvider extends LabelProvider implements ICommonLabelProvider,
	...
	public Image getImage(View view) {
		...
		case MessageStoreEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Node?http:///org/wso2/developerstudio/eclipse/gmf/esb?MessageStore", EsbElementTypes.MessageStore_3700); //$NON-NLS-1$
	...
	public String getText(View view) {
		...
		case MessageStoreEditPart.VISUAL_ID:
			return getMessageStore_3700Text(view);
		case LoadBalanceEndPointInputConnector2EditPart.VISUAL_ID:
	...
	private String getDefaultEndPoint_3609Text(View view) {
		...
		if (parser != null) {
			...
			EsbDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5155); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getLoadBalanceEndPoint_3613Text(View view) {
		...
		if (parser != null) {
			...
			EsbDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5159); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getRecipientListEndPoint_3692Text(View view) {
		...
		if (domainModelElement != null) {
			...
			EsbDiagramEditorPlugin.getInstance().logError(
					"No domain element for view with visualID = " + 3692); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getConditionalRouterMediator_3635Text(View view) {
		ConditionalRouterMediator domainModelElement = (ConditionalRouterMediator) view
				.getElement();
		if (domainModelElement != null) {
			return String.valueOf(domainModelElement.isReverse());
		} else {
			EsbDiagramEditorPlugin.getInstance().logError(
					"No domain element for view with visualID = " + 3635); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getBeanMediator_3683Text(View view) {
		BeanMediator domainModelElement = (BeanMediator) view.getElement();
		if (domainModelElement != null) {
			return String.valueOf(domainModelElement.isReverse());
		} else {
			EsbDiagramEditorPlugin.getInstance().logError(
					"No domain element for view with visualID = " + 3683); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getWSDLEndPoint_3612Text(View view) {
		...
		if (parser != null) {
			...
			EsbDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5158); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getStoreMediator_3588Text(View view) {
		...
		if (domainModelElement != null) {
			return domainModelElement.getMessageStore();
		} else {
			EsbDiagramEditorPlugin.getInstance().logError(
	...
	private String getCallTemplateMediator_3594Text(View view) {
		CallTemplateMediator domainModelElement = (CallTemplateMediator) view.getElement();
		if (domainModelElement != null) {
			return String.valueOf(domainModelElement.isReverse());
		} else {
			EsbDiagramEditorPlugin.getInstance().logError(
	...
	private String getAddressingEndpoint_3689Text(View view) {
		AddressingEndpoint domainModelElement = (AddressingEndpoint) view.getElement();
		if (domainModelElement != null) {
			return domainModelElement.getEndPointName();
		} else {
			EsbDiagramEditorPlugin.getInstance().logError(
					"No domain element for view with visualID = " + 3689); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getAddressEndPoint_3610Text(View view) {
		...
		if (parser != null) {
			...
			EsbDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5156); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getBuilderMediator_3591Text(View view) {
		BuilderMediator domainModelElement = (BuilderMediator) view.getElement();
		if (domainModelElement != null) {
			return String.valueOf(domainModelElement.isReverse());
		} else {
			EsbDiagramEditorPlugin.getInstance().logError(
	 ...
	 * @generated
	 */
	private String getMessageStore_3700Text(View view) {
		MessageStore domainModelElement = (MessageStore) view.getElement();
		if (domainModelElement != null) {
			return domainModelElement.getStoreName();
		} else {
			EsbDiagramEditorPlugin.getInstance().logError(
					"No domain element for view with visualID = " + 3700); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getBAMMediator_3680Text(View view) {
		BAMMediator domainModelElement = (BAMMediator) view.getElement();
		if (domainModelElement != null) {
			return domainModelElement.getStreamName();
		} else {
			EsbDiagramEditorPlugin.getInstance().logError(
					"No domain element for view with visualID = " + 3680); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getPayloadFactoryMediator_3597Text(View view) {
		PayloadFactoryMediator domainModelElement = (PayloadFactoryMediator) view.getElement();
		if (domainModelElement != null) {
			return String.valueOf(domainModelElement.isReverse());
		} else {
			EsbDiagramEditorPlugin.getInstance().logError(
	...
	private String getURLRewriteMediator_3620Text(View view) {
		URLRewriteMediator domainModelElement = (URLRewriteMediator) view.getElement();
		if (domainModelElement != null) {
			return String.valueOf(domainModelElement.isReverse());
		} else {
			EsbDiagramEditorPlugin.getInstance().logError(
					"No domain element for view with visualID = " + 3620); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getFailoverEndPoint_3611Text(View view) {
		...
		if (parser != null) {
			...
			EsbDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5157); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getEJBMediator_3686Text(View view) {
		EJBMediator domainModelElement = (EJBMediator) view.getElement();
		if (domainModelElement != null) {
			return domainModelElement.getJNDIName();
		} else {
			EsbDiagramEditorPlugin.getInstance().logError(
					"No domain element for view with visualID = " + 3686); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getEnqueueMediator_3600Text(View view) {
		EnqueueMediator domainModelElement = (EnqueueMediator) view.getElement();
		if (domainModelElement != null) {
			return String.valueOf(domainModelElement.isReverse());
		} else {
			EsbDiagramEditorPlugin.getInstance().logError(
