...
public class EsbNavigatorLabelProvider extends LabelProvider implements
	...
	public Image getImage(View view) {
		...
		case ProxyServiceEndpointContainerEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Node?http:///org/wso2/developerstudio/eclipse/gmf/esb?ProxyServiceEndpointContainer", EsbElementTypes.ProxyServiceEndpointContainer_3381); //$NON-NLS-1$
		...
		case ProxyServiceSequenceContainerEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Node?http:///org/wso2/developerstudio/eclipse/gmf/esb?ProxyServiceSequenceContainer", EsbElementTypes.ProxyServiceSequenceContainer_3196); //$NON-NLS-1$
