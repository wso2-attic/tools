 ...
 * @generated
 */
public class ClassMediatorClassNameEditPart extends CompartmentEditPart implements
                                                                       ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ClassMediatorClassNameEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser =
			         EsbParserProvider.getParser(EsbElementTypes.ClassMediator_3506,
			                                     getParserElement(),
			                                     EsbVisualIDRegistry.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.ClassMediatorClassNameEditPart.VISUAL_ID));
		}
		return parser;
	}
