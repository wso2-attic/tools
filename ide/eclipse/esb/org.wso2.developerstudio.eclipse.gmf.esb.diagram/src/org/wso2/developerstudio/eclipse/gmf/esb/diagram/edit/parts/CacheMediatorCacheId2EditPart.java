 ...
 * @generated
 */
public class CacheMediatorCacheId2EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public CacheMediatorCacheId2EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = EsbParserProvider
					.getParser(
							...
							getParserElement(),
							EsbVisualIDRegistry
									.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.CacheMediatorCacheId2EditPart.VISUAL_ID));
		}
		return parser;
	}
