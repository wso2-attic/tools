...
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.CalloutMediator2CanonicalEditPolicy;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.CalloutMediator2ItemSemanticEditPolicy;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.part.EsbVisualIDRegistry;

/**
 * @generated NOT
 */
public class CalloutMediator2EditPart extends AbstractMediator {
	 ...
	 * @generated
	 */
	public CalloutMediator2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new CalloutMediator2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CalloutMediatorSoapAction2EditPart) {
			((CalloutMediatorSoapAction2EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureCalloutMediatorPropertyValue());
			return true;
		}
		if (childEditPart instanceof CalloutMediatorInputConnector2EditPart) {
			IFigure borderItemFigure = ((CalloutMediatorInputConnector2EditPart) childEditPart)
					.getFigure();
		...
		if (childEditPart instanceof CalloutMediatorOutputConnector2EditPart) {
			IFigure borderItemFigure = ((CalloutMediatorOutputConnector2EditPart) childEditPart)
					.getFigure();
			BorderItemLocator locator = new FixedBorderItemLocator(
