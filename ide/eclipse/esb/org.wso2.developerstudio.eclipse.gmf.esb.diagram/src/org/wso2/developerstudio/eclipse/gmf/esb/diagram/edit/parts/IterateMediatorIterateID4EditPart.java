 ...
 * @generated
 */
public class IterateMediatorIterateID4EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public IterateMediatorIterateID4EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = EsbParserProvider
					.getParser(
							...
							getParserElement(),
							EsbVisualIDRegistry
									.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.IterateMediatorIterateID4EditPart.VISUAL_ID));
		}
		return parser;
	}
