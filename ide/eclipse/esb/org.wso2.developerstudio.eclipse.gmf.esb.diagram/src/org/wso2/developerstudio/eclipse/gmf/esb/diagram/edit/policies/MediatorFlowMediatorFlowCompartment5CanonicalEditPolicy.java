...
public class MediatorFlowMediatorFlowCompartment5CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<EsbNodeDescriptor> childDescriptors =
		                                           EsbDiagramUpdater.getMediatorFlowMediatorFlowCompartment_7018SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<EsbNodeDescriptor> childDescriptors =
		                                           EsbDiagramUpdater.getMediatorFlowMediatorFlowCompartment_7018SemanticChildren((View) getHost().getModel());
