 ...
 * @generated
 */
public class DBReportMediatorConnectionURL3EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public DBReportMediatorConnectionURL3EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = EsbParserProvider
					.getParser(
							...
							getParserElement(),
							EsbVisualIDRegistry
									.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.DBReportMediatorConnectionURL3EditPart.VISUAL_ID));
		}
		return parser;
	}
