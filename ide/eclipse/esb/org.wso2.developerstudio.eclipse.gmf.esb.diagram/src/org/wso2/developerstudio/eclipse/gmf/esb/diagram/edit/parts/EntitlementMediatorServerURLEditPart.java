 ...
 * @generated
 */
public class EntitlementMediatorServerURLEditPart extends CompartmentEditPart implements
                                                                             ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public EntitlementMediatorServerURLEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser =
			         EsbParserProvider.getParser(EsbElementTypes.EntitlementMediator_3505,
			                                     getParserElement(),
			                                     EsbVisualIDRegistry.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.EntitlementMediatorServerURLEditPart.VISUAL_ID));
		}
		return parser;
	}
