 ...
 * @generated
 */
public class DBLookupMediatorConnectionURLEditPart extends CompartmentEditPart implements
                                                                              ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public DBLookupMediatorConnectionURLEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser =
			         EsbParserProvider.getParser(EsbElementTypes.DBLookupMediator_3512,
			                                     getParserElement(),
			                                     EsbVisualIDRegistry.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.DBLookupMediatorConnectionURLEditPart.VISUAL_ID));
		}
		return parser;
	}
