 ...
 * @generated
 */
public class DefaultEndPoint2ItemSemanticEditPolicy extends
	...
	public DefaultEndPoint2ItemSemanticEditPolicy() {
		super(EsbElementTypes.DefaultEndPoint_3382);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.DefaultEndPointInputConnector_3021 == req
				.getElementType()) {
			return getGEFWrapper(new DefaultEndPointInputConnectorCreateCommand(
					req));
		}
		if (EsbElementTypes.DefaultEndPointOutputConnector_3022 == req
				.getElementType()) {
			return getGEFWrapper(new DefaultEndPointOutputConnectorCreateCommand(
					req));
		}
