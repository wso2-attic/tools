...
public class PropertyMediatorEditPart extends AbstractMediator {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PropertyMediatorPropertyNameEditPart) {
			((PropertyMediatorPropertyNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigurePropertyMediatorPropertyValueLabel());
			return true;
		}
		if (childEditPart instanceof PropertyMediatorInputConnectorEditPart) {
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof PropertyMediatorInputConnectorEditPart) {
			getBorderedFigure().getBorderItemContainer()
			                   .remove(((PropertyMediatorInputConnectorEditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof PropertyMediatorOutputConnectorEditPart) {
			getBorderedFigure().getBorderItemContainer()
			                   .remove(((PropertyMediatorOutputConnectorEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	 ...
	 */
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(EsbVisualIDRegistry.getType(PropertyMediatorPropertyNameEditPart.VISUAL_ID));
	}
