 ...
 * @generated NOT
 */
public class EntitlementMediatorEditPart extends AbstractMediator {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof EntitlementMediatorServerURLEditPart) {
			((EntitlementMediatorServerURLEditPart) childEditPart).setLabel(getPrimaryShape().getFigureEntitlementMediatorPropertyValue());
			return true;
		}
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof EntitlementMediatorInputConnectorEditPart) {
			getBorderedFigure().getBorderItemContainer()
			                   .remove(((EntitlementMediatorInputConnectorEditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof EntitlementMediatorOutputConnectorEditPart) {
			getBorderedFigure().getBorderItemContainer()
			                   .remove(((EntitlementMediatorOutputConnectorEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
