 ...
 * @generated
 */
public class SpringMediatorBeanName2EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public SpringMediatorBeanName2EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = EsbParserProvider
					.getParser(
							...
							getParserElement(),
							EsbVisualIDRegistry
									.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.SpringMediatorBeanName2EditPart.VISUAL_ID));
		}
		return parser;
	}
