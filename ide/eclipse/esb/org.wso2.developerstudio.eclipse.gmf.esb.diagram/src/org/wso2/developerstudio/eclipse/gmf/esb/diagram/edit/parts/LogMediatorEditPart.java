 ...
 * @generated NOT
 */
public class LogMediatorEditPart extends AbstractMediator {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new LogMediatorItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new LogMediatorCanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof LogMediatorLogCategoryEditPart) {
			((LogMediatorLogCategoryEditPart) childEditPart).setLabel(getPrimaryShape().getFigureLogCatogeryLogPropertyLabel());
			return true;
		}
		if (childEditPart instanceof LogMediatorInputConnectorEditPart) {
			IFigure borderItemFigure =
			                           ((LogMediatorInputConnectorEditPart) childEditPart).getFigure();
		...
		if (childEditPart instanceof LogMediatorOutputConnectorEditPart) {
			IFigure borderItemFigure =
			                           ((LogMediatorOutputConnectorEditPart) childEditPart).getFigure();
			BorderItemLocator locator =
			                            new FixedBorderItemLocator(getMainFigure(),
			                                                       borderItemFigure,
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof LogMediatorInputConnectorEditPart) {
			getBorderedFigure().getBorderItemContainer()
			                   .remove(((LogMediatorInputConnectorEditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof LogMediatorOutputConnectorEditPart) {
			getBorderedFigure().getBorderItemContainer()
			                   .remove(((LogMediatorOutputConnectorEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
