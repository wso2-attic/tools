...
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.ProxyFaultInputConnectorItemSemanticEditPolicy;
...
public class ProxyFaultInputConnectorEditPart extends AbstractBaseFigureFaultInputConnectorEditPart {
	 ...
	 * @generated
	 */
	public static final int VISUAL_ID = 3489;
	 ...
	 * @generated
	 */
	public ProxyFaultInputConnectorEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ProxyFaultInputConnectorItemSemanticEditPolicy());
		...
		if (request instanceof CreateConnectionViewAndElementRequest) {
			...
			if (sourceConnection instanceof AbstractOutputConnectorEditPart) {
				if (sourceConnection.getParent() instanceof EditPart) {
					/* check whether source is a child of fault sequence compartment*/
					if (!(sourceConnection.getParent().getParent() instanceof MediatorFlowMediatorFlowCompartment6EditPart)) {
