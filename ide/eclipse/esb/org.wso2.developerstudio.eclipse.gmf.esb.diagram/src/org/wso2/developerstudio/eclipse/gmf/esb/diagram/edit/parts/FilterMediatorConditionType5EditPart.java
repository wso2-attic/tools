 ...
 * @generated
 */
public class FilterMediatorConditionType5EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public FilterMediatorConditionType5EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = EsbParserProvider
					.getParser(
							...
							getParserElement(),
							EsbVisualIDRegistry
									.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.FilterMediatorConditionType5EditPart.VISUAL_ID));
		}
		return parser;
	}
