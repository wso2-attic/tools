...
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.commands.DBLookupMediatorInputConnectorCreateCommand;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.commands.DBLookupMediatorOutputConnectorCreateCommand;
 ...
 * @generated
 */
public class DBLookupMediatorItemSemanticEditPolicy extends EsbBaseItemSemanticEditPolicy {
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.DBLookupMediatorInputConnector_3076 == req.getElementType()) {
			return getGEFWrapper(new DBLookupMediatorInputConnectorCreateCommand(req));
		}
		if (EsbElementTypes.DBLookupMediatorOutputConnector_3077 == req.getElementType()) {
			return getGEFWrapper(new DBLookupMediatorOutputConnectorCreateCommand(req));
		}
