 ...
 * @generated
 */
public class LogMediatorLogCategory3EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public LogMediatorLogCategory3EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = EsbParserProvider
					.getParser(
							...
							getParserElement(),
							EsbVisualIDRegistry
									.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.LogMediatorLogCategory3EditPart.VISUAL_ID));
		}
		return parser;
	}
