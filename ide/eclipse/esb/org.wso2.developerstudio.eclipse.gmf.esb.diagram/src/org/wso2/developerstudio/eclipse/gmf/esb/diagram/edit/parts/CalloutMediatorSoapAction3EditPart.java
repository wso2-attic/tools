 ...
 * @generated
 */
public class CalloutMediatorSoapAction3EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public CalloutMediatorSoapAction3EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = EsbParserProvider
					.getParser(
							...
							getParserElement(),
							EsbVisualIDRegistry
									.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.CalloutMediatorSoapAction3EditPart.VISUAL_ID));
		}
		return parser;
	}
