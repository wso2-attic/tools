 ...
 * @generated
 */
public class EventMediatorTopicTypeEditPart extends CompartmentEditPart implements
                                                                       ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public EventMediatorTopicTypeEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser =
			         EsbParserProvider.getParser(EsbElementTypes.EventMediator_3504,
			                                     getParserElement(),
			                                     EsbVisualIDRegistry.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.EventMediatorTopicTypeEditPart.VISUAL_ID));
		}
		return parser;
	}
