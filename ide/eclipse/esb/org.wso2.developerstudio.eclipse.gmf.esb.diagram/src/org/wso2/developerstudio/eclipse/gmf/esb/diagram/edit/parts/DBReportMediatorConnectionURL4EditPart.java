 ...
 * @generated
 */
public class DBReportMediatorConnectionURL4EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public DBReportMediatorConnectionURL4EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = EsbParserProvider
					.getParser(
							...
							getParserElement(),
							EsbVisualIDRegistry
									.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.DBReportMediatorConnectionURL4EditPart.VISUAL_ID));
		}
		return parser;
	}
