 ...
 * @generated
 */
public class MediatorFlowMediatorFlowCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<EsbNodeDescriptor> childDescriptors =
		                                           EsbDiagramUpdater.getMediatorFlowMediatorFlowCompartment_7015SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<EsbNodeDescriptor> childDescriptors =
		                                           EsbDiagramUpdater.getMediatorFlowMediatorFlowCompartment_7015SemanticChildren((View) getHost().getModel());
