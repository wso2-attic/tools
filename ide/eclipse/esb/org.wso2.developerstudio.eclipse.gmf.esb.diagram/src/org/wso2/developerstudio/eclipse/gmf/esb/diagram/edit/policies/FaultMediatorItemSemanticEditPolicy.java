...
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.commands.FaultMediatorInputConnectorCreateCommand;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.commands.FaultMediatorOutputConnectorCreateCommand;
 ...
 * @generated
 */
public class FaultMediatorItemSemanticEditPolicy extends EsbBaseItemSemanticEditPolicy {
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.FaultMediatorInputConnector_3067 == req.getElementType()) {
			return getGEFWrapper(new FaultMediatorInputConnectorCreateCommand(req));
		}
		if (EsbElementTypes.FaultMediatorOutputConnector_3068 == req.getElementType()) {
			return getGEFWrapper(new FaultMediatorOutputConnectorCreateCommand(req));
		}
