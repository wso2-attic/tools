...
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.commands.XSLTMediatorInputConnectorCreateCommand;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.commands.XSLTMediatorOutputConnectorCreateCommand;
 ...
 * @generated
 */
public class XSLTMediatorItemSemanticEditPolicy extends EsbBaseItemSemanticEditPolicy {
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.XSLTMediatorInputConnector_3039 == req.getElementType()) {
			return getGEFWrapper(new XSLTMediatorInputConnectorCreateCommand(req));
		}
		if (EsbElementTypes.XSLTMediatorOutputConnector_3040 == req.getElementType()) {
			return getGEFWrapper(new XSLTMediatorOutputConnectorCreateCommand(req));
		}
