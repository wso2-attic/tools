...
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.RMSequenceMediator3CanonicalEditPolicy;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.RMSequenceMediator3ItemSemanticEditPolicy;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.part.EsbVisualIDRegistry;

/**
 * @generated NOT
 */
public class RMSequenceMediator3EditPart extends AbstractMediator {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 3312;
	 ...
	 * @generated
	 */
	public RMSequenceMediator3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new RMSequenceMediator3ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE,
				new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new RMSequenceMediator3CanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof RMSequenceMediatorInputConnector3EditPart) {

			IFigure borderItemFigure = ((RMSequenceMediatorInputConnector3EditPart) childEditPart)
					.getFigure();
		...
		} else if (childEditPart instanceof RMSequenceMediatorOutputConnector3EditPart) {

			IFigure borderItemFigure = ((RMSequenceMediatorOutputConnector3EditPart) childEditPart)
					.getFigure();
			BorderItemLocator locator = new FixedBorderItemLocator(
