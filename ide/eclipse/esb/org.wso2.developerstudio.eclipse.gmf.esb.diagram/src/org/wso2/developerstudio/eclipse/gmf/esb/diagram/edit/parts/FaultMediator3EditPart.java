...
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.FaultMediator3CanonicalEditPolicy;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.FaultMediator3ItemSemanticEditPolicy;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.part.EsbVisualIDRegistry;

/**
 * @generated NOT
 */
public class FaultMediator3EditPart extends AbstractMediator {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 3272;
	 ...
	 * @generated
	 */
	public FaultMediator3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new FaultMediator3ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE,
				new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new FaultMediator3CanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof FaultMediatorFaultStringType3EditPart) {
			((FaultMediatorFaultStringType3EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureFaultMediatorPropertyValue());
			return true;
		}
		if (childEditPart instanceof FaultMediatorInputConnector3EditPart) {
			IFigure borderItemFigure = ((FaultMediatorInputConnector3EditPart) childEditPart)
					.getFigure();
		...
		if (childEditPart instanceof FaultMediatorOutputConnector3EditPart) {
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof FaultMediatorInputConnector3EditPart) {
			getBorderedFigure().getBorderItemContainer().remove(
					((FaultMediatorInputConnector3EditPart) childEditPart)
							.getFigure());
			return true;
		}
		if (childEditPart instanceof FaultMediatorOutputConnector3EditPart) {
			getBorderedFigure().getBorderItemContainer().remove(
					((FaultMediatorOutputConnector3EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
