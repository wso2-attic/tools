...
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.EndpointFlow2EditPart;
 ...
 * @generated
 */
public class ProxyServiceEndpointContainerCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return EsbPackage.eINSTANCE.getProxyServiceEndpointContainer_EndpointFlow();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<EsbNodeDescriptor> childDescriptors = EsbDiagramUpdater
				.getProxyServiceEndpointContainer_3392SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return EndpointFlow2EditPart.VISUAL_ID == EsbVisualIDRegistry.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<EsbNodeDescriptor> childDescriptors = EsbDiagramUpdater
				.getProxyServiceEndpointContainer_3392SemanticChildren((View) getHost().getModel());
