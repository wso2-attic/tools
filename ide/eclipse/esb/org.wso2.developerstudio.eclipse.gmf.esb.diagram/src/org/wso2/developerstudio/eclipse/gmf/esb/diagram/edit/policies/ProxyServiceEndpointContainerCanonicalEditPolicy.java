 ...
 * @generated
 */
public class ProxyServiceEndpointContainerCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return EsbPackage.eINSTANCE
				.getProxyServiceEndpointContainer_EndpointFlow();
	}
	...
	private boolean isMyDiagramElement(View view) {
		return EndpointFlow2EditPart.VISUAL_ID == EsbVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<EsbNodeDescriptor> childDescriptors = EsbDiagramUpdater
				.getProxyServiceEndpointContainer_3392SemanticChildren((View) getHost()
						.getModel());
