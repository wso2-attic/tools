 ...
 * @generated
 */
public class SwitchDefaultContainerCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	private boolean isMyDiagramElement(View view) {
		return MediatorFlow4EditPart.VISUAL_ID == EsbVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<EsbNodeDescriptor> childDescriptors = EsbDiagramUpdater
				.getSwitchDefaultContainer_3527SemanticChildren((View) getHost()
						.getModel());
