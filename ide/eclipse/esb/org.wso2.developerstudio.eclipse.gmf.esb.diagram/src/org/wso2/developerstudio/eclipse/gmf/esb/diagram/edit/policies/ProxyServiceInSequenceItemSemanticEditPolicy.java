...
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.commands.MediatorFlowCreateCommand;
 ...
 * @generated
 */
public class ProxyServiceInSequenceItemSemanticEditPolicy extends EsbBaseItemSemanticEditPolicy {
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.MediatorFlow_3490 == req.getElementType()) {
			return getGEFWrapper(new MediatorFlowCreateCommand(req));
		}
