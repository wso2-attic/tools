 ...
 * @generated
 */
public class PropertyMediatorPropertyName2EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public PropertyMediatorPropertyName2EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = EsbParserProvider
					.getParser(
							...
							getParserElement(),
							EsbVisualIDRegistry
									.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.PropertyMediatorPropertyName2EditPart.VISUAL_ID));
		}
		return parser;
	}
