 ...
 * @generated
 */
public class IterateMediatorIterateID2EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public IterateMediatorIterateID2EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = EsbParserProvider
					.getParser(
							...
							getParserElement(),
							EsbVisualIDRegistry
									.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.IterateMediatorIterateID2EditPart.VISUAL_ID));
		}
		return parser;
	}
