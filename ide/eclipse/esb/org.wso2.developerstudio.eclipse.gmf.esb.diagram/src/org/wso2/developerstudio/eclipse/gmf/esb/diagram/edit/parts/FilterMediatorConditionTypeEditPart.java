 ...
 * @generated
 */
public class FilterMediatorConditionTypeEditPart extends CompartmentEditPart implements
                                                                            ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public FilterMediatorConditionTypeEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser =
			         EsbParserProvider.getParser(EsbElementTypes.FilterMediator_3494,
			                                     getParserElement(),
			                                     EsbVisualIDRegistry.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.FilterMediatorConditionTypeEditPart.VISUAL_ID));
		}
		return parser;
	}
