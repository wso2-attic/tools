...
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.commands.SpringMediatorInputConnectorCreateCommand;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.commands.SpringMediatorOutputConnectorCreateCommand;
 ...
 * @generated
 */
public class SpringMediatorItemSemanticEditPolicy extends EsbBaseItemSemanticEditPolicy {
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.SpringMediatorInputConnector_3061 == req.getElementType()) {
			return getGEFWrapper(new SpringMediatorInputConnectorCreateCommand(req));
		}
		if (EsbElementTypes.SpringMediatorOutputConnector_3062 == req.getElementType()) {
			return getGEFWrapper(new SpringMediatorOutputConnectorCreateCommand(req));
		}
