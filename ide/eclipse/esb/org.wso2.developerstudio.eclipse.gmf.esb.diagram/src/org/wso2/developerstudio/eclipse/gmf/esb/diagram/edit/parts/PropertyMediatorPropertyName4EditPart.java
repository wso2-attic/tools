 ...
 * @generated
 */
public class PropertyMediatorPropertyName4EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public PropertyMediatorPropertyName4EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = EsbParserProvider
					.getParser(
							...
							getParserElement(),
							EsbVisualIDRegistry
									.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.PropertyMediatorPropertyName4EditPart.VISUAL_ID));
		}
		return parser;
	}
