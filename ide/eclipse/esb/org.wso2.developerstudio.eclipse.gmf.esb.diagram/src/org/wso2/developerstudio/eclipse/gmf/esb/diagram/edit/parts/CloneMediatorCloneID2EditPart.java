 ...
 * @generated
 */
public class CloneMediatorCloneID2EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public CloneMediatorCloneID2EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = EsbParserProvider
					.getParser(
							...
							getParserElement(),
							EsbVisualIDRegistry
									.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.CloneMediatorCloneID2EditPart.VISUAL_ID));
		}
		return parser;
	}
