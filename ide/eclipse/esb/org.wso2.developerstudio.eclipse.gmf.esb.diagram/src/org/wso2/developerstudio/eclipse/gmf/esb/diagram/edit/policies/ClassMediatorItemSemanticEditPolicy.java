...
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.commands.ClassMediatorInputConnectorCreateCommand;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.commands.ClassMediatorOutputConnectorCreateCommand;
 ...
 * @generated
 */
public class ClassMediatorItemSemanticEditPolicy extends EsbBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public ClassMediatorItemSemanticEditPolicy() {
		super(EsbElementTypes.ClassMediator_3506);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.ClassMediatorInputConnector_3058 == req.getElementType()) {
			return getGEFWrapper(new ClassMediatorInputConnectorCreateCommand(req));
		}
		if (EsbElementTypes.ClassMediatorOutputConnector_3059 == req.getElementType()) {
			return getGEFWrapper(new ClassMediatorOutputConnectorCreateCommand(req));
		}
