...
public class EsbServerEditPart extends AbstractBorderedShapeEditPart {
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof ProxyServiceEditPart) {
			borderItemContainer
					.add(borderItemEditPart.getFigure(), new SlidingBorderItemLocator(
							getMainFigure(), borderItemEditPart.getFigure(),
	...
	public void optimizeBounds() {
		...
		SetBoundsCommand sbc = new SetBoundsCommand(this.getEditingDomain(), "change size",
				new EObjectAdapter((View) this.getModel()), bounds);
		getEditDomain().getCommandStack().execute(new ICommandProxy(sbc));
	}
	...
	public class EsbServerFigure extends RoundedRectangle {
		...
		public EsbServerFigure() {
			...
			// TODO: review this:
			this.setPreferredSize(new Dimension(getMapMode().DPtoLP(1000), getMapMode().DPtoLP(600)));
