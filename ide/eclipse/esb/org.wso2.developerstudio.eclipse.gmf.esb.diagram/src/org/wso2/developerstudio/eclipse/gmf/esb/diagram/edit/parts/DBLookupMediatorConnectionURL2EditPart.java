 ...
 * @generated
 */
public class DBLookupMediatorConnectionURL2EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public DBLookupMediatorConnectionURL2EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = EsbParserProvider
					.getParser(
							...
							getParserElement(),
							EsbVisualIDRegistry
									.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.DBLookupMediatorConnectionURL2EditPart.VISUAL_ID));
		}
		return parser;
	}
