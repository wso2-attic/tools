 ...
 * @generated
 */
public class HeaderMediatorValueLiteral4EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public HeaderMediatorValueLiteral4EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = EsbParserProvider
					.getParser(
							...
							getParserElement(),
							EsbVisualIDRegistry
									.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.HeaderMediatorValueLiteral4EditPart.VISUAL_ID));
		}
		return parser;
	}
