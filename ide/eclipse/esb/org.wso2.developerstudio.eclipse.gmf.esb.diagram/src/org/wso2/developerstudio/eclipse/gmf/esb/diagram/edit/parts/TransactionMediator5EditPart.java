...
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.TransactionMediator5CanonicalEditPolicy;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.TransactionMediator5ItemSemanticEditPolicy;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.part.EsbVisualIDRegistry;

/**
 * @generated NOT
 */
public class TransactionMediator5EditPart extends AbstractMediator {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 3474;
	 ...
	 * @generated
	 */
	public TransactionMediator5EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new TransactionMediator5ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE,
				new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new TransactionMediator5CanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof TransactionMediatorInputConnector5EditPart) {

			IFigure borderItemFigure = ((TransactionMediatorInputConnector5EditPart) childEditPart)
					.getFigure();
		...
		} else if (childEditPart instanceof TransactionMediatorOutputConnector5EditPart) {

			IFigure borderItemFigure = ((TransactionMediatorOutputConnector5EditPart) childEditPart)
					.getFigure();
			BorderItemLocator locator = new FixedBorderItemLocator(
	...
	public class TransactionMediatorFigure extends EsbGraphicalShape {
		 ...
		 * @generated
		 */
		public TransactionMediatorFigure() {
