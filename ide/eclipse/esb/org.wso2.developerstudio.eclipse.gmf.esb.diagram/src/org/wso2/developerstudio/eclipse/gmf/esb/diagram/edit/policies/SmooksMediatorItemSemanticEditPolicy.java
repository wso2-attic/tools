...
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.commands.SmooksMediatorInputConnectorCreateCommand;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.commands.SmooksMediatorOutputConnectorCreateCommand;
 ...
 * @generated
 */
public class SmooksMediatorItemSemanticEditPolicy extends EsbBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public SmooksMediatorItemSemanticEditPolicy() {
		super(EsbElementTypes.SmooksMediator_3514);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.SmooksMediatorInputConnector_3082 == req.getElementType()) {
			return getGEFWrapper(new SmooksMediatorInputConnectorCreateCommand(req));
		}
		if (EsbElementTypes.SmooksMediatorOutputConnector_3083 == req.getElementType()) {
			return getGEFWrapper(new SmooksMediatorOutputConnectorCreateCommand(req));
		}
