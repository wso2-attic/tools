 ...
 * @generated
 */
public class DBLookupMediatorConnectionURL4EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public DBLookupMediatorConnectionURL4EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = EsbParserProvider
					.getParser(
							...
							getParserElement(),
							EsbVisualIDRegistry
									.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.DBLookupMediatorConnectionURL4EditPart.VISUAL_ID));
		}
		return parser;
	}
