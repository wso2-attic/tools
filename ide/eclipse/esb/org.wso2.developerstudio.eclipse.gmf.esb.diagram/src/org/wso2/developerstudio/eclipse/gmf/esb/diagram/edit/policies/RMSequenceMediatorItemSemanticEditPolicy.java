...
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.commands.RMSequenceMediatorInputConnectorCreateCommand;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.commands.RMSequenceMediatorOutputConnectorCreateCommand;
 ...
 * @generated
 */
public class RMSequenceMediatorItemSemanticEditPolicy extends EsbBaseItemSemanticEditPolicy {
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.RMSequenceMediatorInputConnector_3124 == req.getElementType()) {
			return getGEFWrapper(new RMSequenceMediatorInputConnectorCreateCommand(req));
		}
		if (EsbElementTypes.RMSequenceMediatorOutputConnector_3125 == req.getElementType()) {
			return getGEFWrapper(new RMSequenceMediatorOutputConnectorCreateCommand(req));
		}
