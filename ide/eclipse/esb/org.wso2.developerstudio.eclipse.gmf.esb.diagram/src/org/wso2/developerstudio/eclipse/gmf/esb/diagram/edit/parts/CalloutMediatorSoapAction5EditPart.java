 ...
 * @generated
 */
public class CalloutMediatorSoapAction5EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public CalloutMediatorSoapAction5EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = EsbParserProvider
					.getParser(
							...
							getParserElement(),
							EsbVisualIDRegistry
									.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.CalloutMediatorSoapAction5EditPart.VISUAL_ID));
		}
		return parser;
	}
