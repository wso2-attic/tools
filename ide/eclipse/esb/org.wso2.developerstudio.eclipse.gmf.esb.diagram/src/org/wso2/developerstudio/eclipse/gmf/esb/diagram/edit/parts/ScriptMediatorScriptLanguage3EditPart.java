 ...
 * @generated
 */
public class ScriptMediatorScriptLanguage3EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public ScriptMediatorScriptLanguage3EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = EsbParserProvider
					.getParser(
							...
							getParserElement(),
							EsbVisualIDRegistry
									.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.ScriptMediatorScriptLanguage3EditPart.VISUAL_ID));
		}
		return parser;
	}
