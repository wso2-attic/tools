 ...
 * @generated
 */
public class CloneMediatorCloneID4EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public CloneMediatorCloneID4EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = EsbParserProvider
					.getParser(
							...
							getParserElement(),
							EsbVisualIDRegistry
									.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.CloneMediatorCloneID4EditPart.VISUAL_ID));
		}
		return parser;
	}
