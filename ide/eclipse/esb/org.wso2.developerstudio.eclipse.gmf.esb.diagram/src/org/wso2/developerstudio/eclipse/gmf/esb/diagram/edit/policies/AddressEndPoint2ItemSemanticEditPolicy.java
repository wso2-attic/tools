...
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.commands.AddressEndPointInputConnectorCreateCommand;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.commands.AddressEndPointOutputConnectorCreateCommand;
 ...
 * @generated
 */
public class AddressEndPoint2ItemSemanticEditPolicy extends EsbBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public AddressEndPoint2ItemSemanticEditPolicy() {
		super(EsbElementTypes.AddressEndPoint_3383);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.AddressEndPointInputConnector_3030 == req.getElementType()) {
			return getGEFWrapper(new AddressEndPointInputConnectorCreateCommand(req));
		}
		if (EsbElementTypes.AddressEndPointOutputConnector_3031 == req.getElementType()) {
			return getGEFWrapper(new AddressEndPointOutputConnectorCreateCommand(req));
		}
