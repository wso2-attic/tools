...
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.MergeNodeOutputConnectorItemSemanticEditPolicy;
...
public class MergeNodeOutputConnectorEditPart extends AbstractBorderItemEditPart {
	 ...
	 * @generated
	 */
	public MergeNodeOutputConnectorEditPart(View view) {
		super(view);
	}
