 ...
 * @generated
 */
public class EnrichMediatorSourceType4EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public EnrichMediatorSourceType4EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = EsbParserProvider
					.getParser(
							...
							getParserElement(),
							EsbVisualIDRegistry
									.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.EnrichMediatorSourceType4EditPart.VISUAL_ID));
		}
		return parser;
	}
