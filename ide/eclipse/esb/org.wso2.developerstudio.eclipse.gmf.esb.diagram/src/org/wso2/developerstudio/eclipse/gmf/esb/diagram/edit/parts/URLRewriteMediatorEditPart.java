...
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.URLRewriteMediatorCanonicalEditPolicy;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.URLRewriteMediatorItemSemanticEditPolicy;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.part.EsbVisualIDRegistry;

/**
 * @generated NOT
 */
public class URLRewriteMediatorEditPart extends FixedSizedAbstractMediator {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 3620;
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new URLRewriteMediatorItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE,
				new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new URLRewriteMediatorCanonicalEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new URLRewriteMediatorFigure() {
	 ...
	 * @generated
	 */
	public URLRewriteMediatorFigure getPrimaryShape() {
		return (URLRewriteMediatorFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		} else if (childEditPart instanceof URLRewriteMediatorOutputConnectorEditPart) {

			IFigure borderItemFigure = ((URLRewriteMediatorOutputConnectorEditPart) childEditPart)
					.getFigure();
			BorderItemLocator locator = new FixedBorderItemLocator(
	...
	public class URLRewriteMediatorFigure extends EsbGraphicalShape {
		 ...
		 * @generated
		 */
		public URLRewriteMediatorFigure() {
		...
		private void createContents() {
			...
			this.getPropertyValueRectangle1().add(
					fFigureURLRewriteMediatorPropertyValue);
		}
