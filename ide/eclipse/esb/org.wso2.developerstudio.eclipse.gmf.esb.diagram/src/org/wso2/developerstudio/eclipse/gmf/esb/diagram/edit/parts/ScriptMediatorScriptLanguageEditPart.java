 ...
 * @generated
 */
public class ScriptMediatorScriptLanguageEditPart extends CompartmentEditPart implements
                                                                             ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ScriptMediatorScriptLanguageEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser =
			         EsbParserProvider.getParser(EsbElementTypes.ScriptMediator_3508,
			                                     getParserElement(),
			                                     EsbVisualIDRegistry.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.ScriptMediatorScriptLanguageEditPart.VISUAL_ID));
		}
		return parser;
	}
