 ...
 * @generated
 */
public class OAuthMediatorRemoteServiceUrl2EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public OAuthMediatorRemoteServiceUrl2EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = EsbParserProvider
					.getParser(
							...
							getParserElement(),
							EsbVisualIDRegistry
									.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.OAuthMediatorRemoteServiceUrl2EditPart.VISUAL_ID));
		}
		return parser;
	}
