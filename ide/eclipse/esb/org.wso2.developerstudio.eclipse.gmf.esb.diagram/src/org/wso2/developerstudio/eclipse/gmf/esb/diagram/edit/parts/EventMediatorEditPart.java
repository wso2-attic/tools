 ...
 * @generated NOT
 */
public class EventMediatorEditPart extends AbstractMediator {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new EventMediatorItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new EventMediatorCanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof EventMediatorTopicTypeEditPart) {
			((EventMediatorTopicTypeEditPart) childEditPart).setLabel(getPrimaryShape().getFigureEventMediatorPropertyValue());
			return true;
		}
		if (childEditPart instanceof EventMediatorInputConnectorEditPart) {
			IFigure borderItemFigure =
			                           ((EventMediatorInputConnectorEditPart) childEditPart).getFigure();
		...
		if (childEditPart instanceof EventMediatorOutputConnectorEditPart) {
			IFigure borderItemFigure =
			                           ((EventMediatorOutputConnectorEditPart) childEditPart).getFigure();
			BorderItemLocator locator =
			                            new FixedBorderItemLocator(getMainFigure(),
			                                                       borderItemFigure,
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof EventMediatorInputConnectorEditPart) {
			getBorderedFigure().getBorderItemContainer()
			                   .remove(((EventMediatorInputConnectorEditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof EventMediatorOutputConnectorEditPart) {
			getBorderedFigure().getBorderItemContainer()
			                   .remove(((EventMediatorOutputConnectorEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(EsbVisualIDRegistry.getType(EventMediatorTopicTypeEditPart.VISUAL_ID));
	}
