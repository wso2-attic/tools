 ...
 * @generated
 */
public class SpringMediatorBeanName3EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public SpringMediatorBeanName3EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = EsbParserProvider
					.getParser(
							...
							getParserElement(),
							EsbVisualIDRegistry
									.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.SpringMediatorBeanName3EditPart.VISUAL_ID));
		}
		return parser;
	}
