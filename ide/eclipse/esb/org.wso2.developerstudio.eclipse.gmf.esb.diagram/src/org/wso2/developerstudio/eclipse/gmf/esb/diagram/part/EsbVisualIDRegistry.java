...
public class EsbVisualIDRegistry {
	...
	private static final String DEBUG_KEY =
	                                        "org.wso2.developerstudio.eclipse.gmf.esb.diagram/debug/visualID"; //$NON-NLS-1$
	...
	public static int getNodeVisualID(View containerView, EObject domainElement) {
		...
		String containerModelID =
		                          org.wso2.developerstudio.eclipse.gmf.esb.diagram.part.EsbVisualIDRegistry.getModelID(containerView);
		...
		if (EsbDiagramEditPart.MODEL_ID.equals(containerModelID)) {
			containerVisualID =
			                    org.wso2.developerstudio.eclipse.gmf.esb.diagram.part.EsbVisualIDRegistry.getVisualID(containerView);
		} else {
		...
		switch (containerVisualID) {
			...
			case ProxyServiceEditPart.VISUAL_ID:
				...
				if (EsbPackage.eINSTANCE.getProxyInputConnector()
				                        .isSuperTypeOf(domainElement.eClass())) {
				...
				if (EsbPackage.eINSTANCE.getProxyServiceContainer()
				                        .isSuperTypeOf(domainElement.eClass())) {
			...
			case ProxyServiceSequenceContainerEditPart.VISUAL_ID:
				if (EsbPackage.eINSTANCE.getProxyServiceInSequence()
				                        .isSuperTypeOf(domainElement.eClass())) {
			...
			case SwitchMediatorContainerEditPart.VISUAL_ID:
				if (EsbPackage.eINSTANCE.getSwitchCaseContainer()
				                        .isSuperTypeOf(domainElement.eClass())) {
					return SwitchCaseContainerEditPart.VISUAL_ID;
				}
				if (EsbPackage.eINSTANCE.getSwitchDefaultContainer()
				                        .isSuperTypeOf(domainElement.eClass())) {
			...
			case SequenceEditPart.VISUAL_ID:
				if (EsbPackage.eINSTANCE.getSequenceInputConnector()
				                        .isSuperTypeOf(domainElement.eClass())) {
			...
			case AggregateMediatorEditPart.VISUAL_ID:
				...
				if (EsbPackage.eINSTANCE.getAggregateMediatorOnCompleteOutputConnector()
				                        .isSuperTypeOf(domainElement.eClass())) {
			...
			case LoadBalanceEndPoint2EditPart.VISUAL_ID:
				...
				if (EsbPackage.eINSTANCE.getLoadBalanceEndPointWestOutputConnector()
				                        .isSuperTypeOf(domainElement.eClass())) {
			...
			case MessageMediatorEditPart.VISUAL_ID:
				if (EsbPackage.eINSTANCE.getMessageInputConnector()
				                        .isSuperTypeOf(domainElement.eClass())) {
					return MessageInputConnectorEditPart.VISUAL_ID;
				}
				if (EsbPackage.eINSTANCE.getMessageOutputConnector()
				                        .isSuperTypeOf(domainElement.eClass())) {
			...
			case MediatorFlowMediatorFlowCompartmentEditPart.VISUAL_ID:
				...
				if (EsbPackage.eINSTANCE.getPropertyMediator()
				                        .isSuperTypeOf(domainElement.eClass())) {
					return PropertyMediatorEditPart.VISUAL_ID;
				}
				if (EsbPackage.eINSTANCE.getThrottleMediator()
				                        .isSuperTypeOf(domainElement.eClass())) {
				...
				if (EsbPackage.eINSTANCE.getEntitlementMediator()
				                        .isSuperTypeOf(domainElement.eClass())) {
				...
				if (EsbPackage.eINSTANCE.getDBLookupMediator()
				                        .isSuperTypeOf(domainElement.eClass())) {
					return DBLookupMediatorEditPart.VISUAL_ID;
				}
				if (EsbPackage.eINSTANCE.getDBReportMediator()
				                        .isSuperTypeOf(domainElement.eClass())) {
				...
				if (EsbPackage.eINSTANCE.getTransactionMediator()
				                        .isSuperTypeOf(domainElement.eClass())) {
					return TransactionMediatorEditPart.VISUAL_ID;
				}
				if (EsbPackage.eINSTANCE.getRMSequenceMediator()
				                        .isSuperTypeOf(domainElement.eClass())) {
				...
				if (EsbPackage.eINSTANCE.getAggregateMediator()
				                        .isSuperTypeOf(domainElement.eClass())) {
			...
			case ProxyServiceEndpointContainerEndpointCompartmentEditPart.VISUAL_ID:
				...
				if (EsbPackage.eINSTANCE.getFailoverEndPoint()
				                        .isSuperTypeOf(domainElement.eClass())) {
				...
				if (EsbPackage.eINSTANCE.getLoadBalanceEndPoint()
				                        .isSuperTypeOf(domainElement.eClass())) {
