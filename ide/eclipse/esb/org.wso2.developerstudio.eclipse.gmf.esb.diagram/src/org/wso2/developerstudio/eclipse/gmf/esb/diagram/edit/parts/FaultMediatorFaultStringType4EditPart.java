 ...
 * @generated
 */
public class FaultMediatorFaultStringType4EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public FaultMediatorFaultStringType4EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = EsbParserProvider
					.getParser(
							...
							getParserElement(),
							EsbVisualIDRegistry
									.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.FaultMediatorFaultStringType4EditPart.VISUAL_ID));
		}
		return parser;
	}
