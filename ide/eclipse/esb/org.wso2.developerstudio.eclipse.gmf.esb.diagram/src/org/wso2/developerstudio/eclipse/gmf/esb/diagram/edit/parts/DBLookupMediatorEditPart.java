 ...
 * @generated NOT
 */
public class DBLookupMediatorEditPart extends AbstractMediator {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DBLookupMediatorConnectionURLEditPart) {
			((DBLookupMediatorConnectionURLEditPart) childEditPart).setLabel(getPrimaryShape().getFigureDBLookupMediatorPropertyValue());
			return true;
		}
		if (childEditPart instanceof DBLookupMediatorInputConnectorEditPart) {

			IFigure borderItemFigure =
			                           ((DBLookupMediatorInputConnectorEditPart) childEditPart).getFigure();
		...
		if (childEditPart instanceof DBLookupMediatorOutputConnectorEditPart) {
			IFigure borderItemFigure =
			                           ((DBLookupMediatorOutputConnectorEditPart) childEditPart).getFigure();
			BorderItemLocator locator =
			                            new FixedBorderItemLocator(getMainFigure(),
			                                                       borderItemFigure,
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(EsbVisualIDRegistry.getType(DBLookupMediatorConnectionURLEditPart.VISUAL_ID));
	}
