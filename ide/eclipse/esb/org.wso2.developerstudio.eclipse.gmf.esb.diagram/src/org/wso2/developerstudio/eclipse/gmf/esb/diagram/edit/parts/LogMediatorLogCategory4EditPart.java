 ...
 * @generated
 */
public class LogMediatorLogCategory4EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public LogMediatorLogCategory4EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = EsbParserProvider
					.getParser(
							...
							getParserElement(),
							EsbVisualIDRegistry
									.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.LogMediatorLogCategory4EditPart.VISUAL_ID));
		}
		return parser;
	}
