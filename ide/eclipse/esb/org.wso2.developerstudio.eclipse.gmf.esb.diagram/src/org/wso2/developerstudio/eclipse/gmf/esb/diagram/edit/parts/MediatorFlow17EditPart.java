...
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.MediatorFlow17CanonicalEditPolicy;
...
public class MediatorFlow17EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new MediatorFlow17ItemSemanticEditPolicy());
	...
	public void refreshOutputConnector(EditPart childEditPart) {
		if (childEditPart instanceof RuleMediatorEditPart) {
			...
			BorderItemLocator locator = new FixedBorderItemLocator(this.getFigure(),
					ruleMediatorEditPart.childMediatorsOutputConnector, PositionConstants.WEST, 0.5);
			ruleMediatorEditPart.getBorderedFigure().getBorderItemContainer()
					.add(ruleMediatorEditPart.childMediatorsOutputConnector, locator);
		} else {
	...
	protected void addChildVisual(EditPart childEditPart, int index) {
		refreshOutputConnector(((RuleMediatorEditPart) childEditPart.getParent().getParent()));
