...
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.RMSequenceMediator2CanonicalEditPolicy;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.RMSequenceMediator2ItemSemanticEditPolicy;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.part.EsbVisualIDRegistry;

/**
 * @generated NOT
 */
public class RMSequenceMediator2EditPart extends AbstractMediator {
	 ...
	 * @generated
	 */
	public RMSequenceMediator2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new RMSequenceMediator2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE,
				new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new RMSequenceMediator2CanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof RMSequenceMediatorInputConnector2EditPart) {

			IFigure borderItemFigure = ((RMSequenceMediatorInputConnector2EditPart) childEditPart)
					.getFigure();
		...
		} else if (childEditPart instanceof RMSequenceMediatorOutputConnector2EditPart) {

			IFigure borderItemFigure = ((RMSequenceMediatorOutputConnector2EditPart) childEditPart)
					.getFigure();
			BorderItemLocator locator = new FixedBorderItemLocator(
