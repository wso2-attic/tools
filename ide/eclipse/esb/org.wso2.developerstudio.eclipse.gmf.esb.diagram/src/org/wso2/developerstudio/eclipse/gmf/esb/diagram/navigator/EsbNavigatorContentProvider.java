...
public class EsbNavigatorContentProvider implements ICommonContentProvider {
	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case MediatorFlow12EditPart.VISUAL_ID: {
			LinkedList<EsbAbstractNavigatorItem> result = mediatorFlow12(view, parentElement);
			return result.toArray();
		}
		...
		case MediatorFlow15EditPart.VISUAL_ID: {
			LinkedList<EsbAbstractNavigatorItem> result = mediatorFlow15(view, parentElement);
			return result.toArray();
		}
	 ...
	 * @return
	 */
	public LinkedList<EsbAbstractNavigatorItem> mediatorFlow12(View view, Object parentElement) {
		LinkedList<EsbAbstractNavigatorItem> result = new LinkedList<EsbAbstractNavigatorItem>();
		Node sv = (Node) view;
		Collection<View> connectedViews;
		connectedViews = getChildrenByType(Collections.singleton(sv),
	 ...
	 * @return
	 */
	public LinkedList<EsbAbstractNavigatorItem> mediatorFlow15(View view, Object parentElement) {
		LinkedList<EsbAbstractNavigatorItem> result = new LinkedList<EsbAbstractNavigatorItem>();
		Node sv = (Node) view;
		Collection<View> connectedViews;
		connectedViews = getChildrenByType(Collections.singleton(sv),
