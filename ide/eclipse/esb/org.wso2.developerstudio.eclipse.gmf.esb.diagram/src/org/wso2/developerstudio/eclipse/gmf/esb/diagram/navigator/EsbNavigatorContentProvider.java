...
public class EsbNavigatorContentProvider implements ICommonContentProvider {
	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case MediatorFlow13EditPart.VISUAL_ID: {
			return mediatorFlow13Case(view, parentElement);
		}
		...
		case MediatorFlow11EditPart.VISUAL_ID: {
			return mediatorFlow11Case(view, parentElement);
		}
		...
		case MediatorFlow3EditPart.VISUAL_ID: {
			return mediatorFlow3Case(view, parentElement);
		}
	...
	private Object[] mediatorFlow13Case(View view, Object parentElement) {
		LinkedList<EsbAbstractNavigatorItem> result = new LinkedList<EsbAbstractNavigatorItem>();
		Node sv = (Node) view;
		Collection<View> connectedViews;
		connectedViews = getChildrenByType(Collections.singleton(sv),
	...
	private Object[] mediatorFlow11Case(View view, Object parentElement) {
		LinkedList<EsbAbstractNavigatorItem> result = new LinkedList<EsbAbstractNavigatorItem>();
		Node sv = (Node) view;
		Collection<View> connectedViews;
		connectedViews = getChildrenByType(Collections.singleton(sv),
	...
	private Object[] mediatorFlow3Case(View view, Object parentElement) {
		LinkedList<EsbAbstractNavigatorItem> result = new LinkedList<EsbAbstractNavigatorItem>();
		Node sv = (Node) view;
		Collection<View> connectedViews;
		connectedViews = getChildrenByType(Collections.singleton(sv),
