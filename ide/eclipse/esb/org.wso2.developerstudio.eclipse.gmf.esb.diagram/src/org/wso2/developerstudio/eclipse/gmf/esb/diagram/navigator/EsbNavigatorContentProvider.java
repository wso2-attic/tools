...
public class EsbNavigatorContentProvider implements ICommonContentProvider {
	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case MediatorFlow6EditPart.VISUAL_ID: {
			return mediatorFlow6(view, parentElement);
		}
		...
		case MediatorFlow15EditPart.VISUAL_ID: {
			return mediatorFlow15(view, parentElement);
		}
	...
	private Object[] mediatorFlow15(View view, Object parentElement) {
		LinkedList<EsbAbstractNavigatorItem> result = new LinkedList<EsbAbstractNavigatorItem>();
		Node sv = (Node) view;
		Collection<View> connectedViews;
		connectedViews = getChildrenByType(Collections.singleton(sv),
	...
	private Object[] mediatorFlow6(View view, Object parentElement) {
		LinkedList<EsbAbstractNavigatorItem> result = new LinkedList<EsbAbstractNavigatorItem>();
		Node sv = (Node) view;
		Collection<View> connectedViews;
		connectedViews = getChildrenByType(Collections.singleton(sv),
	...
	private Object[] mediatorFlow7(View view, Object parentElement) {
		LinkedList<EsbAbstractNavigatorItem> result = new LinkedList<EsbAbstractNavigatorItem>();
		Node sv = (Node) view;
		Collection<View> connectedViews;
		connectedViews = getChildrenByType(Collections.singleton(sv),
	...
	private Object[] mediatorFlow13(View view, Object parentElement) {
		LinkedList<EsbAbstractNavigatorItem> result = new LinkedList<EsbAbstractNavigatorItem>();
		Node sv = (Node) view;
		Collection<View> connectedViews;
		connectedViews = getChildrenByType(Collections.singleton(sv),
