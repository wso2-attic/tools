...
public class RuleMediatorEditPart extends AbstractMediator {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof RuleMediatorInputConnectorEditPart) {
			...
			IFigure borderItemFigure =
			                           ((RuleMediatorInputConnectorEditPart) childEditPart).getFigure();
			...
			IFigure borderItemFigure =
			                           ((RuleMediatorOutputConnectorEditPart) childEditPart).getFigure();
			BorderItemLocator locator =
			                            new FixedBorderItemLocator(getMainFigure(),
			                                                       borderItemFigure,
	...
	public class RuleMediatorFigure extends EsbGraphicalShape {
		...
		private void createContents() {
			...
			this.getPropertyValueRectangle1().add(fFigureRuleMediatorPropertyValue);
