 ...
 * @generated
 */
public class MediatorFlowMediatorFlowCompartment3CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<EsbNodeDescriptor> childDescriptors =
		                                           EsbDiagramUpdater.getMediatorFlowMediatorFlowCompartment_7016SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<EsbNodeDescriptor> childDescriptors =
		                                           EsbDiagramUpdater.getMediatorFlowMediatorFlowCompartment_7016SemanticChildren((View) getHost().getModel());
