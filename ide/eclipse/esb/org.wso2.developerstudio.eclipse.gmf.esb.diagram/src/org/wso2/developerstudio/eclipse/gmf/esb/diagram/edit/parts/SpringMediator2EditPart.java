...
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.SpringMediator2CanonicalEditPolicy;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.SpringMediator2ItemSemanticEditPolicy;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.part.EsbVisualIDRegistry;

/**
 * @generated NOT
 */
public class SpringMediator2EditPart extends AbstractMediator {
	 ...
	 * @generated
	 */
	public SpringMediator2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new SpringMediator2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE,
				new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new SpringMediator2CanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof SpringMediatorBeanName2EditPart) {
			((SpringMediatorBeanName2EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureSpringMediatorPropertyValue());
			return true;
		}
		if (childEditPart instanceof SpringMediatorInputConnector2EditPart) {
			IFigure borderItemFigure = ((SpringMediatorInputConnector2EditPart) childEditPart)
					.getFigure();
		...
		if (childEditPart instanceof SpringMediatorOutputConnector2EditPart) {
			IFigure borderItemFigure = ((SpringMediatorOutputConnector2EditPart) childEditPart)
					.getFigure();
			BorderItemLocator locator = new FixedBorderItemLocator(
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof SpringMediatorInputConnector2EditPart) {
			getBorderedFigure().getBorderItemContainer().remove(
					((SpringMediatorInputConnector2EditPart) childEditPart)
							.getFigure());
			return true;
		}
		if (childEditPart instanceof SpringMediatorOutputConnector2EditPart) {
			getBorderedFigure().getBorderItemContainer().remove(
					((SpringMediatorOutputConnector2EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
