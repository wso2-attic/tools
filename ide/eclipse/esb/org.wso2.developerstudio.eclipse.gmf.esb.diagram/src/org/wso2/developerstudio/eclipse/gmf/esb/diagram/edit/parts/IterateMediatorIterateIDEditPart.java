 ...
 * @generated
 */
public class IterateMediatorIterateIDEditPart extends CompartmentEditPart implements
                                                                         ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public IterateMediatorIterateIDEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser =
			         EsbParserProvider.getParser(EsbElementTypes.IterateMediator_3519,
			                                     getParserElement(),
			                                     EsbVisualIDRegistry.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.IterateMediatorIterateIDEditPart.VISUAL_ID));
		}
		return parser;
	}
