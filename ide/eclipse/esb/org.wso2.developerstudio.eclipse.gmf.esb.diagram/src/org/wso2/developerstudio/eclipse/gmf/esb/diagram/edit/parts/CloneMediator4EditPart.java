...
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.CloneMediator4CanonicalEditPolicy;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.CloneMediator4ItemSemanticEditPolicy;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.part.EsbVisualIDRegistry;

/**
 * @generated NOT
 */
public class CloneMediator4EditPart extends AbstractMediator {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 3359;
	 ...
	 * @generated
	 */
	public CloneMediator4EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new CloneMediator4ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE,
				new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new CloneMediator4CanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof CloneMediatorCloneID4EditPart) {
			((CloneMediatorCloneID4EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureCloneMediatorPropertyValue());
			return true;
		}
		if (childEditPart instanceof CloneMediatorInputConnector4EditPart) {
			IFigure borderItemFigure = ((CloneMediatorInputConnector4EditPart) childEditPart)
					.getFigure();
		...
		if (childEditPart instanceof CloneMediatorTargetOutputConnector4EditPart) {

			IFigure borderItemFigure = ((CloneMediatorTargetOutputConnector4EditPart) childEditPart)
					.getFigure();
		...
		if (childEditPart instanceof CloneMediatorOutputConnector4EditPart) {
			IFigure borderItemFigure = ((CloneMediatorOutputConnector4EditPart) childEditPart)
					.getFigure();
			BorderItemLocator locator = new FixedBorderItemLocator(
					getMainFigure(), borderItemFigure, PositionConstants.EAST,
					0.5);
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof CloneMediatorInputConnector4EditPart) {
			getBorderedFigure().getBorderItemContainer().remove(
					((CloneMediatorInputConnector4EditPart) childEditPart)
							.getFigure());
			return true;
		}
		if (childEditPart instanceof CloneMediatorOutputConnector4EditPart) {
			getBorderedFigure().getBorderItemContainer().remove(
					((CloneMediatorOutputConnector4EditPart) childEditPart)
							.getFigure());
			return true;
		}
		if (childEditPart instanceof CloneMediatorTargetOutputConnector4EditPart) {
			getBorderedFigure()
					...
					.remove(((CloneMediatorTargetOutputConnector4EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
