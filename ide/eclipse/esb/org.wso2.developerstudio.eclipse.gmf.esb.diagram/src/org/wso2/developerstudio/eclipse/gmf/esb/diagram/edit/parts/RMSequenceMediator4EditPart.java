...
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.RMSequenceMediator4CanonicalEditPolicy;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.RMSequenceMediator4ItemSemanticEditPolicy;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.part.EsbVisualIDRegistry;

/**
 * @generated NOT
 */
public class RMSequenceMediator4EditPart extends AbstractMediator {
	 ...
	 * @generated
	 */
	public RMSequenceMediator4EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new RMSequenceMediator4ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE,
				new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new RMSequenceMediator4CanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof RMSequenceMediatorInputConnector4EditPart) {

			IFigure borderItemFigure = ((RMSequenceMediatorInputConnector4EditPart) childEditPart)
					.getFigure();
		...
		} else if (childEditPart instanceof RMSequenceMediatorOutputConnector4EditPart) {

			IFigure borderItemFigure = ((RMSequenceMediatorOutputConnector4EditPart) childEditPart)
					.getFigure();
			BorderItemLocator locator = new FixedBorderItemLocator(
