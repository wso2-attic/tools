...
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.commands.CommandMediatorInputConnectorCreateCommand;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.commands.CommandMediatorOutputConnectorCreateCommand;
 ...
 * @generated
 */
public class CommandMediatorItemSemanticEditPolicy extends EsbBaseItemSemanticEditPolicy {
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.CommandMediatorInputConnector_3073 == req.getElementType()) {
			return getGEFWrapper(new CommandMediatorInputConnectorCreateCommand(req));
		}
		if (EsbElementTypes.CommandMediatorOutputConnector_3074 == req.getElementType()) {
			return getGEFWrapper(new CommandMediatorOutputConnectorCreateCommand(req));
		}
