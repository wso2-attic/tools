...
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.CloneMediator2CanonicalEditPolicy;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.CloneMediator2ItemSemanticEditPolicy;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.part.EsbVisualIDRegistry;

/**
 * @generated NOT
 */
public class CloneMediator2EditPart extends AbstractMediator {
	 ...
	 * @generated
	 */
	public CloneMediator2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new CloneMediator2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof CloneMediatorInputConnector2EditPart) {
			IFigure borderItemFigure = ((CloneMediatorInputConnector2EditPart) childEditPart)
					.getFigure();
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof CloneMediatorInputConnector2EditPart) {
			getBorderedFigure().getBorderItemContainer().remove(
					((CloneMediatorInputConnector2EditPart) childEditPart)
							.getFigure());
			return true;
		}
		if (childEditPart instanceof CloneMediatorOutputConnector2EditPart) {
			getBorderedFigure().getBorderItemContainer().remove(
					((CloneMediatorOutputConnector2EditPart) childEditPart)
							.getFigure());
			return true;
		}
		if (childEditPart instanceof CloneMediatorTargetOutputConnector2EditPart) {
			getBorderedFigure()
					...
					.remove(((CloneMediatorTargetOutputConnector2EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
