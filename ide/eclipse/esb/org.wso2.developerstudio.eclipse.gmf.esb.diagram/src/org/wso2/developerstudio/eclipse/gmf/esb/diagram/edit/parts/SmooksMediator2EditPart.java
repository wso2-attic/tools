...
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.SmooksMediator2CanonicalEditPolicy;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.SmooksMediator2ItemSemanticEditPolicy;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.part.EsbVisualIDRegistry;

/**
 * @generated NOT
 */
public class SmooksMediator2EditPart extends AbstractMediator {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 3287;
	 ...
	 * @generated
	 */
	public SmooksMediator2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new SmooksMediator2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE,
				new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new SmooksMediator2CanonicalEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new SmooksMediatorFigure();
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof SmooksMediatorInputConnector2EditPart) {

			IFigure borderItemFigure = ((SmooksMediatorInputConnector2EditPart) childEditPart)
					.getFigure();
		...
		} else if (childEditPart instanceof SmooksMediatorOutputConnector2EditPart) {

			IFigure borderItemFigure = ((SmooksMediatorOutputConnector2EditPart) childEditPart)
					.getFigure();
			BorderItemLocator locator = new FixedBorderItemLocator(
