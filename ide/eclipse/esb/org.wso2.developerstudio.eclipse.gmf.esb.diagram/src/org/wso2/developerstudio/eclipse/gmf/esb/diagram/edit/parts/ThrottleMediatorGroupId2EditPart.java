 ...
 * @generated
 */
public class ThrottleMediatorGroupId2EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public ThrottleMediatorGroupId2EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = EsbParserProvider
					.getParser(
							...
							getParserElement(),
							EsbVisualIDRegistry
									.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.ThrottleMediatorGroupId2EditPart.VISUAL_ID));
		}
		return parser;
	}
