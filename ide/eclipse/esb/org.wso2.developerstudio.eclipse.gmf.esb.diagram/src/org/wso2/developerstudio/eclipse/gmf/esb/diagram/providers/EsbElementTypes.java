...
public class EsbElementTypes {
	...
	public static ENamedElement getElement(IAdaptable hint) {
		...
		if (elements == null) {
			...
			elements.put(FilterMediatorOutputConnector_3534,
					EsbPackage.eINSTANCE.getFilterMediatorOutputConnector());
			...
			elements.put(DefaultEndPoint_3563, EsbPackage.eINSTANCE.getDefaultEndPoint());
			...
			elements.put(AddressEndPoint_3564, EsbPackage.eINSTANCE.getAddressEndPoint());
			...
			elements.put(FailoverEndPoint_3565, EsbPackage.eINSTANCE.getFailoverEndPoint());
			...
			elements.put(WSDLEndPoint_3566, EsbPackage.eINSTANCE.getWSDLEndPoint());
			...
			elements.put(LoadBalanceEndPoint_3567, EsbPackage.eINSTANCE.getLoadBalanceEndPoint());
			...
			elements.put(EndpointFlow_3580, EsbPackage.eINSTANCE.getEndpointFlow());
