 ...
 * @generated
 */
public class HeaderMediatorValueLiteral5EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public HeaderMediatorValueLiteral5EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = EsbParserProvider
					.getParser(
							...
							getParserElement(),
							EsbVisualIDRegistry
									.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.HeaderMediatorValueLiteral5EditPart.VISUAL_ID));
		}
		return parser;
	}
