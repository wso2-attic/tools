 ...
 * <ul>
 *   <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.ProxyServiceOutSequenceImpl#getChildren <em>Children</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ProxyServiceOutSequenceImpl extends EsbNodeImpl implements ProxyServiceOutSequence {
	...
	public EList<EsbElement> getChildren() {
		if (children == null) {
			children = new EObjectContainmentEList<EsbElement>(EsbElement.class, this, EsbPackage.PROXY_SERVICE_OUT_SEQUENCE__CHILDREN);
		}
		return children;
	}
