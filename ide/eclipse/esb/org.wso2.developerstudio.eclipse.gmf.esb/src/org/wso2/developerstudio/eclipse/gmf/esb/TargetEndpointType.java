 ...
 * <!-- end-user-doc -->
 * @see org.wso2.developerstudio.eclipse.gmf.esb.EsbPackage#getTargetEndpointType()
 * @model
 * @generated
 */
public enum TargetEndpointType implements Enumerator {
	 ...
	 * @generated
	 */
	private static final TargetEndpointType[] VALUES_ARRAY =
		new TargetEndpointType[] {
			NONE,
			ANONYMOUS,
			REGISTRY_REFERENCE,
		};
