 ...
 * <ul>
 *   <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.ProxyServiceInSequenceImpl#getChildren <em>Children</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ProxyServiceInSequenceImpl extends EsbNodeImpl implements ProxyServiceInSequence {
	...
	public EList<EsbElement> getChildren() {
		if (children == null) {
			children = new EObjectContainmentEList<EsbElement>(EsbElement.class, this, EsbPackage.PROXY_SERVICE_IN_SEQUENCE__CHILDREN);
		}
		return children;
	}
