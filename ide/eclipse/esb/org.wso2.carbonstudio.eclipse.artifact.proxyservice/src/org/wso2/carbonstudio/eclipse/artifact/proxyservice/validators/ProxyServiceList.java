...
package org.wso2.carbonstudio.eclipse.artifact.proxyservice.validators;
...
public class ProxyServiceList extends AbstractListDataProvider{

	
	public List<ListData> getListData(String modelProperty,
			ProjectDataModel model) {
		List<ListData> list = new ArrayList<ListData>();
		List<OMElement> availablePSList = ((ProxyServiceModel)model).getAvailablePSList();
