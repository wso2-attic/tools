...
package org.wso2.developerstudio.eclipse.artifact.sequence.project.export;
...
public class SequenceArtfactExportHandler extends ProjectArtifactHandler{
    ...
    private boolean isSequence(File xmlFile){
		try {
