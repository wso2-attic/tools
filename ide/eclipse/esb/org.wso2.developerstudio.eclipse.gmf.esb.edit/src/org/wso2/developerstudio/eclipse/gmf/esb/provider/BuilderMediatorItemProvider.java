...
public class BuilderMediatorItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EsbPackage.Literals.BUILDER_MEDIATOR__MESSAGE_BUILDERS);
			childrenFeatures.add(EsbPackage.Literals.BUILDER_MEDIATOR__INPUT_CONNECTOR);
			childrenFeatures.add(EsbPackage.Literals.BUILDER_MEDIATOR__OUTPUT_CONNECTOR);
		}
