...
/**
 * This is the item provider adapter for a {@link org.wso2.carbonstudio.eclipse.gmf.esb.SqlParameterDefinition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SqlParameterDefinitionItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EsbPackage.Literals.SQL_PARAMETER_DEFINITION__VALUE_EXPRESSION);
		}
	...
	public String getText(Object object) {
		SqlParameterDataType labelValue = ((SqlParameterDefinition)object).getDataType();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_SqlParameterDefinition_type") :
			getString("_UI_SqlParameterDefinition_type") + " " + label;
	}
