...
/**
 * This is the item provider adapter for a {@link org.wso2.carbonstudio.eclipse.gmf.esb.RuleSetConfiguration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RuleSetConfigurationItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EsbPackage.Literals.RULE_SET_CONFIGURATION__SOURCE_TYPE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EsbPackage.Literals.RULE_SET_CONFIGURATION__SOURCE_CODE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EsbPackage.Literals.RULE_SET_CONFIGURATION__SOURCE_KEY);
			childrenFeatures.add(EsbPackage.Literals.RULE_SET_CONFIGURATION__PROPERTIES);
		}
	...
	public String getText(Object object) {
		RuleSourceType labelValue = ((RuleSetConfiguration)object).getSourceType();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_RuleSetConfiguration_type") :
			getString("_UI_RuleSetConfiguration_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EsbPackage.Literals.RULE_SET_CONFIGURATION__SOURCE_KEY,
				 EsbFactory.eINSTANCE.createRegistryKeyProperty()));

		newChildDescriptors.add
			(createChildParameter
				(EsbPackage.Literals.RULE_SET_CONFIGURATION__PROPERTIES,
