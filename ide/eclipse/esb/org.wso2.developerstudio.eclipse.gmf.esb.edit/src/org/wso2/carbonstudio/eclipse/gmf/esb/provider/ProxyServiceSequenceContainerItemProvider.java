...
/**
 * This is the item provider adapter for a {@link org.wso2.carbonstudio.eclipse.gmf.esb.ProxyServiceSequenceContainer} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProxyServiceSequenceContainerItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EsbPackage.Literals.PROXY_SERVICE_SEQUENCE_CONTAINER__IN_SEQUENCE);
			childrenFeatures.add(EsbPackage.Literals.PROXY_SERVICE_SEQUENCE_CONTAINER__OUT_SEQUENCE);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ProxyServiceSequenceContainer.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EsbPackage.Literals.PROXY_SERVICE_SEQUENCE_CONTAINER__IN_SEQUENCE,
				 EsbFactory.eINSTANCE.createProxyServiceInSequence()));

		newChildDescriptors.add
			(createChildParameter
				(EsbPackage.Literals.PROXY_SERVICE_SEQUENCE_CONTAINER__OUT_SEQUENCE,
				 EsbFactory.eINSTANCE.createProxyServiceOutSequence()));
	}
