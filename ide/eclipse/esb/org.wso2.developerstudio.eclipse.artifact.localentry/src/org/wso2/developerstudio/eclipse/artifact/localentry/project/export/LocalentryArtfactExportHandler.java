...
package org.wso2.developerstudio.eclipse.artifact.localentry.project.export;
...
public class LocalentryArtfactExportHandler extends ProjectArtifactHandler{
    ...
    private boolean isLocalEntry(File xmlFile){
		try {
