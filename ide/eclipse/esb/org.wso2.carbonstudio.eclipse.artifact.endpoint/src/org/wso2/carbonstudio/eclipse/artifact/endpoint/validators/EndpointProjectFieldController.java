package org.wso2.carbonstudio.eclipse.artifact.endpoint.validators;
...
public class EndpointProjectFieldController extends AbstractFieldController {
	...
	private Map<String, List<String>> getTemplateFieldProperties() {
		...
		map.put("org.wso2.carbonstudio.eclipse.esb.template.ep2", Arrays.asList(new String[] {}));
		map.put("org.wso2.carbonstudio.eclipse.esb.template.ep1", Arrays
		        .asList(new String[] { "templ.address.ep.uri" }));
		map.put("org.wso2.carbonstudio.eclipse.esb.template.ep5", Arrays
		        .asList(new String[] { "templ.wsdl.ep.uri", "templ.wsdl.ep.service",
		                              "templ.wsdl.ep.port" }));
		map.put("org.wso2.carbonstudio.eclipse.esb.template.ep3", Arrays.asList(new String[] {}));
		map.put("org.wso2.carbonstudio.eclipse.esb.template.ep4", Arrays.asList(new String[] {}));
		map.put("org.wso2.carbonstudio.eclipse.esb.template.ep0", Arrays
