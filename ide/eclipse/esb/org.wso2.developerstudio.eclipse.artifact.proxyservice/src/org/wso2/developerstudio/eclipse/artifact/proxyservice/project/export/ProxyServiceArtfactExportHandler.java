...
package org.wso2.developerstudio.eclipse.artifact.proxyservice.project.export;
...
public class ProxyServiceArtfactExportHandler extends ProjectArtifactHandler{
    ...
    private boolean isProxy(File xmlFile){
		try {
