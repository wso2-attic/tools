...
import org.wso2.carbonstudio.eclipse.gmf.esb.AbstractBooleanFeature;
import org.wso2.carbonstudio.eclipse.gmf.esb.AbstractCommonTarget;
import org.wso2.carbonstudio.eclipse.gmf.esb.AbstractEndPoint;
import org.wso2.carbonstudio.eclipse.gmf.esb.AbstractLocationKeyResource;
import org.wso2.carbonstudio.eclipse.gmf.esb.AbstractNameValueExpressionProperty;
import org.wso2.carbonstudio.eclipse.gmf.esb.AbstractNameValueProperty;
import org.wso2.carbonstudio.eclipse.gmf.esb.AbstractSqlExecutorMediator;
...
import org.wso2.carbonstudio.eclipse.gmf.esb.AutoscaleInMediator;
import org.wso2.carbonstudio.eclipse.gmf.esb.AutoscaleOutMediator;
import org.wso2.carbonstudio.eclipse.gmf.esb.CacheAction;
import org.wso2.carbonstudio.eclipse.gmf.esb.CacheImplementationType;
...
import org.wso2.carbonstudio.eclipse.gmf.esb.CacheOnHitBranch;
import org.wso2.carbonstudio.eclipse.gmf.esb.CacheScope;
import org.wso2.carbonstudio.eclipse.gmf.esb.CacheSequenceType;
...
import org.wso2.carbonstudio.eclipse.gmf.esb.ClassProperty;
...
import org.wso2.carbonstudio.eclipse.gmf.esb.CloneTarget;
...
import org.wso2.carbonstudio.eclipse.gmf.esb.CommandProperty;
import org.wso2.carbonstudio.eclipse.gmf.esb.CommandPropertyContextAction;
import org.wso2.carbonstudio.eclipse.gmf.esb.CommandPropertyMessageAction;
import org.wso2.carbonstudio.eclipse.gmf.esb.CommandPropertyValueType;
...
import org.wso2.carbonstudio.eclipse.gmf.esb.EndPoint;
import org.wso2.carbonstudio.eclipse.gmf.esb.EndPointAddressingVersion;
import org.wso2.carbonstudio.eclipse.gmf.esb.EndPointAttachmentOptimization;
import org.wso2.carbonstudio.eclipse.gmf.esb.EndPointMessageFormat;
import org.wso2.carbonstudio.eclipse.gmf.esb.EndPointTimeOutAction;
...
import org.wso2.carbonstudio.eclipse.gmf.esb.EnrichSourceType;
import org.wso2.carbonstudio.eclipse.gmf.esb.EnrichTargetAction;
import org.wso2.carbonstudio.eclipse.gmf.esb.EnrichTargetType;
...
import org.wso2.carbonstudio.eclipse.gmf.esb.EsbConnector;
...
import org.wso2.carbonstudio.eclipse.gmf.esb.EsbSequenceInput;
import org.wso2.carbonstudio.eclipse.gmf.esb.EsbSequenceInputConnector;
import org.wso2.carbonstudio.eclipse.gmf.esb.EsbSequenceOutput;
...
import org.wso2.carbonstudio.eclipse.gmf.esb.EventTopicType;
...
import org.wso2.carbonstudio.eclipse.gmf.esb.FailoverEndPointCaseBranchOutputConnector;
import org.wso2.carbonstudio.eclipse.gmf.esb.FailoverEndPointDefaultBranchOutputConnector;
...
import org.wso2.carbonstudio.eclipse.gmf.esb.FaultCodeSoap11;
import org.wso2.carbonstudio.eclipse.gmf.esb.FaultCodeSoap12;
...
import org.wso2.carbonstudio.eclipse.gmf.esb.FilterConditionType;
...
import org.wso2.carbonstudio.eclipse.gmf.esb.HeaderAction;
...
import org.wso2.carbonstudio.eclipse.gmf.esb.HeaderValueType;
...
import org.wso2.carbonstudio.eclipse.gmf.esb.IterateTarget;
...
import org.wso2.carbonstudio.eclipse.gmf.esb.LocalEntry;
import org.wso2.carbonstudio.eclipse.gmf.esb.LocalEntryValueType;
import org.wso2.carbonstudio.eclipse.gmf.esb.LogCategory;
import org.wso2.carbonstudio.eclipse.gmf.esb.LogLevel;
...
import org.wso2.carbonstudio.eclipse.gmf.esb.LogProperty;
import org.wso2.carbonstudio.eclipse.gmf.esb.Mediator;
import org.wso2.carbonstudio.eclipse.gmf.esb.MediatorSequence;
...
import org.wso2.carbonstudio.eclipse.gmf.esb.OAuthMediatorInputConnector;
import org.wso2.carbonstudio.eclipse.gmf.esb.OAuthMediatorOutputConnector;
import org.wso2.carbonstudio.eclipse.gmf.esb.OutputConnector;
import org.wso2.carbonstudio.eclipse.gmf.esb.OutputMethod;
import org.wso2.carbonstudio.eclipse.gmf.esb.ParentEndPoint;
import org.wso2.carbonstudio.eclipse.gmf.esb.PropertyAction;
import org.wso2.carbonstudio.eclipse.gmf.esb.PropertyDataType;
...
import org.wso2.carbonstudio.eclipse.gmf.esb.PropertyScope;
import org.wso2.carbonstudio.eclipse.gmf.esb.PropertyValueType;
...
import org.wso2.carbonstudio.eclipse.gmf.esb.RMSequenceMediatorOutputConnector;
import org.wso2.carbonstudio.eclipse.gmf.esb.RMSequenceType;
import org.wso2.carbonstudio.eclipse.gmf.esb.RMSpecVersion;
import org.wso2.carbonstudio.eclipse.gmf.esb.ReceivingSequenceType;
import org.wso2.carbonstudio.eclipse.gmf.esb.RegistryKeyProperty;
import org.wso2.carbonstudio.eclipse.gmf.esb.RouteTarget;
import org.wso2.carbonstudio.eclipse.gmf.esb.RouterMediator;
import org.wso2.carbonstudio.eclipse.gmf.esb.RouterRoute;
import org.wso2.carbonstudio.eclipse.gmf.esb.RuleChildMediatorsConfiguration;
import org.wso2.carbonstudio.eclipse.gmf.esb.RuleFact;
import org.wso2.carbonstudio.eclipse.gmf.esb.RuleFactType;
import org.wso2.carbonstudio.eclipse.gmf.esb.RuleFactValueType;
import org.wso2.carbonstudio.eclipse.gmf.esb.RuleFactsConfiguration;
import org.wso2.carbonstudio.eclipse.gmf.esb.RuleMediator;
import org.wso2.carbonstudio.eclipse.gmf.esb.RuleMediatorInputConnector;
import org.wso2.carbonstudio.eclipse.gmf.esb.RuleMediatorOutputConnector;
import org.wso2.carbonstudio.eclipse.gmf.esb.RuleResult;
import org.wso2.carbonstudio.eclipse.gmf.esb.RuleResultType;
import org.wso2.carbonstudio.eclipse.gmf.esb.RuleResultValueType;
import org.wso2.carbonstudio.eclipse.gmf.esb.RuleResultsConfiguration;
import org.wso2.carbonstudio.eclipse.gmf.esb.RuleSessionConfiguration;
import org.wso2.carbonstudio.eclipse.gmf.esb.RuleSessionProperty;
import org.wso2.carbonstudio.eclipse.gmf.esb.RuleSetConfiguration;
import org.wso2.carbonstudio.eclipse.gmf.esb.RuleSetCreationProperty;
import org.wso2.carbonstudio.eclipse.gmf.esb.RuleSourceType;
import org.wso2.carbonstudio.eclipse.gmf.esb.ScriptLanguage;
...
import org.wso2.carbonstudio.eclipse.gmf.esb.Session;
...
import org.wso2.carbonstudio.eclipse.gmf.esb.SomeXML;
...
import org.wso2.carbonstudio.eclipse.gmf.esb.SqlExecutorBooleanValue;
import org.wso2.carbonstudio.eclipse.gmf.esb.SqlExecutorConnectionType;
import org.wso2.carbonstudio.eclipse.gmf.esb.SqlExecutorDatasourceType;
import org.wso2.carbonstudio.eclipse.gmf.esb.SqlExecutorIsolationLevel;
import org.wso2.carbonstudio.eclipse.gmf.esb.SqlParameterDataType;
import org.wso2.carbonstudio.eclipse.gmf.esb.SqlParameterDefinition;
import org.wso2.carbonstudio.eclipse.gmf.esb.SqlParameterValueType;
import org.wso2.carbonstudio.eclipse.gmf.esb.SqlResultMapping;
import org.wso2.carbonstudio.eclipse.gmf.esb.SqlStatement;
...
import org.wso2.carbonstudio.eclipse.gmf.esb.TargetEndpointType;
import org.wso2.carbonstudio.eclipse.gmf.esb.TargetSequenceType;
import org.wso2.carbonstudio.eclipse.gmf.esb.Task;
import org.wso2.carbonstudio.eclipse.gmf.esb.ThrottleAccessType;
import org.wso2.carbonstudio.eclipse.gmf.esb.ThrottleConditionType;
import org.wso2.carbonstudio.eclipse.gmf.esb.ThrottleMediator;
import org.wso2.carbonstudio.eclipse.gmf.esb.ThrottleMediatorInputConnector;
import org.wso2.carbonstudio.eclipse.gmf.esb.ThrottleMediatorOutputConnector;
import org.wso2.carbonstudio.eclipse.gmf.esb.ThrottleOnAcceptBranch;
import org.wso2.carbonstudio.eclipse.gmf.esb.ThrottleOnRejectBranch;
import org.wso2.carbonstudio.eclipse.gmf.esb.ThrottlePolicyConfiguration;
import org.wso2.carbonstudio.eclipse.gmf.esb.ThrottlePolicyEntry;
import org.wso2.carbonstudio.eclipse.gmf.esb.ThrottlePolicyType;
import org.wso2.carbonstudio.eclipse.gmf.esb.ThrottleSequenceType;
import org.wso2.carbonstudio.eclipse.gmf.esb.TransactionAction;
...
import org.wso2.carbonstudio.eclipse.gmf.esb.Trigger;
import org.wso2.carbonstudio.eclipse.gmf.esb.Type;
import org.wso2.carbonstudio.eclipse.gmf.esb.ValidateFeature;
import org.wso2.carbonstudio.eclipse.gmf.esb.ValidateMediator;
import org.wso2.carbonstudio.eclipse.gmf.esb.ValidateOnFailBranch;
import org.wso2.carbonstudio.eclipse.gmf.esb.ValidateSchema;
import org.wso2.carbonstudio.eclipse.gmf.esb.WSDLDefinition;
import org.wso2.carbonstudio.eclipse.gmf.esb.WSDLDescription;
...
import org.wso2.carbonstudio.eclipse.gmf.esb.XQueryVariableType;
import org.wso2.carbonstudio.eclipse.gmf.esb.XQueryVariableValueType;
import org.wso2.carbonstudio.eclipse.gmf.esb.XSLTFeature;
...
import org.wso2.carbonstudio.eclipse.gmf.esb.XSLTProperty;
import org.wso2.carbonstudio.eclipse.gmf.esb.XSLTResource;
import org.wso2.carbonstudio.eclipse.gmf.esb.propertyTaskString;
import org.wso2.carbonstudio.eclipse.gmf.esb.propertyTaskXML;
...
public class EsbPackageImpl extends EPackageImpl implements EsbPackage {
	 ...
	 * @see org.wso2.carbonstudio.eclipse.gmf.esb.EsbPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EAttribute getConditionalRouteBranch_BreakRoute() {
	...
	public void initializePackageContents() {
		...
		initEAttribute(getCloneMediatorTargetOutputConnector_SoapAction(), ecorePackage.getEString(), "soapAction", null, 0, 1, CloneMediatorTargetOutputConnector.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCloneMediatorTargetOutputConnector_ToAddress(), ecorePackage.getEString(), "toAddress", null, 0, 1, CloneMediatorTargetOutputConnector.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getRuleSetConfiguration_SourceKey(), this.getRegistryKeyProperty(), null, "sourceKey", null, 0, 1, RuleSetConfiguration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
