 ...
 *   <li>{@link org.wso2.carbonstudio.eclipse.esb.impl.MediatorSequenceImpl#getDescription <em>Description</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MediatorSequenceImpl extends ConfigurationElementImpl implements
	...
	public void doLoad(Element self) throws Exception {
		...
		if (null != descriptionElem) {
			...
			setDescription(descriptionElem.getTextContent());
		}
	...
	public Element doSave(Element parent) throws Exception {
		...
		// Save description
		String newDesription = getDescription();
		if (!StringUtils.isBlank(newDesription)) {
			Element descriptionElem = createChildElement(self, "description");
			descriptionElem.setTextContent(newDesription);
		}
