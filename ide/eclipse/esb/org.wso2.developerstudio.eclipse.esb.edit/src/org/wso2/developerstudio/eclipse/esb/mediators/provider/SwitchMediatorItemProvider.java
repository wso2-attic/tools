...
/**
 * This is the item provider adapter for a {@link org.wso2.developerstudio.eclipse.esb.mediators.SwitchMediator} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SwitchMediatorItemProvider
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 ...
                 MediatorsPackage.Literals.SWITCH_MEDIATOR__SOURCE_XPATH,
                 true,
                 false,
                 false,
                 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(MediatorsPackage.Literals.SWITCH_MEDIATOR__CASE_BRANCHES);
            childrenFeatures.add(MediatorsPackage.Literals.SWITCH_MEDIATOR__DEFAULT_BRANCH);
        }
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add
            (createChildParameter
                (MediatorsPackage.Literals.SWITCH_MEDIATOR__CASE_BRANCHES,
                 MediatorsFactory.eINSTANCE.createSwitchCaseBranch()));

        newChildDescriptors.add
            (createChildParameter
                (MediatorsPackage.Literals.SWITCH_MEDIATOR__DEFAULT_BRANCH,
                 MediatorsFactory.eINSTANCE.createSwitchDefaultBranch()));
    }
