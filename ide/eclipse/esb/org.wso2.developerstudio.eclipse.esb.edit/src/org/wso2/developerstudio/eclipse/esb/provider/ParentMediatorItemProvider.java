 ...
 * {@link org.wso2.developerstudio.eclipse.esb.ParentMediator} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class ParentMediatorItemProvider extends MediatorItemProvider implements
	 ...
	 * @generated
	 */
	public ParentMediatorItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
        ...
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(EsbPackage.Literals.PARENT_MEDIATOR__CHILDREN);
        }
	...
	public String getText(Object object) {
		return getString("_UI_ParentMediator_type");
	}
	...
	public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(ParentMediator.class)) {
	...
	protected void collectNewChildDescriptors(
		...
		ParentMediator parentMediator = (ParentMediator) object;
		switch (parentMediator.getCurrentEsbVersion()) {
		case ESB400:
