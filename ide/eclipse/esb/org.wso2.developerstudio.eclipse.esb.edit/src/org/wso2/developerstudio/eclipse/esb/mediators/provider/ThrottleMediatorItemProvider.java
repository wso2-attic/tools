...
/**
 * This is the item provider adapter for a {@link org.wso2.developerstudio.eclipse.esb.mediators.ThrottleMediator} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ThrottleMediatorItemProvider
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 ...
                 MediatorsPackage.Literals.THROTTLE_MEDIATOR__GROUP_ID,
                 true,
                 false,
                 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(MediatorsPackage.Literals.THROTTLE_MEDIATOR__POLICY_CONFIGURATION);
            childrenFeatures.add(MediatorsPackage.Literals.THROTTLE_MEDIATOR__ON_ACCEPT_BRANCH);
            childrenFeatures.add(MediatorsPackage.Literals.THROTTLE_MEDIATOR__ON_REJECT_BRANCH);
        }
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add
            (createChildParameter
                (MediatorsPackage.Literals.THROTTLE_MEDIATOR__POLICY_CONFIGURATION,
                 MediatorsFactory.eINSTANCE.createThrottlePolicyConfiguration()));

        newChildDescriptors.add
            (createChildParameter
                (MediatorsPackage.Literals.THROTTLE_MEDIATOR__ON_ACCEPT_BRANCH,
                 MediatorsFactory.eINSTANCE.createThrottleOnAcceptBranch()));

        newChildDescriptors.add
            (createChildParameter
                (MediatorsPackage.Literals.THROTTLE_MEDIATOR__ON_REJECT_BRANCH,
                 MediatorsFactory.eINSTANCE.createThrottleOnRejectBranch()));
    }
