...
/**
 * This is the item provider adapter for a {@link org.wso2.developerstudio.eclipse.esb.ProxyWsdlConfiguration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProxyWsdlConfigurationItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		...
		if (!proxyWsdl.getWsdlType().equals(ProxyWsdlType.NONE)) {
			childrenFeatures.add(EsbPackage.Literals.PROXY_WSDL_CONFIGURATION__WSDL_RESOURCES);
		}
	...
	protected Command createCreateChildCommand(EditingDomain domain, EObject owner, EStructuralFeature feature,
		...
		ProxyWsdlConfiguration wsdlConfiguration = (ProxyWsdlConfiguration) owner;
		if (value instanceof ProxyWsdlResource) {
			if (wsdlConfiguration.getWsdlType().equals(ProxyWsdlType.NONE)) {
