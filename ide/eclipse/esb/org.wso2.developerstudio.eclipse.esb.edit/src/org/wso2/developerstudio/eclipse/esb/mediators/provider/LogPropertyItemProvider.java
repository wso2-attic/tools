...
import org.wso2.developerstudio.eclipse.esb.provider.AbstractNameValueExpressionPropertyItemProvider;
import org.wso2.developerstudio.eclipse.esb.provider.EsbEditPlugin;

/**
 * This is the item provider adapter for a {@link org.wso2.developerstudio.eclipse.esb.mediators.LogProperty} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LogPropertyItemProvider
	...
	public String getText(Object object) {
		LogProperty property = (LogProperty) object;
		String name = property.getPropertyName();
		String value = 
			property.getPropertyValueType().equals(PropertyValueType.VALUE) ?
            property.getPropertyValue() : property.getPropertyExpression().getPropertyValue();
