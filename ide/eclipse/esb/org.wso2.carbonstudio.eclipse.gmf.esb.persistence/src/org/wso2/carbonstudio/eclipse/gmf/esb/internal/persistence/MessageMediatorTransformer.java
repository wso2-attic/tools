...
public class MessageMediatorTransformer extends AbstractEsbNodeTransformer {
	...
	public void transform(TransformationInfo info, EsbNode subject)
		...
		// Check subject.
		Assert.isTrue(
				subject instanceof org.wso2.carbonstudio.eclipse.gmf.esb.MessageMediator,
				"Invalid subject.");
		org.wso2.carbonstudio.eclipse.gmf.esb.MessageMediator visualMessage = (org.wso2.carbonstudio.eclipse.gmf.esb.MessageMediator) subject;
