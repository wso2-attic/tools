...
public class TaskTransformer {
	...
	throws Exception {
		...
		Assert.isTrue(
				subject instanceof org.wso2.carbonstudio.eclipse.gmf.esb.Task,
				"Invalid subject.");
		org.wso2.carbonstudio.eclipse.gmf.esb.Task visualTask = (org.wso2.carbonstudio.eclipse.gmf.esb.Task) subject;
