...
/**
 * Utility class used to create inactive create child commands (inactive menu items). 
 */
public class UnexecutableCreateChildCommand extends CreateChildCommand {
	
	/**
	 * Creates a new {@link UnexecutableCreateChildCommand}.
	 */
	public UnexecutableCreateChildCommand(EditingDomain domain,
            EObject owner,
