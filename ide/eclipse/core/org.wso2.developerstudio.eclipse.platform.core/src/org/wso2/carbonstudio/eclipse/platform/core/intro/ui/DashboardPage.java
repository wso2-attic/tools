...
import org.wso2.carbonstudio.eclipse.samples.wizards.ProjectCreationWizard;
...
public class DashboardPage extends FormPage {
	...
	static{
		wizardCategoryMap.put("Application Server", new String[] {
				"org.wso2.carbonstudio.eclipse.artifact.newaxis2artifact",
				"org.wso2.carbonstudio.eclipse.artifact.newjaxwsartifact",
				"org.wso2.carbonstudio.eclipse.artifact.newwarartifact"
				});
		
		wizardCategoryMap.put("Business Process Server", new String[] {
				"org.wso2.carbonstudio.eclipse.artifact.newbpelartifact"
				});
		
		wizardCategoryMap.put("Carbon", new String[] {
				"org.wso2.carbonstudio.eclipse.artifact.carbonUIartifact",
				"org.wso2.carbonstudio.eclipse.artifact.newlibraryartifact"
				});
		
		wizardCategoryMap.put( "Data Services Server", new String[] {
				"org.wso2.carbonstudio.eclipse.artifact.newdsartifact",
				"org.wso2.carbonstudio.eclipse.artifact.newvalidiatorartifact"
				});
		
		wizardCategoryMap.put("Enterprise Service Bus", new String[]{
				"org.wso2.carbonstudio.eclipse.artifact.newesbproject",
				"org.wso2.carbonstudio.eclipse.artifact.newendpointartifact", 
				"org.wso2.carbonstudio.eclipse.artifact.newlocalentry",
				"org.wso2.carbonstudio.eclipse.artifact.newmediatorartifact",
				"org.wso2.carbonstudio.eclipse.artifact.newproxyservice",
				"org.wso2.carbonstudio.eclipse.artifact.newsequenceartifact",
				"org.wso2.carbonstudio.eclipse.artifact.synapseartifact"
				});
		
		wizardCategoryMap.put("Governance Registry", new String[]{
				"org.wso2.carbonstudio.eclipse.general.project",
				"org.wso2.carbonstudio.eclipse.artifact.newregistryresource",
				"org.wso2.carbonstudio.eclipse.artifact.newregistryfilter",
				"org.wso2.carbonstudio.eclipse.artifact.newregistryhandler"
				});
		
		wizardCategoryMap.put("Gadget Server", new String[]{ 
				"org.wso2.carbonstudio.eclipse.artifact.newgadgetartifact"
				});
		
		wizardCategoryMap.put("Distribution", new String[]{
				"org.wso2.carbonstudio.eclipse.distribution.project",
				});
	}
	/**
	...
	protected void createFormContent(IManagedForm managedForm) {
		...
		form.setText("WSO2 Carbon Studio");
	...
	private Map<String, IWizardDescriptor> getWizardDescriptors() {
		...
		List<IWizardDescriptor> descriptors = getWizardDescriptor(
		        "org.wso2.carbonstudio.eclipse.capp.distribution",
				"org.wso2.carbonstudio.eclipse.web.apps",
				"org.wso2.carbonstudio.eclipse.message.mediation",
				"org.wso2.carbonstudio.eclipse.repository",
				"org.wso2.carbonstudio.eclipse.business.processes",
				"org.wso2.carbonstudio.eclipse.portal.services",
				"org.wso2.carbonstudio.eclipse.carbon.ui",
				"org.wso2.carbonstudio.eclipse.extensions",
				"org.wso2.carbonstudio.eclipse.service.hosting.project.types",
				"org.wso2.carbonstudio.eclipse.service.hosting.features",
				"org.wso2.carbonstudio.eclipse.extensions.project.types",
				"org.wso2.carbonstudio.eclipse.extensions.features",
				"org.wso2.carbonstudio.eclipse.message.mediation.project.types",
				"org.wso2.carbonstudio.eclipse.message.mediation.features");
	...
	private void createSamples(IManagedForm managedForm,Composite composite){
		...
		for (ICarbonStudioSampleContributor contributor : samples) {
			createSampleLink(managedForm,composite,contributor);
        }
	}

	private void createSampleLink(IManagedForm managedForm,Composite composite,final ICarbonStudioSampleContributor contributor){
	...
	private void createProject(ICarbonStudioSampleContributor contributor){
