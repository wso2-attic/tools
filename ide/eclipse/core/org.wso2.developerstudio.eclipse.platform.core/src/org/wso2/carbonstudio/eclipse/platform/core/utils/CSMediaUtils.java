...
import org.wso2.carbonstudio.eclipse.platform.core.internal.impl.MediaTypeResolverProviderImpl;

public class CSMediaUtils {
	private static ICarbonStudioLog log=Logger.getLog(Activator.PLUGIN_ID);

	private static String MEDIA_TYPE_EXTENSION="org.wso2.carbonstudio.eclipse.platform.core.mediatype";
