package org.wso2.carbonstudio.eclipse.greg.core;
...
import org.wso2.carbonstudio.eclipse.greg.core.interfaces.IRegistryResourceProviderData;
import org.wso2.carbonstudio.eclipse.greg.core.internal.impl.RegistryResourceProviderData;
...
public class RegistryManager {
	...
	private static String REGISTRY_RESOURCE_EXTENSION = "org.wso2.carbonstudio.eclipse.greg.resourceProvider";
	...
	public static boolean isMediaTypeFilterPassed(
		...
		boolean passed = true;
		try {
			if (CarbonStudioProviderUtils.isFilterPresent(filters,
					CSProviderConstants.FILTER_MEDIA_TYPE)) {
				String mediaType = getRegistryResourceMediaType(file);
				passed = CarbonStudioProviderUtils.isMediaTypeFilterPassed(filters, mediaType);
			}
		} catch (Exception e) {
			passed=false;
		}
