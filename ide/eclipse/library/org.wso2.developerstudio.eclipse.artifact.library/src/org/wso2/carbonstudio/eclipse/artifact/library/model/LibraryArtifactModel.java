...
package org.wso2.carbonstudio.eclipse.artifact.library.model;
...
public void setFragmentHostBundle(boolean fragmentHostBundle) {
	this.fragmentHostBundle = fragmentHostBundle;
}

public boolean isFragmentHostBundle() {
	return fragmentHostBundle;
} 
}
