...
package org.wso2.developerstudio.eclipse.carbonserver40.configuration;
	...
	public void createSection(Composite parent) {
		...
		startWSASCheck.addSelectionListener(new SelectionAdapter(){
			public void widgetSelected(SelectionEvent arg0) {
				CarbonServer40Utils.setServerStartBrowserPopup(server.getOriginal(),startWSASCheck.getSelection());
			}
		});
		...
		hotupdateCheck.addSelectionListener(new SelectionAdapter(){
			public void widgetSelected(SelectionEvent arg0) {
				CarbonServer40Utils.setServerHotUpdate(server.getOriginal(), hotupdateCheck.getSelection());
			}
		...
		osgiConsoleCheck.addSelectionListener(new SelectionAdapter(){
			public void widgetSelected(SelectionEvent arg0) {
				CarbonServer40Utils.setServerStartWithOSGiConsole(server.getOriginal(),osgiConsoleCheck.getSelection());
			}
		});
...
//		axis2FileMonitor.stopMonitoring();
	...
	protected void initialize() {
		Display.getDefault().asyncExec(new Runnable(){
            public void run() {
            	while(true){
            		Boolean serverConfigMapValue = CarbonServer40Utils.isServerStartBrowserPopup(server.getOriginal());
            		...
            		boolean enableAxis2Hotupdate=CarbonServer40Utils.isServerHotUpdate(server.getOriginal());
            		boolean enableOSGIConsole=CarbonServer40Utils.isServerStartWithOSGiConsole(server.getOriginal());
