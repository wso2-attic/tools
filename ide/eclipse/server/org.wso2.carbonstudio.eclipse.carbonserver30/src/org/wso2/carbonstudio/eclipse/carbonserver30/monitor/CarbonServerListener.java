...
package org.wso2.carbonstudio.eclipse.carbonserver30.monitor;
...
import org.wso2.carbonstudio.eclipse.carbonserver.base.console.CarbonServerConsole;
...
//            		case IServer.STATE_UNKNOWN:triggerStarting(event.getServer());break;
    ...
    private void triggerStarting(IServer server){
    	File cappMonitorBundle = CarbonServer30Utils.getCappMonitorBundle();
