 ...
 * by the Apache Axis2 version: 1.6-wso2v4  Built on : Dec 08, 2010 (06:36:57 UTC)
 */
        package org.wso2.carbonstudio.eclipse.carbonserver.base.capp.uploader;
   ...
   public CarbonAppUploaderStub(org.apache.axis2.context.ConfigurationContext configurationContext,
     ...
     * Default Constructor
     */
    public CarbonAppUploaderStub(org.apache.axis2.context.ConfigurationContext configurationContext) throws org.apache.axis2.AxisFault {
        
                    this(configurationContext,"https://10.100.0.162:9443/services/CarbonAppUploader.CarbonAppUploaderHttpsSoap12Endpoint/" );
    ...
    public CarbonAppUploaderStub(java.lang.String targetEndpoint) throws org.apache.axis2.AxisFault {
        this(null,targetEndpoint);
                     ...
                     * 
                     * @see org.wso2.carbonstudio.eclipse.carbonserver.base.capp.uploader.CarbonAppUploader#uploadApp
                     * @param uploadApp
                     ...
                     */
                            ...
                            org.wso2.carbonstudio.eclipse.carbonserver.base.capp.uploader.CarbonAppUploaderStub.UploadedFileItem[] fileItems)
              ...
              org.apache.axiom.soap.SOAPEnvelope env = null;
                    org.wso2.carbonstudio.eclipse.carbonserver.base.capp.uploader.CarbonAppUploaderStub.UploadApp dummyWrappedType = null;
        ...
        _operationClient.execute(true);
            ...
            if (faultElt!=null){
                if (faultExceptionNameMap.containsKey(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(),"uploadApp"))){
                    //make the fault by reflection
                    try{
                        java.lang.String exceptionClassName = (java.lang.String)faultExceptionClassNameMap.get(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(),"uploadApp"));
                        java.lang.Class exceptionClass = java.lang.Class.forName(exceptionClassName);
                        java.lang.Exception ex = (java.lang.Exception) exceptionClass.newInstance();
                        //message class
                        java.lang.String messageClassName = (java.lang.String)faultMessageMap.get(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(),"uploadApp"));
                           ...
                           */
                           public  UploadedFileItem[] getFileItems(){
                            ...
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localFileItems);
                               list.add(param);
                               this.localFileItems =
                             (UploadedFileItem[])list.toArray(
                            new UploadedFileItem[list.size()]);
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                java.lang.String namespace = null;
                  ...
                  if (serializeType){
                   ...
                   java.lang.String namespacePrefix = registerPrefix(xmlWriter,"http://upload.application.carbon.wso2.org");
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":uploadApp",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "uploadApp",
                                       ...
                                       if (localFileItems!=null){
                                            for (int i = 0;i < localFileItems.length;i++){
                                                if (localFileItems[i] != null){
                                                 localFileItems[i].serialize(new javax.xml.namespace.QName("http://upload.application.carbon.wso2.org","fileItems"),
                                                           xmlWriter);
                                                } else {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"uploadApp".equals(type)){
                                ...
                                return (UploadApp)ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://upload.application.carbon.wso2.org","fileItems").equals(reader.getName())){
                                    ...
                                    // Process the array and step past its final element's end.
                                                        ...
                                                        while(!loopDone1){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("http://upload.application.carbon.wso2.org","fileItems").equals(reader.getName())){
                                                        ...
                                                        object.setFileItems((UploadedFileItem[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                UploadedFileItem.class,
                                                                list1));
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                java.lang.String namespace = null;
                  ...
                  if (serializeType){
                   ...
                   java.lang.String namespacePrefix = registerPrefix(xmlWriter,"http://upload.application.carbon.wso2.org/xsd");
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
    ...
    public static class Factory{
        ...
        */
        public static UploadedFileItem parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ...
            try {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"UploadedFileItem".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (UploadedFileItem)ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://upload.application.carbon.wso2.org/xsd","dataHandler").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://upload.application.carbon.wso2.org/xsd","fileName").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://upload.application.carbon.wso2.org/xsd","fileType").equals(reader.getName())){
            ...
            private  org.apache.axiom.om.OMElement  toOM(org.wso2.carbonstudio.eclipse.carbonserver.base.capp.uploader.CarbonAppUploaderStub.UploadApp param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault {

            
                        try{
                             return param.getOMElement(org.wso2.carbonstudio.eclipse.carbonserver.base.capp.uploader.CarbonAppUploaderStub.UploadApp.MY_QNAME,
                            ...
                            throw org.apache.axis2.AxisFault.makeFault(e);
                                ...
                                private  org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory,
                                    org.wso2.carbonstudio.eclipse.carbonserver.base.capp.uploader.CarbonAppUploaderStub.UploadedFileItem[] param1,
                                    org.wso2.carbonstudio.eclipse.carbonserver.base.capp.uploader.CarbonAppUploaderStub.UploadApp dummyWrappedType,
                                 boolean optimizeContent) throws org.apache.axis2.AxisFault{

                                try{
                                org.wso2.carbonstudio.eclipse.carbonserver.base.capp.uploader.CarbonAppUploaderStub.UploadApp wrappedType = new org.wso2.carbonstudio.eclipse.carbonserver.base.capp.uploader.CarbonAppUploaderStub.UploadApp();
                               ...
                               org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
                                        ...
                                        emptyEnvelope.getBody().addChild(wrappedType.getOMElement(org.wso2.carbonstudio.eclipse.carbonserver.base.capp.uploader.CarbonAppUploaderStub.UploadApp.MY_QNAME,factory));
        ...
        */
        ...
        try {
                ...
                if (org.wso2.carbonstudio.eclipse.carbonserver.base.capp.uploader.CarbonAppUploaderStub.UploadApp.class.equals(type)){
                
                           return org.wso2.carbonstudio.eclipse.carbonserver.base.capp.uploader.CarbonAppUploaderStub.UploadApp.Factory.parse(param.getXMLStreamReaderWithoutCaching());
