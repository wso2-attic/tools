...
public class SymbolsProvider {
	...
	public static int getModifierSym(String modifier, PHPVersion phpVersion) {
		...
		// return
		// org.eclipse.php.internal.core.ast.scanner.php54.ParserConstants.T_PUBLIC;
		//			} else if (modifier.equals("private")) { //$NON-NLS-1$
		// return
		// org.eclipse.php.internal.core.ast.scanner.php54.ParserConstants.T_PRIVATE;
		//			} else if (modifier.equals("protected")) { //$NON-NLS-1$
		// return
		// org.eclipse.php.internal.core.ast.scanner.php54.ParserConstants.T_PROTECTED;
		//			} else if (modifier.equals("static")) { //$NON-NLS-1$
		// return
		// org.eclipse.php.internal.core.ast.scanner.php54.ParserConstants.T_STATIC;
		//			} else if (modifier.equals("abstract")) { //$NON-NLS-1$
		// return
		// org.eclipse.php.internal.core.ast.scanner.php54.ParserConstants.T_ABSTRACT;
		//			} else if (modifier.equals("final")) { //$NON-NLS-1$
		// return
		// org.eclipse.php.internal.core.ast.scanner.php54.ParserConstants.T_FINAL;
		// }
		// }
