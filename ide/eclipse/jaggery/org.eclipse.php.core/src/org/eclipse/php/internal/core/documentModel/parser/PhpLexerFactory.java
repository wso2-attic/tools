...
public class PhpLexerFactory {
	...
	public static AbstractPhpLexer createLexer(Reader reader,
		...
		// return new
		// org.eclipse.php.internal.core.documentModel.parser.php4.PhpLexer(
		// reader);
		// }
		// if (phpVersion == PHPVersion.PHP5) {
		// return new
		// org.eclipse.php.internal.core.documentModel.parser.php5.PhpLexer(
		// reader);
		// }
		// if (phpVersion == PHPVersion.PHP5_3) {
		// return new
		// org.eclipse.php.internal.core.documentModel.parser.php53.PhpLexer(
		// reader);
		// }
