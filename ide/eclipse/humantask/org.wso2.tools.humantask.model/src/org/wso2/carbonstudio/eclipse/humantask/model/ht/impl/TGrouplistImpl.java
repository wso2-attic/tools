 ...
 * <ul>
 *   <li>{@link org.wso2.carbonstudio.eclipse.humantask.model.ht.impl.TGrouplistImpl#getGroup <em>Group</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TGrouplistImpl extends EObjectImpl implements TGrouplist {
	...
	protected EClass eStaticClass() {
		return HTPackage.Literals.TGROUPLIST;
	}
	...
	public EList<String> getGroup() {
		if (group == null) {
			group = new EDataTypeEList<String>(String.class, this, HTPackage.TGROUPLIST__GROUP);
		}
		return group;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case HTPackage.TGROUPLIST__GROUP:
				return getGroup();
		}
